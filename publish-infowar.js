...
const article = {
  ...
  content: `Deepfakes can now fool the systems banks and apps use to verify you're real. The tools built to catch fake videos are failing.
...
The information war isn't coming. It's here. It's hitting identity systems, propaganda pipelines, military operations, and disaster responses. The question isn't whether information can be weaponized. It's whether we can build systems resilient enough to function when it is.`,
  slug: "deepfakes-broke-identity-verification",
  author: "Jacob Wilson",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Misinformation is false information shared without malicious intent. Disinformation is deliberately deceptive content spread to manipulate. The key difference is intent, not accuracy."
    },
    {
      q: "Are deepfake voice calls actually common?",
      a: "Yes. One in four Americans received a deepfake voice call in the past year, according to tracking data from Hiya. They're used for financial scams, impersonating family members or bosses to request money transfers."
    }
  ],
