...
export function MobileNav() {
  ...
  // Hide top nav on scroll down, show on scroll up (uses ref to avoid re-registering listener)
  useEffect(() => {
    let ticking = false;
    function onScroll() {
      if (ticking) return;
  ...
  const NAV_ITEMS = loggedIn ? NAV_ITEMS_AUTHED : NAV_ITEMS_GUEST;
