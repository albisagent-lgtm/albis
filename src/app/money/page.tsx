...
const CATEGORY_FILTERS = ["economic-flows", "markets"];

export const metadata: Metadata = {
  title: "Money — Albis",
  description: "Economy, trade, markets, and cost of living — how global events hit your wallet.",
};
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 md:px-6 md:py-10">
        <header className="mb-8 border-b border-black/[0.1] pb-4 dark:border-white/[0.1]">
          <div className="flex items-baseline justify-between">
            <h1 className="font-[family-name:var(--font-inter)] text-[11px] font-bold uppercase tracking-[0.15em] text-zinc-500 dark:text-zinc-400">Money</h1>
          ...
          <p className="mt-2 max-w-xl font-[family-name:var(--font-source-serif)] text-sm text-zinc-500 dark:text-zinc-400">
            Economy, trade, markets, and cost of living — how global events hit your wallet.
          </p>
        </header>
