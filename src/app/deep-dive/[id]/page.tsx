...
function getJsonLd() {
  return {
    ...
    publisher: { "@type": "Organization", name: "Albis", url: "https://www.albis.news" },
    ...
    <main>
      ...
      <section className="border-b border-zinc-200 py-12 dark:border-zinc-800/50 md:py-16">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <h1 className="mt-6 font-[family-name:var(--font-playfair)] text-2xl font-semibold leading-headline tracking-tight text-zinc-800 dark:text-zinc-100 md:text-3xl">
            {d.headline}
          </h1>
            ...
            {SECTIONS.map((section) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-2 rounded-full px-4 py-2 text-xs font-medium whitespace-nowrap transition-all ${
                    isActive
