---
title: >-
  Colombia fossil-fuel summit ends with draft phaseout roadmap and scientific
  panel
description: >-
  The summit creates a new climate-governance track outside the slowest parts of
  the COP process.
...
tags:
  ...
  - santa-marta
image: >-
  https://images.pexels.com/photos/12377480/pexels-photo-12377480.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940
excerpt: >-
  The summit creates a new climate-governance track outside the slowest parts of
  the COP process.
author: Albis
...
article_signals:
  coreFact: >-
    The summit creates a new climate-governance track outside the slowest parts
    of the COP process.
  keyNumber: null
  mainActors:
    - Latin America
...
story_plan:
  ...
  walkaway: >-
    The summit creates a new climate-governance track outside the slowest parts
    of the COP process. The walkaway is that price and financing pressure is
    already changing downstream behaviour.
  ...
  nutGrafPromise: >-
    This piece should show how price and financing pressure turns one event into
    wider ripple effects.
  hardFactsToPreserve:
    - >-
      Colombia fossil-fuel summit ends with draft phaseout roadmap and
      scientific panel
    - >-
      The summit creates a new climate-governance track outside the slowest
      parts of the COP process.
    - Latin America
    - COP
    - Europe
    - Africa
  ...
  primaryAngle: Treat price and financing pressure as the engine of the piece.
