---
title: "Fake Iran War Photos Hit 100M Views, Both Sides 2026"
...
featured: false
seoKeyword: "fake war photos deepfakes iran war 100 million views"
perception_gap: 6.33
regions_found: ["us", "eu", "middle_east", "asia_pacific"]
regions_absent: ["south_asia", "latam", "africa"]
region_significance: { "us": 5, "eu": 4, "middle_east": 5, "asia_pacific": 3 }
region_frames:
  us: "Emphasises Iranian deepfake campaigns targeting American audiences"
  eu: "Frames as global trust crisis requiring AI regulation"
  middle_east: "Focuses on Western/Israeli fabrications and debunks pro-Western fakes"
  asia_pacific: "Covers as technology story about AI detection failures"
sources:
  - name: "Deadline"
    url: "https://deadline.com/2026/03/ai-propaganda-shaping-iran-war-1236767715/"
    region: "North America"
    quote: "NewsGuard has now tracked 50 false claims in the conflict's first 25 days, an average of two a day"
  - name: "US News (AP)"
    url: "https://www.usnews.com/news/politics/articles/2026-03-29/hacked-hospitals-hidden-spyware-iran-conflict-shows-how-digital-fight-is-ingrained-in-warfare"
    region: "North America"
    quote: "Supporters of both sides have spread bogus images of atrocities or decisive victories that never happened"
  - name: "Cyabra"
    url: "https://cyabra.com/reports/irans-coordinated-campaign-deepfakes-used-to-manipulate-the-war-narrative/"
    region: "International"
    quote: "A coordinated network of tens of thousands of inauthentic accounts generating over 145 million views in under two weeks"
  - name: "Euronews"
    url: "https://www.euronews.com/my-europe/2026/03/18/netanyahu-denies-death-rumours-in-social-media-clip-which-grok-falsely-branded-ai"
    region: "Europe"
    quote: "Grok shared contradictory claims, in some instances labelling the video as a deepfake"
  - name: "CNN"
    url: "https://www.cnn.com/2026/03/13/politics/james-talarico-ai-deepfake-republicans-midterms"
    region: "North America"
    quote: "NRSC ad uses deepfake depiction of James Talarico with small, faint AI disclosure"
confidence: "confirmed"
faqs:
  - q: "How many fake images have spread during the Iran war?"
    a: "NewsGuard tracked 50 false claims in the first 25 days alone. Cyabra documented a single pro-Iran campaign generating 145 million views through tens of thousands of fake accounts. One AI-generated image of a sunken US warship alone reached 100 million views."
  - q: "Can AI detect deepfakes in the Iran war?"
    a: "Detection tools like Hive can identify some AI-generated content with 99.9% confidence. But the problem is speed — fakes spread to millions before detection happens. Worse, X's own AI chatbot Grok falsely labelled a real Netanyahu video as a deepfake, showing that AI verification tools can compound confusion rather than resolve it."
  - q: "Are deepfakes being used in US elections too?"
    a: "Yes. The NRSC released a deepfake attack ad targeting Texas Senate candidate James Talarico in March 2026, one of at least three Republican ads using AI-generated content in the midterms. The AI disclosure label was nearly invisible. Only 22 US states have any deepfake election laws."
---
...
**Tier one: recycled footage.** Old clips relabelled as current combat. AFP caught images of burning vehicles in Tel Aviv that actually showed January 2026 protests in Tehran. Snopes debunked a "new" Iranian strike video as June 2025 footage. Arabic Reuters fact-checked a 1967 Vietnam War photograph shared as a Houthi naval strike. A fabricated Burj Khalifa fire video — rated 99.9% AI-generated by Hive — circulated widely before anyone flagged it.

**Tier two: video game clips.** BBC Verify traced the war's most viral fake — the 70-million-view "Iranian missile destroys US fighter jet" — to a military flight simulator. Right camera angle, right smoke trail, right explosion. It looked real because it was *designed* to look real, just not for this.
...
The White House isn't clean either. It's posted roughly a dozen "hype videos" to X and TikTok, weaving Call of Duty footage and Hollywood clips into real military operations. The line between propaganda and entertainment has dissolved on every side.
...
The war deepfake pipeline and the [election deepfake pipeline](/blog/nrsc-talarico-deepfake-texas-law-loophole-2026-midterms) are converging.
