---
title: "Israel's Strike on IRGC Headquarters: 'Precision Operation' or 'War Crime in a Capital City'?"
description: "The same Israeli strike on Iran's Revolutionary Guard headquarters in Tehran gets described as a surgical military operation in Washington and a criminal attack on sovereignty in the Middle East. The PGI score of 8.68 makes it one of the most divided stories of 2026."
date: "2026-03-08"
...
author: "Albis"
tags: ["divided", "pgi", "iran", "israel", "irgc", "tehran", "war", "framing"]
sources:
  - name: "New York Times"
    url: "https://www.nytimes.com/2026/03/07/world/middleeast/us-israel-targets-iran.html"
    region: "North America"
    quote: "Israel sought to paralyze the chain of command in Iran. Israeli warplanes fired a barrage of missiles that struck the Iranian leadership compound in central Tehran."
  - name: "Al Jazeera"
    url: "https://www.aljazeera.com/news/2026/3/3/us-claims-destroyed-irgc-command-centre-more-israel-attacks-on-tehran"
    region: "Middle East"
    quote: "CENTCOM said it destroyed IRGC command and control facilities. It provided no evidence for its claims."
  - name: "The Guardian"
    url: "https://www.theguardian.com/world/2026/mar/04/israel-fresh-strikes-tehran-beirut-iran-targets-us-bases-gulf"
    region: "Europe"
    quote: "Washington has reportedly been exploring the possibility of using Kurdish separatist groups to invade parts of Iran and establish a safe zone."
  - name: "Global Times"
    url: "https://www.globaltimes.cn/page/202603/1356001.shtml"
    region: "Asia-Pacific"
    quote: "Since the Iranian side believes that the US and Israel had struck civilian sites including office buildings and schools, its attack on civilian facilities could be reciprocal strikes."
  - name: "The Hindu"
    ...
    region: "South Asia"
    quote: "Iran media reports Israeli strikes hit hospital in Tehran; U.S. says headquarters of Iran's Revolutionary Guards destroyed."
confidence: "confirmed"
faqs:
  - q: "What was the PGI score for the IRGC headquarters strike?"
    a: "The Albis Perception Gap Index scored it 8.68 out of 10, making it one of the most divided stories of 2026. The widest gap was between US and Middle Eastern coverage at 9.0."
  - q: "How do different regions describe the same strike?"
    a: "US media calls it a strike on 'military command centers' and 'terrorist infrastructure.' Middle Eastern outlets describe it as attacks near residential areas, hospitals, and civilian buildings in the Iranian capital. European coverage sits between, questioning legality while reporting military claims."
  - q: "What is the Perception Gap Index?"
    a: "The PGI measures how differently regions frame the same global event, scored from 1 (consensus) to 10 (completely opposing realities). It tracks six dimensions including factual divergence, causal attribution, and actor portrayal."
---
