...
sources:
  - name: "The Conversation"
    url: "https://theconversation.com/we-designed-an-ai-tutor-that-helps-college-students-reason-rather-than-give-them-answers-276584"
    region: "North America"
    quote: "Students who used Macro Buddy, alongside peer discussion, earned higher exam scores than students who worked alone, without this AI tutor."
  - name: "Fortune"
    url: "https://fortune.com/2026/02/24/students-cant-reason-teachers-warn-ai-fueling-crisis-in-kids-ability-to-think/"
    region: "North America"
    quote: "AI is so good at cheating that it's causing a 'great unwiring' of students' brains — including cognitive atrophy, artificial intimacy, and the erosion of relational trust."
  - name: "OECD Digital Education Outlook 2026"
    ...
    quote: "Offloading cognitive tasks to general-purpose chatbots creates risks of metacognitive laziness and disengagement that may deter skill acquisition in the long run."
  - name: "Brookings Institution"
    url: "https://www.brookings.edu/articles/a-new-direction-for-students-in-an-ai-world-prosper-prepare-protect/"
    region: "North America"
    quote: "The frictionless nature of generative AI is its most pernicious feature for students — by removing the struggle, AI acts as the 'fast food of education.'"
  - name: "Fast Company"
    url: "https://www.fastcompany.com/91503857/this-ai-tutor-helps-college-students-reason-without-giving-them-answers"
    region: "North America"
    quote: "Students who used Macro Buddy alongside peer discussion earned higher exam scores than those who studied alone."
faqs:
  - q: "Does using AI for studying help or hurt student learning?"
    a: "It depends entirely on how the AI is used. Students who use AI to get answers directly tend to score lower on exams when AI is removed, according to the OECD's 2026 digital education report. But students paired with an AI designed to prompt their own reasoning — and who also discussed concepts with classmates — actually outperformed those who studied alone."
  - q: "What is Macro Buddy and what did the study find?"
    a: "Macro Buddy is a custom AI tutor built by economists at the University of Wisconsin, La Crosse. Instead of giving students answers, it asks follow-up questions to guide their thinking. A spring 2025 study with 140 undergraduate macroeconomics students found that those using Macro Buddy alongside peer discussion earned higher exam scores than those who studied alone without any AI assistance."
  - q: "What did the Brookings Institution find about AI and student learning?"
    a: "A January 2026 Brookings Institution report based on 400+ studies and hundreds of interviews found that AI's 'frictionless' nature removes the cognitive struggle that is central to actual learning. The report described AI as 'fast food for education' — satisfying in the moment but cognitively hollow — and warned of a 'great unwiring' of students' reasoning abilities."
---
...
This matters globally. AI tutoring tools are being deployed at scale, often pitched as equalizers for low-resource schools. The [AI in education topic](/topics/ai) is central to how countries think about closing learning gaps. But Macro Buddy's results suggest design matters as much as availability.
...
*Albis tracks how knowledge and information travel across regions and disciplines. Explore the [AI topic hub](/topics/ai) for more on artificial intelligence and learning.*
