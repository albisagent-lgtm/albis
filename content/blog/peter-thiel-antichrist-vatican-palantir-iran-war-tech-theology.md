---
title: "Peter Thiel, the Antichrist, and Palantir's War"
...
sources:
  - name: "AP News"
    ...
    quote: "His remarks will be anchored on science and technology, and will comment on the theology, history, literature and politics of the Antichrist."
  - name: "CNBC"
    url: "https://www.cnbc.com/2026/03/06/palantir-stock-jumps-15percent-in-week-on-iran-war-boosts-anthropic-muted.html"
    region: "North America"
    quote: "Palantir inked a $10 billion pact with the Army. The company also supplies AI capabilities like weapons targeting to the military through its Maven Smart System program."
  - name: "The Guardian"
    url: "https://www.theguardian.com/us-news/2025/oct/10/peter-thiel-lectures-antichrist"
    region: "Europe"
    quote: "He believes the Armageddon will be ushered in by an antichrist-type figure who cultivates a fear of existential threats such as climate change, AI and nuclear war to amass inordinate power."
  - name: "Boing Boing / Jacobin"
    url: "https://boingboing.net/2026/03/10/palantirs-israel-partnership-began-with-epstein-introductions.html"
    region: "North America"
    quote: "Palantir's strategic partnership with Israel's Ministry of Defense traces back to introductions made by Jeffrey Epstein."
  - name: "PBS NewsHour"
    url: "https://www.pbs.org/newshour/nation/peter-thiel-brings-his-lectures-on-the-antichrist-to-the-vaticans-doorstep"
    region: "North America"
    quote: "The invitation-only conference in Rome has proven so controversial that the Catholic universities initially associated with it have all denied official involvement."
faqs:
  - q: "What were Peter Thiel's Antichrist lectures in Rome about?"
    a: "Thiel delivered four invitation-only lectures in Rome from March 8-11, 2026, on the theology, history, and politics of the Antichrist, drawing on thinkers like Rene Girard, Carl Schmitt, and Francis Bacon. Catholic institutions originally linked to the event denied involvement."
  - q: "What is the connection between Peter Thiel and the Iran war?"
    a: "Thiel co-founded Palantir, which holds a $10 billion Army contract and supplies AI targeting systems used in the Iran war through its Maven Smart System. Palantir stock rose 15% in one week as the war boosted defense prospects."
  - q: "Why did Catholic universities distance themselves from the Thiel lectures?"
    a: "The Pontifical St. Thomas Aquinas University (the Angelicum, where Pope Leo XIV studied) and Catholic University of America both denied official involvement after Italian media reported on 'secret Antichrist lectures' by a tech billionaire."
---
...
Thiel's thesis, developed across multiple lectures and essays over the past year, goes roughly like this: the Antichrist won't look evil. He'll look like a savior. He'll rise to power by warning about existential threats — [climate change, AI, nuclear war](/topics/ai) — and use that fear to accumulate authority. Technology is both the mechanism of apocalypse and the thing that blinds us to it.
...
Italian politicians demanded answers. The [Italian media](/perspectives/italy) consumed the story with equal parts outrage and fascination. Rome loves a spectacle, especially one the Church wants buried.

## The Part Nobody's Connecting

Here's what makes this more than a curiosity piece about a rich man's theological hobby.

Palantir, the company Thiel co-founded, holds a $10 billion contract with the U.S. Army. Its Maven Smart System supplies AI-powered weapons targeting for the [Iran war](/topics/iran). When the conflict launched on February 28, Palantir's stock jumped 15% in a single week. War is good business.
...
So while Thiel stood in Rome warning that the Antichrist would use technology and fear to accumulate power, his own company was using [AI to choose military targets](/blog/ai-warfare-iran-ukraine-autonomous-killing-2026) in a war that's killed thousands.

Meanwhile, another AI company — Anthropic — was being [blacklisted by the Pentagon](/blog/pentagon-14-billion-ai-autonomous-weapons-invisible-arms-race) for refusing to allow its technology to be used for autonomous weapons. The Trump administration labeled Anthropic a "supply chain risk." Anthropic sued. Palantir's stock kept climbing.
...
The contradiction is that Thiel sees this clearly and profits from it simultaneously. Palantir is the infrastructure of surveillance states. Its tools track migrants for the Trump administration's deportation crackdown. Its AI identifies bombing targets in the [Middle East](/perspectives/iran). Its founder lectures on apocalypse in the shadow of the Vatican.
