...
author: "Harry Wenham"
tags: ["health-longevity", "medical-devices", "fda", "medical-tourism", "cancer"]
sources:
  - name: "New York Times"
    url: "https://www.nytimes.com/2026/03/05/business/exthera-cancer-filter-federal-charges.html"
    region: "North America"
    quote: "Patients were charged $45,000 per treatment session"
  - name: "Reuters"
    url: "https://www.reuters.com/legal/government/blood-filter-start-up-ex-executive-face-us-charges-concealing-deaths-2026-03-06/"
    region: "International"
    quote: "Blood filter start-up, ex-executive face US charges for concealing deaths"
  - name: "RegTech Times"
    url: "https://regtechtimes.com/former-exthera-medical-corporation-executive-admits-to-concealing-patient-deaths-from-fda-and-company-enters-deferred-prosecution-agreement-doj/"
    region: "North America"
    quote: "Ilic notified some of ExThera's leadership of potential adverse events, including life-threatening complications, before starting treatments"
  - name: "IBTimes UK"
    url: "https://www.ibtimes.co.uk/california-medical-firm-penalty-concealing-patient-deaths-1783724"
    region: "Europe"
    quote: "A California medical tech firm is fined $5.6 million after an executive admits to hiding patient deaths from the FDA"
  - name: "CDC"
    url: "https://www.cdc.gov/yellow-book/hcp/health-care-abroad/medical-tourism.html"
    region: "North America"
    quote: "Oncology tourists are a vulnerable patient population because the fear caused by a cancer diagnosis can lead them to try potentially risky treatments"
confidence: "confirmed"
faqs:
  - q: "What happened with ExThera Medical and the cancer patient deaths?"
    a: "ExThera Medical, a California company, lured late-stage cancer patients to Antigua to use its blood filter device — which was only FDA-approved for Covid-19 ICU patients — charging $45,000 per session. Two patients died in April 2024, and the company's chief regulatory officer concealed the deaths from the FDA. She has agreed to plead guilty and faces up to three years in prison. ExThera must forfeit $5.7 million."
  - q: "What is ExThera's Seraph 100 blood filter and what is it approved for?"
    a: "The Seraph 100 is a blood filtration device that uses heparin-coated microbeads to bind and remove pathogens from the bloodstream. The FDA granted it emergency use authorization in April 2020 only for adult Covid-19 patients in intensive care with respiratory failure. It was never approved for cancer treatment, though ExThera marketed it as a cancer cure in Antigua."
  - q: "How common is medical tourism for unproven cancer treatments?"
    a: "An estimated 150,000 to 320,000 Americans travel abroad for healthcare annually. The CDC specifically warns that oncology tourists are vulnerable because cancer diagnoses can push patients toward risky, unproven treatments. The Caribbean, Mexico, and parts of Central America are common destinations for treatments not available or approved in the US."
---
