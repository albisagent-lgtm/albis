...
author: "Albis"
tags: ["health-longevity", "mental-health", "wearables", "neuroscience", "diagnostics"]
faqs:
  - q: "Can smart glasses really detect mental health conditions?"
    a: "Carolina Instruments' glasses track pupil size and eye movement using infrared light, not cameras. Pupil changes are well-established biomarkers of arousal states linked to ADHD, depression, anxiety, and PTSD. The technology detects shifts in neural signaling before behavioral symptoms appear."
  - q: "How does pupillometry work for mental health diagnosis?"
    a: "Your pupils respond to internal brain states, not just light. When arousal levels shift — through stress, anxiety, or cognitive load — your pupils dilate or constrict in measurable patterns. Research shows pupil tracking can detect depressive episodes with 76% accuracy and predict treatment response."
  - q: "When will mental health wearables be available to consumers?"
    a: "Carolina Instruments is currently focused on research applications, with clinical and consumer markets as future targets. The mental health wearables market is growing at 19% annually and is projected to reach $17.9 billion by 2035. Consumer-grade mental health glasses could emerge within 3-5 years."
sources:
  - name: "UNC Research"
    url: "https://research.unc.edu/story/eyes-on-the-brain/"
    region: "North America"
    quote: "We're trying to identify the neural circuits that modulate arousal, which then go on to modulate behavior."
  - name: "RIoT Accelerator"
    url: "https://riot.org/startup-spotlight-carolina-instruments-founder-transforming-neuroscience-inside-and-outside-the-lab/"
    region: "North America"
    quote: "We developed a wearable, camera-free method for measuring pupil size and eye motion with high precision."
  - name: "Acta Psychologica (ScienceDirect)"
    url: "https://www.sciencedirect.com/science/article/pii/S0001691825000332"
    region: "International"
    quote: "Pupillometry offers a uniquely sensitive biomarker of the functioning of several distinct networks, cognitive functions, emotional states."
  - name: "Stevens Institute / Neuroscience News"
    url: "https://neurosciencenews.com/ai-depression-facial-cue-eyes-27735/"
    region: "North America"
    quote: "The best iteration of PupilSense proved 76% accurate at flagging times when people did indeed feel depressed."
