...
faqs:
  - q: "What is Freedom.gov?"
    a: "Freedom.gov is a US State Department portal designed to help users in Europe and elsewhere bypass local content moderation laws, including hate speech and terrorist content restrictions. It includes a built-in VPN to make traffic appear to originate from the US."
  - q: "Why did the US create Freedom.gov?"
    a: "The US sees European laws like the Digital Services Act as censorship that violates free speech principles. American officials argue these regulations unfairly target conservative voices and impose European standards on American platforms and citizens."
  - q: "How has Europe reacted to Freedom.gov?"
    a: "European officials view it as 'a direct shot' at their laws. The European Commission expressed serious concern and warned it could take appropriate measures in response. Many see it as the US treating democratic Europe like an authoritarian regime."
sources:
  - name: "Reuters"
    url: "https://www.reuters.com/world/us-plans-online-portal-bypass-content-bans-europe-elsewhere-2026-02-18/"
    region: "International"
    quote: "The site will be hosted at 'freedom.gov,' the sources said. One source said officials had discussed including a virtual private network function to make a user's traffic appear to originate in the U.S."
  - name: "The Guardian"
    url: "https://www.theguardian.com/technology/2026/feb/19/us-builds-website-that-will-allow-europeans-to-view-blocked-content"
    region: "Europe"
    quote: "The portal features a graphic of a ghostly horse galloping above the Earth, and the motto: 'Information is power.'"
  - name: "Atlantic Council"
    url: "https://www.atlanticcouncil.org/blogs/new-atlanticist/us-eu-dispute-over-free-speech-is-set-to-escalate/"
    region: "North America"
    quote: "Kenneth Propp, former State Department official, called the plan 'a direct shot' at European rules and laws, saying freedom.gov 'would be perceived in Europe as a U.S. effort to frustrate national law provisions.'"
  - name: "House Judiciary Committee"
    url: "https://judiciary.house.gov/sites/evo-subsites/republicans-judiciary.house.gov/files/2026-02/THE-FOREIGN-CENSORSHIP-THREAT-PART-II-2-3-26.pdf"
    region: "North America"
    quote: "The European Commission weaponizes the Digital Services Act (DSA), a law regulating online speech, to impose undue restrictions on freedom of expression."
  - name: "Euronews"
    url: "https://www.euronews.com/my-europe/2026/02/09/is-the-eu-really-censoring-americans-interfering-in-elections-and-targeting-conservative-c"
    region: "Europe"
    quote: "House Judiciary Committee chairman Jim Jordan has been waging a 'crusade' intensifying throughout 2025, homing in on the idea that EU regulations force US platforms to adopt restrictive moderation policies globally."
...
The [Albis Perception Gap Index](/indexes/pgi) scored Freedom.gov coverage at 7 out of 10. American outlets framed it as defending liberty. European outlets framed it as undermining sovereignty. Same portal, opposite moral universes.
