---
title: "The Pentagon Banned Its Best AI. Now Staff Are Using Excel."
description: "Three weeks after blacklisting Anthropic's Claude, Pentagon workers are reverting to spreadsheets while officials quietly bet the ban won't last."
date: "2026-03-22"
author: "Albis"
image: "https://images.pexels.com/photos/5092815/pexels-photo-5092815.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800&w=1200"
tags: ["ai-intelligence", "pentagon", "anthropic", "claude", "military-ai", "us-defense"]
seoKeyword: "Pentagon Claude AI ban resistance Excel Anthropic military 2026"
faqs:
  - q: "Why did the Pentagon ban Anthropic's Claude AI?"
    a: "Defense Secretary Pete Hegseth designated Anthropic a 'supply chain risk' on March 3, 2026 after the company refused to remove safety guardrails preventing Claude's use in mass surveillance of Americans and fully autonomous weapons. The ban requires a six-month phase-out across all Pentagon systems and contractors."
  - q: "Is the US military still using Claude AI despite the ban?"
    a: "Yes. Reuters reported on March 19 that Claude remains in use for operations related to the Iran conflict. Pentagon staff are slow-rolling the phase-out, and some agencies are betting the ban will be reversed before the six-month deadline. Replacing Claude could take 12-18 months of system recertification."
  - q: "What is Palantir's connection to the Pentagon Claude AI dispute?"
    a: "Palantir's Maven Smart Systems platform — used for intelligence analysis and weapons targeting with contracts worth over $1 billion — was built using Anthropic's Claude Code. Replacing Claude means Palantir must rebuild parts of its software and recertify the entire system for classified use."
sources:
  - name: "Reuters"
    ...
    quote: "Career IT people at DOD hate this move because they had finally gotten operators comfortable using AI. They think it's stupid."
  - name: "Military Times"
    ...
    quote: "Tasks previously handled by Claude are in some cases now being done manually with tools such as Microsoft Excel."
  - name: "WIRED"
    url: "https://www.wired.com/story/anthropic-supply-chain-risk-shockwaves-silicon-valley/"
    region: "North America"
    quote: "This is the most shocking, damaging, and overreaching thing I have ever seen the United States government do."
  - name: "The Guardian"
    url: "https://www.theguardian.com/technology/2026/mar/01/claude-anthropic-iran-strikes-us-military"
    region: "Europe"
    quote: "US military command used the tools for intelligence purposes, as well as to help select targets and carry out battlefield simulations."
  - name: "World Policy Hub"
    url: "https://worldpolicyhub.com/military-ai-controversy-how-anthropics-claude-sparked-an-ethics-debate-with-the-pentagon/"
    region: "International"
    quote: "Claude was employed to generate targeting lists containing precise GPS coordinates for a large number of targets within a 24-hour period."
