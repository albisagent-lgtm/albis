...
sources:
  - name: "CNBC"
    ...
    quote: "In space, there's no convection, there's just radiation — and so we have to figure out how to cool these systems out in space."
  - name: "The Register"
    url: "https://www.theregister.com/2026/03/17/nvidia_chips_in_spaaaaaace/"
    region: "Europe"
    quote: "Nvidia's Rubin Module delivers up to 25 times the AI compute of an H100 GPU for space-based inferencing."
  - name: "Data Center Dynamics"
    ...
    quote: "SpaceX has filed plans with the FCC for up to one million orbital data center satellites."
  - name: "Gartner via The Register"
    url: "https://www.theregister.com/2026/02/25/gartner_orbiting_datacenter_peak_insanity"
    region: "North America"
    quote: "Companies are wasting money by pouring funds into the orbital data center 'bubble' because the economics do not work."
confidence: "confirmed"
faqs:
  - q: "What is Nvidia's Space-1 module for orbital data centers?"
    a: "The Vera Rubin Space-1 Module is an AI chip system Nvidia announced at GTC 2026, designed specifically for satellites and orbital data centers. It delivers up to 25 times the AI compute power of an H100 GPU in a compact, radiation-hardened package built for size-, weight-, and power-constrained environments."
  - q: "Why are companies building AI data centers in space?"
    a: "Space offers virtually unlimited solar power and avoids the electricity shortages plaguing terrestrial data centers. Companies like SpaceX, Google, and Starcloud believe orbital compute could process satellite imagery, run geospatial intelligence, and eventually offload AI inference from Earth — though critics say the economics don't work yet."
  - q: "How many satellites has SpaceX filed to launch for orbital AI data centers?"
    a: "SpaceX filed with the FCC in January 2026 to launch up to 1 million orbital data center satellites. The application was fast-tracked, meaning no environmental impact assessment is required — a decision that has alarmed astronomers worried about light pollution and orbital debris."
---
