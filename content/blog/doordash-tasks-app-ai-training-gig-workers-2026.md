---
title: "DoorDash Pays Couriers to Film Chores for AI Robots"
description: "DoorDash launched a standalone Tasks app paying its 8 million couriers to film themselves washing dishes, folding clothes, and speaking Spanish — all to train AI and robotics models. The privacy gaps and labor paradox nobody's examining."
pubDate: 2026-03-23
author: "Harry Wenham"
category: "tech-ai"
...
perception_gap: 3
regions_found: [us]
regions_absent: [eu, middle_east, asia_pacific, south_asia, africa, latam]
region_significance:
  us: 5
region_frames:
  us: "Framed as gig economy innovation and new earning opportunity rather than automation pipeline or labor exploitation"
...
sources:
  - name: "TechCrunch"
    ...
    quote: "One example of a task involves asking a courier to capture footage of their hands washing at least five dishes while wearing a body camera"
  - name: "NBC News"
    url: "https://www.nbcnews.com/tech/tech-news/doordash-now-letting-drivers-train-ai-rcna264387"
    region: "North America"
    quote: "We think this will be huge for building the frontier of physical intelligence"
  - name: "The Next Web"
    url: "https://thenextweb.com/news/doordash-launches-tasks"
    region: "Europe"
    quote: "DoorDash has not published detail on how it handles consent, data retention, or the rights workers have over footage of themselves in their own homes"
  - name: "Bloomberg"
    url: "https://www.bloomberg.com/news/articles/2026-03-19/doordash-s-new-paid-tasks-turn-couriers-into-ai-and-robot-trainers"
    region: "North America"
    quote: "Recording an unscripted conversation in Spanish, or filming themselves completing various household chores like loading a dishwasher"
  - name: "Los Angeles Times"
    url: "https://www.latimes.com/business/story/2026-03-12/why-people-in-la-are-strapping-cameras-on-their-bodies-to-do-chores"
    region: "North America"
    quote: "Handing out headbands with phone mounts, a simple piece of equipment that lets people record their every move"
faqs:
  - q: "What is the DoorDash Tasks app?"
    a: "DoorDash Tasks is a standalone app launched in March 2026 that pays the company's 8 million US delivery couriers to film themselves doing household chores and recording speech samples. The video and audio data is used to train AI and robotics models for DoorDash and its partners in retail, insurance, hospitality, and technology."
  - q: "How much does DoorDash Tasks pay workers?"
    a: "DoorDash says pay is shown upfront and based on effort and complexity. Harder tasks like pruning plants pay more than simpler ones like folding clothes. However, DoorDash hasn't disclosed average rates or minimum pay floors. The app excludes California, New York City, Seattle, and Colorado — states with stricter labor laws."
  - q: "Is DoorDash using gig workers to train robots that will replace them?"
    a: "DoorDash frames Tasks as additional earning opportunities, but the data directly trains AI and robotics systems designed to automate physical tasks. Sunday Robotics, Waymo, and others are building household and delivery robots using exactly this type of human-movement data. Workers are creating the training data for technologies that could reduce demand for human labor."
---
...
"This data helps AI and robotic systems understand the physical world," [DoorDash wrote](https://about.doordash.com/en-us/news/introducing-doordash-tasks) in its announcement. Pay is shown upfront, weighted by effort and complexity. Harder tasks pay more.
...
DoorDash isn't inventing this market. It's arriving in one that already exists and growing fast. The global [data annotation industry](/topics/ai) is worth roughly $2-3 billion in 2026 and projected to reach $7-14 billion by the early 2030s, depending on whose estimate you trust.
...
Uber saw this too. In October 2025, it [launched a similar pilot](https://www.cnbc.com/2025/10/16/uber-will-offer-us-drivers-more-gig-work-including-ai-data-labeling.html) through its AI Solutions Group, paying drivers to upload photos and recordings. Instawork, a staffing app, went further: the *Los Angeles Times* [reported in March](https://www.latimes.com/business/story/2026-03-12/why-people-in-la-are-strapping-cameras-on-their-bodies-to-do-chores) that the company was recruiting workers in LA to strap on headbands with phone mounts and film themselves cleaning their homes.
...
DoorDash's co-founder Andy Fang called it "building the frontier of physical intelligence." The [humanoid robot market](/topics/ai) is projected to hit $15 billion by 2030, up from under $3 billion today. Companies like Figure, Tesla, and Sunday Robotics are all racing to build machines that can navigate homes and complete domestic tasks. Every one of them needs exactly the data DoorDash is now collecting at scale.
...
A [March 2026 Longreads investigation](https://longreads.com/2026/03/17/ai-training-data-gig-economy/) put it starkly: "Producing training data means working toward your own obsolescence." *New York Magazine* found that laid-off professionals — lawyers, scientists, writers — are increasingly hired back as contractors to train the AI systems that [replaced them](/blog/ai-tutor-reasoning-vs-answers-learning-outcomes-2026).
...
DoorDash has not published details on consent mechanisms, data retention periods, or what happens to footage after it's submitted. According to [The Next Web's analysis](https://thenextweb.com/news/doordash-launches-tasks), the company hasn't disclosed whether workers can request deletion of their footage, who gains access to the audio recordings, or how long the data persists.
