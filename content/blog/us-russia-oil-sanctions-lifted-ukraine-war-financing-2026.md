...
faqs:
  - q: "Did the US lift sanctions on Russian oil in 2026?"
    a: "Yes. On March 5, 2026, OFAC issued General License 133, authorizing the delivery and sale of Russian crude oil already loaded on ships to India. It covered oil produced by sanctioned entities including Rosneft and Lukoil — Russia's two largest oil companies — and expired April 4, 2026."
  - q: "How does the Russia oil sanctions waiver help fund the Ukraine war?"
    a: "Russia's 2026 war budget assumed oil at $59/barrel. Sanctions had crushed Urals crude to $40/barrel, cutting revenues 44% year-on-year. The waiver — combined with Iran-war-driven price spikes — pushed Urals to nearly $99/barrel, generating an estimated $150 million/day in extra revenue that the Institute for the Study of War confirmed could finance Russia's continued war against Ukraine."
  - q: "Why did the US lift Russian oil sanctions during the Iran war?"
    a: "The Strait of Hormuz closure cut off India's access to Middle Eastern oil. India had pledged to stop buying Russian oil as part of a trade deal with the US. With that supply gone, the US issued a temporary waiver so India could keep buying Russian oil already in transit, managing global oil prices — and inadvertently rescuing Russia's war chest."
sources:
  - name: "OFAC / US Treasury"
    url: "https://ofac.treasury.gov/recent-actions/20260305_33"
    region: "North America"
    quote: "Russia-related General License 133 — Authorizing the Delivery and Sale of Crude Oil and Petroleum Products of Russian Federation Origin Loaded on Vessels as of March 5, 2026 to India"
  - name: "Institute for the Study of War (ISW)"
    url: "https://understandingwar.org/research/russia-ukraine/russian-offensive-campaign-assessment-march-13-2026/"
    region: "International"
    quote: "The US decision to provide Russia with sanctions relief on oil may financially benefit Russia by reversing months of declining Russian oil revenue and allow Russia to continue to finance its war against Ukraine in the medium term."
  - name: "Sullivan & Cromwell LLP"
    url: "https://www.sullcrom.com/insights/memo/2026/March/OFAC-General-License-133-Russian-Oil-India"
    region: "North America"
    quote: "GL 133 appears therefore to authorize both shipments on sanctioned 'shadow fleet' vessels and sales of products produced by sanctioned entities, including Rosneft and Lukoil."
  - name: "The Moscow Times"
    ...
    region: "International"
    quote: "According to calculations by the Financial Times, the surge in oil prices is generating as much as $150 million in additional revenue for Russia's budget each day."
  - name: "Foundation for Defense of Democracies (FDD)"
    ...
    region: "North America"
    quote: "Russia is desperate for additional revenue after falling energy receipts pushed its budget deficit to more than 90 percent of its full-year target just two months into 2026."
...
The [Albis Perception Gap Index](/indexes/pgi) scored this story 7.65 — meaning the gap between how US domestic audiences and Ukrainian/Arabic audiences are reading the same policy decision is one of the widest recorded this week.
...
*This article focuses on the mechanism behind OFAC General License 133. For the regional framing analysis — how different audiences are interpreting the same policy decision — see our [Divided piece on the Russia oil sanctions framing](/blog/russia-oil-sanctions-lifted-ukraine-war-financing-divided-pgi-2026).*
