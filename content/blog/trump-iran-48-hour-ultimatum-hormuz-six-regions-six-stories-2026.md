...
perception_gap: 7.5
regions_found: [us, eu, middle_east, asia_pacific, south_asia, latam]
regions_absent: [africa]
region_significance:
  us: 5
  eu: 5
  middle_east: 5
  ...
  latam: 3
region_frames:
  us: "Framed as justified coercion to reopen Hormuz shipping lanes"
  eu: "Framed as energy security emergency requiring urgent gas storage"
  middle_east: "Iranian media called it 'desperate'; Arabic media warned of food catastrophe for 100 million"
  asia_pacific: "Chinese media mapped 10 supply-chain cascades from potential Hormuz closure"
  south_asia: "Framed as economic contagion driving rupee collapse and capital flight"
  latam: "Covered as distant crisis with oil price implications"
sources:
  - "New York Times — Trump threatens Iranian power plants (March 22, 2026)"
  - "PressTV / BBC Persian — IRGC counter-threat: Hormuz closed until plants rebuilt"
  - "Al Jazeera Arabic — Gulf food security analysis citing 80-90% import dependency"
  - "Sina Finance / China Energy News — 10 supply chain cascades and fertiliser disruption"
  - "Dünya Gazetesi / Endeks24 — Turkey's $4-5 billion per $10/barrel economic modelling"
confidence: "confirmed"
faqs:
  - q: "What did Trump threaten Iran with in March 2026?"
    a: "Trump gave Iran a 48-hour deadline to reopen the Strait of Hormuz or face strikes on Iranian power plants, the most direct US infrastructure threat of the war."
  - q: "How did Iran respond to Trump's 48-hour ultimatum?"
    a: "The IRGC's Khatam al-Anbiya headquarters responded that the Strait of Hormuz would remain completely closed until any destroyed power plants were rebuilt — a counter-ultimatum largely absent from English-language coverage."
  - q: "Why does the Hormuz Strait matter for food security?"
    a: "Gulf states import 80-90% of their food through Hormuz-dependent shipping routes, putting roughly 100 million people at risk of food disruption if the strait stays closed."
---
...
US media framed Trump's threat as the logical next step in a pressure campaign. The Strait of Hormuz had been [effectively closed](/topics/iran-war) for weeks. Oil sat above $110 a barrel. American consumers felt it at the pump.
...
This strategic messaging — Iran using [food security](/topics/food-agriculture) as a wedge between the US and its Gulf allies — was invisible in English-language coverage.
...
Saudi media, meanwhile, framed the broader diplomatic rupture — including its [expulsion of Iranian diplomats](/blog/saudi-expels-iran-diplomats-beijing-agreement-dead-china-2026) — as self-defence against an aggressor violating "principles of Islamic brotherhood" and the China-brokered Beijing Agreement.
...
The [Albis Perception Gap Index](/indexes/pgi) scored this story at 7.5 out of 10 — Competing Realities tier.
