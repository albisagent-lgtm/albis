...
perception_gap: 6.6
regions_found: [us, latam]
regions_absent: [eu, middle_east, south_asia, asia_pacific, africa]
region_significance:
  us: 4
  latam: 4
region_frames:
  us: "Framed as proof that maximum pressure produces concessions from authoritarian regimes"
  latam: "Framed as sovereign state making concessions under imperial threat with Venezuela as the warning"
sources:
  - name: "The Atlantic"
    url: "https://www.theatlantic.com/national-security/2026/03/trump-plan-cuba/686497/"
    description: "US officials describe Venezuela operation as 'dry run' for Cuba"
  - name: "Foreign Policy"
    url: "https://foreignpolicy.com/2026/03/17/trump-regime-change-cuba-miguel-diaz-canel/"
    description: "Analysis of US potentially settling for less than regime change"
  - name: "The Guardian"
    url: "https://www.theguardian.com/world/2026/mar/17/donald-trump-can-take-cuba-oil"
    description: "Trump declares he will have 'the honour of taking Cuba'"
  - name: "Cuba Headlines"
    url: "https://www.cubaheadlines.com/articles/323736"
    description: "Cuban deputy FM admits political prisoners excluded from US negotiations"
  - name: "Reuters"
    url: "https://www.reuters.com/world/americas/cuba-release-51-prisoners-under-agreement-with-vatican-2026-03-13/"
    description: "Cuba to release 51 prisoners in Vatican-brokered deal"
confidence: "confirmed"
faqs:
  - q: "Why did Cuba release 51 prisoners in March 2026?"
    a: "Cuba announced the release under a deal with the Vatican, framing it as a humanitarian gesture. US media reported it as a concession to pressure from the Trump administration's oil blockade, which has caused three nationwide blackouts in March alone."
  - q: "Is the US planning military action against Cuba in 2026?"
    a: "The Atlantic reported that multiple US officials called the Venezuela military operation a 'dry run' for Cuba. Gen. Francis Donovan told Congress the Pentagon is not rehearsing an invasion, but stands ready to defend the embassy and Guantánamo Bay."
  - q: "How many political prisoners does Cuba have?"
    a: "Prisoners Defenders counts over 1,200 political prisoners. Justicia 11J reports at least 760. Cuba's deputy foreign minister admitted political prisoners exist but said they are excluded from US-Cuba negotiations."
---
...
This story scores a **6.6 on the Albis [Perception Gap Index](/indexes/pgi)**, with the US-Latin America pair hitting **7.0** — one of the sharpest hemispheric divides in today's scan.
...
Latin American audiences saw all of this. They saw it alongside the Venezuela seizure, alongside [Operation Southern Spear's 159 dead in US boat strikes](/blog/operation-southern-spear-159-dead-boat-strikes-invisible-2026), alongside the "Genesis" caravan of 75,000 migrants — many of them Cuban deportees — stranded on Mexico's southern border.
