...
sources:
  - name: "Goldman Sachs Research"
    url: "https://www.goldmansachs.com/insights/articles/aging-population-not-a-risk-to-the-global-economy-after-all"
    region: "International"
    quote: "In a very tangible sense, 70 is the new 53."
  - name: "MDPI Sustainability Journal"
    url: "https://www.mdpi.com/2071-1050/18/4/1841"
    region: "International"
    quote: "Demographic decline and productivity growth are not mutually exclusive. Instead, demographic contraction may serve as a catalyst for structural adjustment."
  - name: "IMF Working Paper"
    url: "https://www.imf.org/external/pubs/ft/wp/2016/wp16237.pdf"
    region: "International"
    quote: "Aging and slower population growth lowered the real neutral interest rate, hampering monetary policy's ability to reflate the economy."
  - name: "Uncharted Territories"
    url: "https://unchartedterritories.tomaspueyo.com/p/why-japan-succeeds-despite-stagnation"
    region: "International"
    quote: "Infrastructure in Japan is clean, functional, and regularly expanded. There is very little crime or disorder. Compared to a peer country like Britain, Japan seems to enjoy a higher quality of life."
faqs:
  - q: "Is the demographic time bomb real or not?"
    a: "It depends what you measure. Total GDP might stagnate with fewer workers. But GDP per capita — the part that affects living standards — can keep rising if productivity per worker climbs fast enough. Japan's 30-year 'crisis' hasn't crashed living standards. Goldman says healthier aging changes the math."
  - q: "If fewer workers don't mean economic collapse, why did governments spend decades fearing it?"
    a: "Because most demographic models assumed a fixed retirement age and static productivity. They didn't account for people staying healthier longer or AI offsetting workforce declines. Trillions were spent on pension reforms and immigration policy based on that old model. If it's wrong, those were the wrong fixes."
  - q: "What's the Japan paradox?"
    a: "Japan's population peaked in 2010 and has been shrinking since. The country's had 30 years of 'lost decades' with ~1% GDP growth. Yet it's still the world's 4th-5th largest economy, has low unemployment, functional infrastructure, and high quality of life. The doom narrative didn't match reality."
---
...
**The Albis Perception Gap Index scored this story 4.0 (Visible Divergence).** US coverage frames aging as productivity opportunity. European sources emphasize pension sustainability risks. Asia-Pacific coverage highlights Japan's paradox — 30 years of "demographic crisis" yet still thriving.
...
**"In a very tangible sense, 70 is the new 53,"** Daly writes.

If people age healthier, "old age" shifts. The working-age ratio matters less. A 70-year-old who's cognitively 53 doesn't retire at 65 the way someone did in 2000.
