...
sources:
  - name: "UN News"
    url: "https://news.un.org/en/story/2026/03/1167081"
    region: "International"
    quote: "Women worldwide have 64 per cent of the legal rights of men whilst 54 per cent of countries lack consent based legal definitions of rape."
  - name: "Latina Republic"
    ...
    quote: "The Ministry of Health of Brazil announced plans to provide 4.7 million psychological consultations in 2026 focused on the mental health needs of women experiencing violence."
  - name: "UK Government"
    url: "https://www.gov.uk/government/news/government-launches-landmark-gender-pay-gap-and-menopause-action-plans-to-help-women-thrive-at-work"
    region: "Europe"
    quote: "Employers with 250 or more employees will be encouraged to publish the steps they are taking to reduce their gender pay gap and support employees through menopause from April."
  - name: "CNBC"
    url: "https://www.cnbc.com/2026/03/06/gender-pay-gap-doubles-over-the-course-of-womens-careers-glassdoor-report.html"
    region: "North America"
    quote: "During the first 10 years of their careers, the overall gender pay gap between women and men grows from 12% to 19%."
  - name: "Reuters"
    url: "https://www.reuters.com/world/one-three-eu-women-face-violence-most-cases-unreported-survey-finds-2026-03-03/"
    region: "Europe"
    quote: "The scale of unreported violence shows systems must be improved and victims must be supported."
faqs:
  - q: "What percentage of countries have discriminatory laws against women?"
    a: "According to a UN Women report released March 4, 2026, nearly 70 percent of countries maintain discriminatory legal frameworks that prevent women from accessing justice on equal terms. Women worldwide have only 64 percent of the legal rights that men possess."
  - q: "What is femicide and which countries are addressing it?"
    a: "Femicide is the gender-based killing of women. Uzbekistan announced March 5, 2026, it will introduce legal responsibility for femicide as a distinct crime. Brazil is implementing the Brazil Pact Against Femicide with electronic monitoring of domestic violence offenders and executing outstanding arrest warrants."
  - q: "How large is the gender pay gap in 2026?"
    a: "A Glassdoor report from March 6, 2026, found that during the first ten years of women's careers, the overall gender pay gap grows from 12 percent to 19 percent. The UK is mandating gender pay gap action plans for large employers starting in spring 2027."
---
