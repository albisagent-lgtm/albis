...
tags: ["womens-rights", "gender-equality", "domestic-violence", "reproductive-rights", "political-representation"]
image: "https://picsum.photos/seed/womens-rights-diverging-trajectories-taliban-domestic-violence/1200/630"
confidence: "confirmed"
sources:
  - name: "Al Jazeera"
    url: "https://www.aljazeera.com/news/2026/3/8/marches-for-international-womens-day-denounce-war-abuse-and-oppression"
    region: "International"
    quote: "Thousands of demonstrators have taken to the streets around the world to mark International Women's Day, taking a stand on a number of issues including the US-Israeli war on Iran and gender-based violence."
  - name: "CNN"
    url: "https://edition.cnn.com/2026/03/01/asia/taliban-afghanistan-domestic-violence-legal"
    region: "International"
    quote: "The men have the right to rule completely the women. His word is the word of law – that's it."
  - name: "Latina Republic"
    url: "https://latinarepublic.com/2026/03/06/brazil-launches-new-measures-to-track-domestic-violence-offenders/"
    region: "Latin America"
    quote: "Through the Ministry of Justice and Public Security of Brazil, authorities will implement an electronic monitoring system known as Safe Woman Alert, designed to track individuals accused of domestic violence when courts have issued protective measures for victims."
  - name: "Human Rights Watch"
    url: "https://www.hrw.org/news/2026/03/06/us-abortion-restrictions-causing-preventable-deaths"
    region: "North America"
    quote: "Women in states with abortion bans are twice as likely to die from pregnancy-related causes as those in states where abortion is legal and accessible."
  - name: "UN News"
    url: "https://news.un.org/en/story/2026/03/1167092"
    region: "International"
    quote: "Women's parliamentary representation remained lowest in the Middle East and North Africa, where women hold just 16.2 per cent of seats on average."
  - name: "Gazeta.uz"
    url: "https://www.gazeta.uz/en/2026/03/05/violence/"
    region: "Central Asia"
    quote: "The decree also proposes introducing legal responsibility for femicide (gender-based killing of women), familicide (killing of family members), stalking, cyberviolence and online grooming aimed at sexual exploitation of minors."
faqs:
  - q: "What does the Taliban's new domestic violence law allow?"
    a: "The decree permits men to beat their wives as long as they don't break bones or leave open wounds. Only severe violence resulting in broken bones, open wounds, or visible bruising triggers punishment of 15 days imprisonment. Given that Afghan women cannot leave home without a male guardian and their testimony is worth half that of a man's, the law effectively blocks access to justice."
  - q: "How does women's political representation vary globally?"
    a: "As of 2026, women hold 27.5% of parliamentary seats worldwide. The Americas lead at 35.6%, while the Middle East and North Africa lag at just 16.2%. Three countries—Oman, Tuvalu, and Yemen—have no women MPs at all. Chambers with quota legislation average 31% women compared to 23% without quotas."
  - q: "What impact are US abortion restrictions having on maternal mortality?"
    a: "According to Human Rights Watch and the Gender Equity Policy Institute, women in US states with abortion bans are twice as likely to die from pregnancy-related causes as those in states where abortion is accessible. The US has the highest maternal mortality rate among high-income nations, with 80% of maternal deaths considered preventable."
---
