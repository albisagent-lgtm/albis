...
sources:
  - name: "BioSpace"
    url: "https://www.biospace.com/fda/fdas-one-trial-policy-not-a-revolution-but-a-potentially-risky-evolution"
    region: "North America"
    quote: "In 2024, 66% of all new molecular entities approved by CDER relied on evidence from just one clinical trial"
  - name: "CNBC"
    url: "https://www.cnbc.com/2026/03/03/fda-watchers-warn-agency-chaos-drug-approval-delays-health-risks.html"
    region: "North America"
    quote: "The agency is in a bit of chaos — it's hemorrhaging people"
  - name: "STAT News"
    url: "https://www.statnews.com/2026/03/06/fda-vinay-prasad-controversial-cber-director-leaving/"
    region: "North America"
    quote: "Prasad's center has recently rejected at least five cell and gene therapies that experts believe likely could have received approval under previous FDA officials"
  - name: "New York Times"
    url: "https://www.nytimes.com/2026/03/05/health/fda-drugs-rare-diseases-rfk-jr.html"
    region: "North America"
    quote: "Patients with rare diseases view recent decisions as signs that the doors are closing on their options"
  - name: "PharmExec"
    url: "https://www.pharmexec.com/view/fda-removes-two-study-requirement-new-drug-approval-process-report"
    region: "North America"
    quote: "Over-reliance on two trials no longer makes sense"
...
region_significance:
  us: 5
region_frames:
  us: "Split between 'faster innovation' framing and 'safety erosion' framing depending on political alignment"
faqs:
  - q: "Does the FDA now only require one clinical trial to approve drugs?"
    a: "Yes, as of March 2026, the FDA officially shifted its default standard so that one adequate and well-controlled clinical trial is generally sufficient for drug approval. However, 66% of drugs were already approved on single-trial evidence in 2024, so in practice this formalises an existing trend rather than creating a new one."
  - q: "How many FDA staff have left under Makary's leadership?"
    a: "The FDA's oncology review staff has dropped from about 100 people to below 60 — a 40% reduction. The Center for Drug Evaluation and Research had five different directors in 2025 alone, and senior officials continue to leave at a steady rate."
  - q: "Is the FDA one-trial policy safe for patients?"
    a: "Experts are divided. Supporters argue that modern biology and statistical methods make a second trial redundant. Critics point out that the agency is simultaneously rejecting rare disease treatments that had existing data, and that the staff exodus means fewer experienced reviewers to catch problems in single-trial submissions."
---
...
The FDA approved the first [at-home brain stimulation device](/blog/fda-brain-stimulation-device-depression-2026) for major depression this month — a genuinely new kind of treatment reaching patients faster. That's the version of this story the administration wants you to see. The Huntington's patients who were turned away? That's the version they'd rather you didn't.
