---
title: "Biggest Chip Smuggling Case Ever. Policy Just Changed."
...
sources:
  - name: "CNBC"
    ...
    quote: "Super Micro fell 33% on Friday after a federal court released the indictment."
  - name: "Fortune"
    url: "https://fortune.com/2026/03/19/supermicro-arrested-founder-smuggling-gpu-china/"
    region: "North America"
    quote: "During a three-week period from late April to mid-May 2025, about half a billion worth of servers assembled in the U.S. were shipped to China as part of the alleged conspiracy."
  - name: "Reuters"
    url: "https://www.reuters.com/world/us-charges-three-people-with-conspiring-divert-ai-tech-china-2026-03-19/"
    region: "International"
    quote: "US officials allege the three were using hair dryers to remove labels and serial numbers from the real machines and placing them on dummy machines left behind after the real machines had been shipped to China."
  - name: "Introl / BIS Federal Register"
    url: "https://introl.com/blog/bis-h200-china-export-policy-ai-overwatch-act-2026"
    region: "North America"
    quote: "The Bureau of Industry and Security loosened H200 export restrictions to China on January 15, 2026, moving from presumption of denial to case-by-case review with a 25% Section 232 tariff."
  - name: "Caixin Global"
    url: "https://www.caixinglobal.com/2026-01-14/us-eases-restrictions-on-nvidia-h200-chip-exports-to-china-102403667.html"
    region: "Asia-Pacific"
    quote: "The US eased restrictions on Nvidia H200 chip exports to mainland China and Macao under a case-by-case review process, relaxing a previous policy that effectively banned such transactions."
...
The [semiconductor competition with China](/topics/ai) isn't one battle — it's three, running simultaneously and moving in different directions.
...
This doesn't make the alleged conduct legal — it wasn't, when it happened. But it does make the strategic picture more complicated than "the US caught the bad guys." The [AI chip export control debate](/topics/ai) is now a three-way collision between prosecutors enforcing old rules, regulators rewriting them, and a market that keeps moving either way.
