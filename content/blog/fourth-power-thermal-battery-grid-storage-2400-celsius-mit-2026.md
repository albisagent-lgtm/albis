...
sources:
  - name: "MIT News"
    url: "https://news.mit.edu/2026/turning-extreme-heat-large-scale-energy-storage-0318"
    region: "North America"
  - name: "TechCrunch"
    url: "https://techcrunch.com/2025/09/16/fourth-powers-sci-fi-thermal-batteries-could-be-cheaper-than-pricey-natural-gas-power-plants/"
    region: "North America"
  - name: "Amperon / S&P Global"
    url: "https://www.amperon.co/blog/us-solar-and-wind-curtailment-is-exploding"
    region: "North America"
  - name: "SolarTech Online"
    url: "https://solartechonline.com/blog/what-is-energy-curtailment/"
    region: "International"
  - name: "Renewable Energy Magazine"
    url: "https://www.renewableenergymagazine.com/storage/fourth-power-secures-19m-for-lowcost-utilityscale-20231222"
    region: "International"
faqs:
  - q: "What is a thermal battery and how does it store energy?"
    a: "A thermal battery stores electricity as heat rather than chemical energy. Fourth Power's system heats carbon blocks to 2,400°C using excess grid electricity, then pumps molten tin through graphite pipes to convert the stored heat back into power via thermophotovoltaic cells — the same principle as a solar panel, but using white-hot infrared light instead of sunlight."
  - q: "Why is renewable energy curtailment a problem in 2026?"
    a: "Solar and wind farms sometimes produce more electricity than the grid can use or transmit. In 2024, the US curtailed 20 million MWh of clean energy — throwing it away because no storage existed to absorb it. California alone curtailed 3.4 million MWh (up 29% from 2023). SPP's curtailment increased sixfold since 2020."
  - q: "How cheap could Fourth Power's thermal batteries get?"
    a: "Fourth Power targets $25 per kilowatt-hour at scale — roughly one-tenth the cost of grid-scale lithium-ion batteries. The company raised $39 million across two rounds and plans to deliver commercial batteries in 2028, starting with a 1 MWh demonstration prototype this year."
---
...
The [renewable energy transition](/topics/climate) doesn't have a generation problem — it has a storage and transmission problem. Clean power is already [being generated faster than it can be used](/blog/us-record-86gw-clean-energy-2026). Twenty million megawatt-hours of evidence landed in 2024 to prove it.
