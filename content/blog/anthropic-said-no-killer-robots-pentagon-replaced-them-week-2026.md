...
tags: ["ai-intelligence", "anthropic", "pentagon", "military-ai", "xai", "openai", "autonomous-weapons", "defense"]
faqs:
  - q: "Why did the Pentagon ban Anthropic?"
    a: "Anthropic refused to let its AI models be used for fully autonomous weapons or mass domestic surveillance of Americans. The Pentagon wanted those restrictions removed. When Anthropic said no, Defense Secretary Pete Hegseth designated the company a 'supply chain risk' and ordered all contractors to stop doing business with them."
  - q: "What AI companies are replacing Anthropic in the Pentagon?"
    a: "Elon Musk's xAI (maker of Grok) has already secured a deal for classified networks, agreeing to 'all lawful use' with no ethical restrictions. OpenAI is also moving in. Both companies accepted terms Anthropic refused."
  - q: "Can Anthropic fight the Pentagon ban legally?"
    a: "Anthropic argues that Defense Secretary Hegseth lacks the legal authority to bar companies from doing business with both Anthropic and the government. The company has threatened to sue if the designation becomes official. Legal experts call the Pentagon's basis 'extremely flimsy,' but contractors are complying anyway because they can't risk their defense revenue."
---
