...
sources:
  ...
  - "The American Prospect, 'Iran War Exposes America's Unfixed Supply Chains,' March 12, 2026"
  - "TFI (Fertilizer Institute), 'Strait of Hormuz Closure Impacts to Fertilizer,' March 2026"
  - "Tandfonline, 'Securing defense critical minerals: Challenges and U.S. strategic responses,' 2025"
confidence: "confirmed"
faqs:
  - q: "What does the Hormuz blockade do to US weapons production?"
    a: "The blockade has caused a near-total disruption of sulfur shipments through Hormuz, which handles 50% of global seaborne sulfur trade. Sulfur is converted to sulfuric acid — needed to extract copper, cobalt and rare earth elements used in precision-guided munitions, jet engines and drone batteries. Sulfur prices have surged 165% year-over-year and 25% since the Iran war began."
  - q: "Why is sulfur important to the US military?"
    a: "Sulfur is processed into sulfuric acid, which is essential for extracting the critical minerals — copper, cobalt, rare earths — that go into semiconductors, precision weapons, radar systems, and drone batteries. Without a steady sulfur supply, replacing war-damaged equipment could cost double or more than normal, according to West Point's Modern War Institute."
  - q: "How many people are unaware of this story?"
    a: "The Albis GAI score for this story is 6.64 (Information Shadow). Only the US has coverage. An estimated 5.87 billion people — the entire non-American world — have no visibility on the self-undermining dynamic at the heart of the Iran war."
---
...
**GAI Score: 6.64 (Information Shadow).** Seen in: US only. Blind regions: EU (450M), Middle East (600M), Asia Pacific (1.55B), South Asia (1.40B), Africa (1.40B), Latin America (660M).
...
The [Albis Global Attention Index](/indexes/gai) tracks stories by how many people can't see them. This one scores 6.64 — Information Shadow — because a HIGH significance story is visible in exactly one region.
