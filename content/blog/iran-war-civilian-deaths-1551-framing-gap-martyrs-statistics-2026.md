---
title: "Iran War Civilian Deaths: Martyrs or Statistics?"
description: "HRANA counts 1,551 civilian dead including 236 children in one month. Farsi press names each one as a martyr. English press reports the number and moves on. The same dead, two different wars."
pubDate: 2026-03-29
author: James Chen
...
region_significance:
  ...
  south_asia: 4
region_frames:
  us: "Reports aggregate casualty numbers with clinical distance, attributes deaths to 'the war'"
  eu: "Humanitarian concern framing, emphasis on international law and proportionality"
  middle_east: "Names individual victims, uses martyrdom language, attributes deaths to US-Israel aggression"
  south_asia: "Frames through energy crisis lens, civilian toll secondary to oil supply disruption"
sources:
  - name: "HRANA (Human Rights Activists News Agency)"
    url: "https://www.en-hrana.org"
  - name: "BBC News"
    url: "https://www.bbc.com/news/articles/c3v6ld7lv9no"
  - name: "New York Times"
    url: "https://www.nytimes.com/live/2026/03/28/world/iran-war-trump-israel-oil"
  - name: "Firstpost"
    url: "https://www.firstpost.com/world/us-israel-iran-war-live-updates-houthis-join-mideast-war-iran-tells-gulf-states-to-cut-support-for-us-israel-liveblog-13994189.html"
  - name: "Al Jazeera"
    url: "https://www.aljazeera.com/news/2026/3/2/iran-death-toll-reaches-555-as-us-israel-escalate-attacks"
confidence: "confirmed"
faqs:
  - q: "How many civilians have died in the Iran war?"
    a: "HRANA has documented at least 1,551 civilian deaths as of March 28, 2026, including 236 children. The real number is likely higher due to Iran's internet blackout making verification difficult."
  - q: "Why do different countries report Iran war casualties differently?"
    a: "Western outlets tend to report aggregate numbers without individual stories. Farsi and Arabic media name victims individually, use martyrdom language, and attribute deaths to US-Israel aggression. The same people die — but the framing determines whether readers see statistics or human beings."
  - q: "What is the PGI score for Iran war civilian casualty coverage?"
    a: "The Albis Perception Gap Index scores this story at 7.15 out of 10, with the sharpest divergence between US and Middle Eastern coverage (8.0). Factual reporting, causal attribution, and emotional register all diverge sharply across regions."
---

The Iran war has killed at least 1,551 civilians in one month, including 236 children, according to HRANA. The [Albis Perception Gap Index](/indexes/pgi) scores the framing of these deaths at 7.15 — one of the highest divergences of the conflict. In Farsi press, each casualty is named, mourned, and called a martyr. In English press, they're a paragraph buried in a live blog. Same dead. Two different wars.
...
HRANA, the US-based Human Rights Activists News Agency, has tracked [every documented civilian death](/blog/israel-strikes-khondab-ardakan-bushehr-nuclear-sites-framing-2026) since February 28. By March 17, they'd counted 3,114 total deaths in Iran — 1,354 civilians, 1,138 military, 622 unclassified. By March 28, the civilian count alone had reached 1,551. Fifteen percent were children.
...
When a strike killed a [family of four in Bushehr province](https://www.firstpost.com/world/us-israel-iran-war-live-updates-houthis-join-mideast-war-iran-tells-gulf-states-to-cut-support-for-us-israel-liveblog-13994189.html) this week, Farsi outlets named each member. English-language wire services reported "a family of four killed in Bushehr" and filed the next paragraph about the water facility hit in Khuzestan.
...
**Actor portrayal: 7.0.** In Farsi media, the dead are heroes — a meteorologist killed in Bushehr on World Meteorology Day became a symbol of innocence lost. In English media, he doesn't exist.

**Cui bono: 7.5.** ME media attributes every death to "US-Israel aggression." Western media frames casualties as "consequences of war" — a passive construction that dissolves accountability into atmosphere.

**Causal attribution: 7.5.** This is the deepest split. When HRANA reports 1,551 civilians dead, Farsi press asks: who dropped the bombs? English press asks: how high is the number? The question determines the answer your readers get.

The sharpest regional pair is US-ME at 8.0. That's near the maximum. American and Middle Eastern audiences aren't just seeing the same story differently — they're seeing different stories entirely.

## What four billion people don't see

Three regions — Asia-Pacific, Latin America, and Africa, home to 3.6 billion people — have almost no coverage of Iran's civilian toll. India's media covers the war through its [oil crisis lens](/blog/oecd-iran-war-inflation-india-crisis-new-york-new-delhi-2026), where the dead are backdrop to barrel prices. The Philippines just [declared an energy emergency](/blog/philippines-energy-emergency-45-days-fuel-left-2026). The civilians in Bushehr and Khuzestan don't register.
