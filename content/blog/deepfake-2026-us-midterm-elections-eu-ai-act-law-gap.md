...
sources:
  - name: "European Commission"
    ...
    region: "Europe"
    quote: "This timeline allows sufficient time for providers and deployers to prepare for compliance before the rules take effect in August 2026."
  - name: "CNN Politics"
    url: "https://www.cnn.com/2026/03/13/politics/james-talarico-ai-deepfake-republicans-midterms"
    region: "North America"
    quote: "While roughly half of states have passed a law relating to campaign deepfakes, many of the others simply require disclosure when an ad was made with AI."
  - name: "Foreign Affairs Forum"
    url: "https://www.faf.ae/home/2026/3/19/x1"
    region: "International"
    quote: "The 2026 Iran conflict has crossed a qualitative threshold. AI-generated content now constitutes a larger share of the disinformation ecosystem than content produced through traditional manipulation methods."
  - name: "Columbia Law Review (EU AI Act)"
    url: "https://cjel.law.columbia.edu/preliminary-reference/2024/deepfake-deep-trouble-the-european-ai-act-and-the-fight-against-ai-generated-misinformation/"
    region: "International"
    quote: "Non-compliance with the mandated obligations is punishable by hefty fines that can reach up to 35 million euros or 7 percent of global annual turnover."
  - name: "India Today"
    url: "https://www.indiatoday.in/india/story/pakistan-deepfakes-digital-propaganda-india-west-asia-crisis-2879939-2026-03-10"
    region: "Asia-Pacific"
    quote: "The PIB Fact Check unit has flagged a deepfake video of External Affairs Minister S Jaishankar as part of a wider Pakistan-linked misinformation campaign during the West Asia crisis."
faqs:
  - q: "What does the EU AI Act say about deepfakes?"
    a: "Article 50 of the EU AI Act requires all AI-generated content to be labelled as synthetic in a machine-readable format. Enforcement begins August 2, 2026. Non-compliance carries fines up to €35 million or 7% of global annual revenue, whichever is higher."
  - q: "Are deepfakes being used in the 2026 US midterm elections?"
    a: "Yes. On March 11, 2026, the National Republican Senatorial Committee posted an attack ad using a deepfake of Texas Senate candidate James Talarico. Twenty-six states have some form of deepfake law, but there is no federal framework — leaving the other 24 states with no rules at all."
  - q: "How are deepfakes being used in the Iran war?"
    a: "The Iran-Israel conflict has been called the first prolonged 'cognitive warfare laboratory' by defence analysts. Iran's IRGC deployed deepfakes falsely claiming to have killed Israeli PM Netanyahu. Pakistan used AI-generated videos of Indian military leaders to spread disinformation. AI-generated content now constitutes a larger share of the disinformation ecosystem in this conflict than traditionally manipulated material."
---
...
*For more on how information shapes perception across borders, see the [Albis Perception Gap Index](/indexes/pgi) and our [AI and information warfare coverage](/topics/ai).*
