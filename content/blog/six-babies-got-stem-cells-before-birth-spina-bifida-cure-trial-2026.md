...
sources:
  - name: "The Lancet"
    url: "https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(25)02466-3/fulltext"
    region: "International"
    quote: "Motor function of the legs was improved. This observation gave us hope that we could further advance neurological outcomes"
  - name: "UC Davis Health"
    ...
    quote: "Putting stem cells into a growing fetus was a total unknown. We are excited to report great safety"
  - name: "The Guardian"
    url: "https://www.theguardian.com/science/2026/feb/26/giving-stem-cells-in-utero-to-babies-with-spina-bifida-boosts-quality-of-life-trial-finds"
    region: "Europe"
    quote: "Surgeons applied placenta-derived mesenchymal stem cells onto the exposed spinal cord of the babies at 24 to 25 weeks of gestation"
  - name: "Science (AAAS)"
    url: "https://www.science.org/content/article/treating-fetuses-stem-cells-proves-safe-milestone-spina-bifida-trial"
    region: "North America"
    quote: "He is one of six children whose data are included in a study showing the approach doesn't have short-term harmful side effects"
  - name: "Gizmodo"
    url: "https://gizmodo.com/scientists-injected-stem-cells-into-fetuses-to-treat-a-birth-defect-heres-what-happened-2000727597"
    region: "North America"
    quote: "MRI scans showed that the newborns all experienced a reversal of their hindbrain herniation"
confidence: "confirmed"
faqs:
  - question: "What is the CuRe Trial?"
    answer: "The CuRe (Cellular Therapy for In Utero Repair of Myelomeningocele) Trial is a first-in-human clinical study at UC Davis that combines standard fetal surgery for spina bifida with placenta-derived stem cells applied directly to the exposed spinal cord. Phase 1 results published in The Lancet showed the approach is safe."
  - question: "Did the stem cells help the babies walk?"
    answer: "It's too early to say definitively. The trial was designed to test safety, not effectiveness. However, all six babies showed reversal of hindbrain herniation and none needed brain shunts before leaving hospital — both positive signs. Leg motor function showed improvement. Larger trials are needed to confirm whether stem cells improve mobility beyond surgery alone."
  - question: "When could this treatment become widely available?"
    answer: "The trial is now expanding to enroll more patients in Phase 2. Even with positive results, regulatory approval would likely take several more years. The treatment requires specialized fetal surgery capabilities that exist at only a handful of medical centers worldwide."
---
