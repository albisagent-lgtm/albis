...
RAND analysts note a complication: the January 2026 protests, which drew millions, had already fractured the establishment's consensus. Khamenei himself had elevated Ali Larijani — a former IRGC general — to effectively run the country in the weeks before his death. Whether the Assembly selects a Supreme Leader or opts for a leadership council remains genuinely unclear.

Foreign Minister Abbas Araghchi's public statements suggest IRGC regional commanders may already be operating under pre-authorised strike authority. If the senior command structure is fragmented, individual commanders making tactical decisions without central coordination becomes the default. That's how wars spiral.
...
Each Iranian strike on Gulf soil pushes those governments closer to joining the anti-Iran coalition. Reuters analysis notes that the countries Iran needs most for mediation or back-channel diplomacy are precisely the ones it's bombing. The 2023 China-brokered detente between Riyadh and Tehran is functionally dead.
