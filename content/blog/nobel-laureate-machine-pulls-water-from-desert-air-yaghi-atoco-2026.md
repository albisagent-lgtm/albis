...
author: "Albis"
tags: ["clean-energy", "water", "technology", "climate", "innovation"]
faqs:
  - q: "How does Omar Yaghi's water harvester work?"
    a: "It uses metal-organic frameworks (MOFs) — crystalline materials with internal surface areas so vast that one gram has the pore space of a football field. At night, the MOFs trap water vapour from air. During the day, sunlight heats them, releasing the moisture as liquid water. No electricity needed."
  - q: "How much water can the Atoco machine produce?"
    a: "The commercial unit, roughly the size of a 20-foot shipping container, produces up to 1,000 litres (265 gallons) of clean drinking water per day. It works in humidity as low as 20% — bone-dry desert conditions."
  - q: "When will Yaghi's water harvester be available to buy?"
    a: "Atoco plans to start taking orders in late 2026. Early targets include data centres (which consume around 530,000 gallons daily), green hydrogen plants, and drought-hit communities in the Caribbean, Middle East, and sub-Saharan Africa."
---
