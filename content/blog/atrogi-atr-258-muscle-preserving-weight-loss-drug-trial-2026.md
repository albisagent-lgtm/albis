...
sources:
  - name: "Longevity Technology"
    ...
    region: "Europe"
    quote: "Can you help people lose fat without sacrificing muscle?"
  - name: "PR Newswire / Atrogi"
    url: "https://www.prnewswire.com/news-releases/atrogi-announces-first-subjects-dosed-in-human-trial-for-lead-candidate-atr-258-302716294.html"
    region: "Europe"
    quote: "Preserve, or even augment, muscle function in various conditions of muscle wasting, such as immobilization, aging, and weight loss"
  - name: "University of Cambridge"
    url: "https://www.cam.ac.uk/research/news/patients-regain-weight-rapidly-after-stopping-weight-loss-drugs-but-still-keep-off-a-quarter-of"
    region: "Europe"
    quote: "Lean body mass — including muscle — can constitute up to 40% of total weight lost during treatment"
  - name: "CNBC"
    url: "https://www.cnbc.com/2026/02/04/eli-lilly-novo-nordisk-earnings-glp1-market.html"
    region: "North America"
    quote: "Lilly forecasted 2026 sales of $80 billion to $83 billion"
  - name: "UC Davis"
    url: "https://www.ucdavis.edu/news/glp-1-and-health-beyond-weight-loss-ozempic-era"
    region: "North America"
    quote: "Rapid weight reduction can lead to 15–25% lean muscle mass loss"
confidence: "confirmed"
faqs:
  - q: "How much muscle do you lose on Ozempic or Wegovy?"
    a: "Studies show up to 40% of total weight lost on GLP-1 drugs like Ozempic and Wegovy can come from lean muscle mass rather than fat. UC Davis research puts the range at 15–25% lean mass loss, with some analyses showing figures as high as 39%."
  - q: "What is ATR-258 and how does it preserve muscle during weight loss?"
    a: "ATR-258 is an oral drug by Swedish biotech Atrogi that uses biased β2-adrenergic receptor signaling to target skeletal muscle directly. It aims to mimic the metabolic effects of exercise — burning fat while preserving or even building lean muscle tissue — without the cardiovascular side effects of older drugs in this class."
  - q: "When will muscle-preserving weight loss drugs be available?"
    a: "ATR-258 is in early human trials as of March 2026, with an 8-week study underway at the University of Copenhagen. If successful, it would still need Phase 2 and Phase 3 trials before approval, likely placing availability several years away. Other companies are also racing to solve the GLP-1 muscle loss problem."
---
