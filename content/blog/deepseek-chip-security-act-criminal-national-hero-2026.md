---
title: "DeepSeek: Criminal in DC, National Hero in Beijing"
description: "The US House passed the Chip Security Act after a $2.5B smuggling probe. China celebrates DeepSeek V4 running on domestic chips as proof export controls failed. Same company, two incompatible stories."
date: 2026-03-29
...
perception_gap: 6
regions_found: [us, ap]
regions_absent: [eu, middle_east, south_asia, latam, africa]
region_significance:
  us: 5
  asia_pacific: 5
region_frames:
  us: "Criminal enterprise exploiting American technology, requiring stricter controls"
  asia_pacific: "National triumph proving export controls failed and China can build its own AI stack"
sources:
  - name: "Select Committee on the CCP"
    url: "https://chinaselectcommittee.house.gov/media/press-releases/house-committee-passes-chip-security-act"
    region: "North America"
    quote: "America has the best semiconductors in the world and we must defend our advantage over China"
  - name: "Prism News"
    url: "https://www.prismnews.com/news/house-foreign-affairs-committee-advances-chip-security-act"
    region: "North America"
    quote: "Super Micro's co-founder was in federal custody on smuggling charges when the House Foreign Affairs Committee advanced the Chip Security Act"
  - name: "Reuters"
    url: "https://www.reuters.com/world/us-charges-three-people-with-conspiring-divert-ai-tech-china-2026-03-19/"
    region: "International"
    quote: "U.S. officials allege the three took extensive measures to conceal their activity"
  - name: "ITI (Information Technology Industry Council)"
    url: "https://www.itic.org/news-events/techwonk-blog/the-unintended-consequence-of-the-chip-security-act"
    region: "North America"
    quote: "Chinese companies would market their products as tracking-free, forcing U.S. partners to choose"
  - name: "Particula Tech"
    url: "https://particula.tech/blog/deepseek-v4-qwen-open-source-ai-disruption"
    region: "International"
    quote: "V4 was optimized for Huawei Ascend and Cambricon chips, with DeepSeek withholding early access from Nvidia and AMD"
faqs:
  - q: "What is the Chip Security Act and why was it passed?"
    a: "The Chip Security Act (H.R. 3447) is US legislation requiring location verification for advanced AI chips sold abroad. It passed the House Foreign Affairs Committee on March 26, 2026, after a $2.5 billion smuggling scheme funnelled restricted Nvidia chips to China through shell companies in Taiwan and Southeast Asia."
  - q: "Did DeepSeek use smuggled Nvidia chips?"
    a: "Yes. The House Select Committee on China concluded that DeepSeek trained its AI models using restricted Nvidia chips, including Blackwell-generation hardware banned from export to China. Three people linked to Super Micro Computer were charged in the smuggling scheme."
  - q: "Is DeepSeek still using Nvidia chips?"
    a: "DeepSeek V4, its latest trillion-parameter model, was optimized for domestic Chinese chips — Huawei Ascend and Cambricon hardware. DeepSeek gave early access to Chinese chipmakers and withheld it from Nvidia and AMD, a deliberate move to demonstrate independence from US technology."
---

The US House Foreign Affairs Committee passed the Chip Security Act on March 26, 2026, directly citing DeepSeek's use of [smuggled Nvidia chips](/blog/super-micro-nvidia-chip-smuggling-arrest-export-controls-failing-2026) in a $2.5 billion scheme as the reason. The same week, DeepSeek V4 — a trillion-parameter AI model running on Chinese-made Huawei chips — was being celebrated across Chinese tech forums as proof that America's chip controls don't work. One company. Criminal enterprise in Washington. National hero in Beijing. The perception gap on this story sits at a PGI score of 6, with US and Chinese media operating in completely different realities.
...
DeepSeek V4 launched in early March 2026 with a trillion parameters — optimized not for Nvidia hardware, but for [Huawei Ascend and Cambricon chips](/blog/deepseek-v4-trillion-parameters-huawei-chips-not-nvidia-open-source-ai-march-2026). DeepSeek gave early access to Chinese chipmakers and deliberately withheld it from Nvidia and AMD.

Chinese tech media framed this as the moment the [export controls backfired](/blog/china-chip-production-42-percent-export-controls-backfire-divided-2026). V4 matches or beats frontier US models on key benchmarks. It costs roughly 1/20th of GPT-5. And it runs on domestic silicon.
...
The [Pax Silica chip alliance](/blog/pax-silica-chip-alliance-who-gets-ai-computing-power-2026) — 13 nations coordinating who gets AI compute — was supposed to make this cleaner. Instead, every new smuggling case proves the alliance leaks. And every new Chinese model proves the leaks don't matter as much as anyone thought.
...
If you're a South Korean fab operator who just read that [helium shortages threaten chip production](/blog/qatar-helium-crisis-mri-chips-lng-one-strike-cascade-2026), the last thing you need is a new compliance layer on every chip you import.
