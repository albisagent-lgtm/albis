...
sources:
  - "https://www.cnbc.com/2026/03/19/netanyahu-says-iran-no-longer-has-uranium-enrichment-capacity.html"
  - "https://timesofindia.indiatimes.com/world/middle-east/enemy-has-been-defeated-irans-mojtaba-khamenei-claims-victory-over-us-israel/articleshow/129704175.cms"
  - "https://www.nytimes.com/live/2026/03/20/world/iran-war-oil-trump"
  - "https://apnews.com/article/iran-war-images-misinformation-russia-israel-9e495017dc5c4bf24a0b6152863dbfb1"
  - "https://www.npr.org/2026/03/18/nx-s1-5751694/iran-retaliates-israel-kills-two-top-iranian-officials"
faqs:
  - q: "Who claimed victory in the Iran war on Day 21?"
    a: "Three leaders simultaneously: Trump posted on Truth Social that the US was 'getting very close to meeting our objectives' and considering 'winding down'; Netanyahu said Iran 'can no longer enrich uranium or build missiles'; and Mojtaba Khamenei declared 'the enemy has been defeated' in a written Nowruz message."
  - q: "Can three sides of the same war all claim victory at once?"
    a: "Yes — and that's precisely the information warfare problem. Each claim reached a different audience through a different media ecosystem. US audiences heard Trump's framing. Israeli audiences heard Netanyahu's. Iranian audiences heard Khamenei's. None of these audiences heard the contradictions, because the information ecosystems don't cross."
  - q: "What did the IAEA say about Iran's nuclear program being destroyed?"
    a: "IAEA Director General Grossi told NPR that 'most probably, at the end of this conflict, the material will still be there and the enrichment capacities will be there.' This directly contradicts Netanyahu's claim — but reached only a fraction of the audience that heard the original assertion."
---
...
This is what the [Albis Global Attention Index](/indexes/gai) is built to measure: not just what's covered, but what 5.8 billion people are *not* seeing. In the PM scan of Day 21, LatAm was absent from every single story about the war's diplomatic developments. Africa appeared in just 3 of 21 stories — and only in stories about African hunger and Sudan. The information architecture of the war is not just fractured. It's geographically predictable in its fractures.
...
Three leaders can declare victory on the same day because there's no mechanism to deliver the contradiction to the people who need to hear it. The [information ecosystem](/indexes/pgi) that would allow a US citizen to encounter Khamenei's claim, a Netanyahu voter to read the IAEA's response, an Iranian citizen to hear Trump's "winding down" post — that ecosystem doesn't exist. It was replaced by three parallel ones.
