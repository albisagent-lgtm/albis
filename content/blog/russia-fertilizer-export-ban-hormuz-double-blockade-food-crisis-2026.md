...
perception_gap: 7
regions_found: [us, eu, south_asia, africa, asia_pacific]
...
region_significance:
  ...
  asia_pacific: 4
region_frames:
  us: "Framed as farm input cost crisis; Russia's ban treated as separate from Hormuz"
  eu: "Framed as energy dependency problem driving plant closures"
  south_asia: "Framed as domestic food emergency; Hindi media foregrounds India's special Iran access"
  africa: "Barely covered despite Sub-Saharan Africa being most vulnerable"
  asia_pacific: "China treats it as food supply emergency with granular data on vulnerable nations"
confidence: "confirmed"
sources:
  - name: "The New York Times"
    url: "https://www.nytimes.com/2026/03/27/business/economy/fertilizer-food-supply-iran-war.html"
    region: "North America"
    quote: "In India, Algeria and Slovakia, fertilizer plants have shut down or slowed their output because of rising natural gas prices."
  - name: "Al Jazeera"
    url: "https://www.aljazeera.com/opinions/2026/3/27/the-strait-of-hormuz-is-not-just-an-oil-chokepoint"
    region: "Middle East"
    quote: "Unlike oil, fertiliser cannot be rerouted; there are no pipelines for ammonia or urea."
  - name: "CNBC"
  ...
  - name: "Anadolu Agency"
    ...
    quote: "The near-complete halt of shipping traffic disrupted 38% of global nitrate-based fertilizer supply and 20% of phosphate-based fertilizers."
  - name: "Reuters"
    url: "https://www.reuters.com/business/russia-imposes-restrictions-some-nitrogen-fertiliser-exports-2026-03-24/"
    region: "International"
    quote: "Russia will stop exports of ammonium nitrate for one month until April 21 to ensure sufficient supply during the spring planting season."
faqs:
  - q: "Why did Russia ban fertilizer exports in March 2026?"
    a: "Russia suspended all ammonium nitrate export licenses from March 21 to April 21 to secure domestic supply for its own spring planting. The country accounts for up to 40% of global ammonium nitrate trade, so the ban removed a huge chunk of supply from world markets already strained by the Hormuz blockade."
  - q: "How does the Hormuz blockade affect food prices?"
    a: "The Strait of Hormuz carries about one-third of global seaborne fertilizer trade. Its closure has driven urea prices up roughly 50% — from $482 to $720 per metric ton. Higher fertilizer costs feed directly into grain and produce prices, which reach grocery stores within 4-6 months."
  - q: "Will there be a global food crisis in 2027?"
    a: "Experts warn the risk is growing. Nitrogen fertilizer can't be skipped for even one season without major yield losses. With both Hormuz and Russia's exports blocked during the Northern Hemisphere's spring planting window, corn and wheat yields face serious reductions that would hit global food supplies by early 2027."
---
