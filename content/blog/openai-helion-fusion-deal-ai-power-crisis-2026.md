---
title: "OpenAI Bets on Fusion Power That Doesn't Exist Yet"
description: "OpenAI is negotiating to buy 5 gigawatts of fusion power from Helion by 2030. The problem: Helion hasn't generated a single watt of net electricity. Here's what the deal reveals about AI's energy crisis."
date: "2026-03-25"
author: "Albis"
...
region_significance:
  ...
  asia_pacific: 4
region_frames:
  us: "Framed as visionary tech partnership securing clean energy future"
  eu: "Framed through strategic autonomy lens — EU investing €330M in own fusion program"
  asia_pacific: "Chinese media highlights state-funded BEST reactor on track for 2027, contrasting with private-sector approach"
confidence: "developing"
faqs:
  - question: "How much fusion power does OpenAI want from Helion?"
    answer: "The reported deal would guarantee OpenAI 12.5% of Helion's production — 5 gigawatts by 2030 and 50 gigawatts by 2035."
  - question: "Has Helion achieved net energy from fusion?"
    answer: "No. Helion's Polaris prototype hit 150 million degrees Celsius in February 2026, but no private fusion company has yet achieved scientific breakeven — producing more energy than consumed."
  - question: "How many reactors would Helion need to build?"
    answer: "At 50 megawatts per reactor, Helion would need 800 reactors operating by 2030 and 8,000 by 2035 to meet reported targets. Zero commercial fusion reactors exist today."
sources:
  - "TechCrunch - Sam Altman-backed fusion startup Helion in talks to sell power to OpenAI (March 23, 2026)"
  - "Axios - OpenAI explores fusion energy in Helion power deal (March 23, 2026)"
  - "POWER Magazine - OpenAI in Talks with Helion to Secure Fusion Energy (March 24, 2026)"
  - "The Economist - China is a serious contender in the race for fusion energy (March 18, 2026)"
  - "DevelopmentAid - EU invests €330 million to bring fusion energy forward (March 22, 2026)"
---
...
Here's what makes this story interesting. It's not a fusion story — it's an [AI energy crisis](/blog/hormuz-crisis-accelerating-clean-energy-transition-asia-2026) story wearing a fusion costume.
...
This is Musk's [$25 billion Terafab](/blog/musk-terafab-chip-factory-ai-panic-signal-2026) all over again — the announcement reveals the crisis, not the solution.
...
**The American version:** AI money rescues fusion. Private capital, venture-backed startups, and billionaire founders will crack the code faster than government programs. Helion, Commonwealth Fusion Systems, and TAE Technologies lead the charge. The market will solve it.

**The Chinese version:** China is building BEST — the Burning plasma Experimental Superconducting Tokamak — on track for completion by 2027. The state-funded China Fusion Engineering Demo Reactor targets commercial power by 2030. The Economist reported this week that China is "a serious contender" in the race, combining state planning with industrial investment at a scale private companies can't match.

**The European version:** The EU just committed €330 million to fusion energy through its 2026-2027 Euratom Work Programme. It's a fraction of what private US startups have raised, but it's patient money aimed at ITER and next-generation reactor designs — a bet on the long game while the Americans sprint.
...
**One.** AI companies have already committed to more electricity than the existing grid can deliver. They're not expanding supply — they're competing for it. Every gigawatt that goes to a data center is a gigawatt that doesn't go to homes, hospitals, or factories. As the [US wind and solar sector showed](/blog/us-wind-solar-17-percent-record-59gw-stalled-clean-energy-2026), 59 gigawatts of clean power sits stalled in interconnection queues while AI companies jump the line with private generation.

**Two.** The fusion industry's business model has shifted. It's no longer "solve clean energy for humanity." It's "solve clean energy for AI companies willing to pay above-market rates for dedicated supply." Microsoft, OpenAI, and Google are the new anchor tenants. The rest of us get whatever's left.

**Three.** Nobody is asking the hardest question: what happens if fusion doesn't deliver on time? If Helion can't hit 200 million degrees and start generating net electricity by 2028, OpenAI's 5-gigawatt-by-2030 target evaporates. And AI's power demand won't wait. It'll get met with natural gas, revived coal plants, or the kind of grid strain that raises everyone's electricity bills.
