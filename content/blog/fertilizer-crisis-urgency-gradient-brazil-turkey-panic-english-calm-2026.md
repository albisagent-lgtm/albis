---
title: "Urea Up 89% in Brazil, 50% in Turkey — English Media Calls It a Market Story"
...
region_significance:
  ...
  asia_pacific: 5
region_frames:
  us: "Framed as commodity price update — fertilizer up 35% as market indicator"
  eu: "Framed as energy dependency problem and plant closure concern"
  south_asia: "Framed as domestic food emergency with wartime fertilizer subsidy crisis"
  latam: "Framed as immediate agricultural survival threat — harvest compromise warnings"
  asia_pacific: "Framed as strategic food supply vulnerability requiring emergency planning"
region_frames_long:
  us: "US outlets report fertilizer as an economic indicator — urea up 35%, market implications, USDA briefing. The UN's humanitarian fertilizer corridor is a policy detail, not a crisis signal."
  eu: "European media focuses on fertilizer plant closures in Slovakia and energy dependency. The framing is structural — fossil fuel reliance created this vulnerability."
  south_asia: "Hindi media leads with domestic alarm — India's urea subsidy already strained before the war, now facing input cost explosion. India's special diplomatic channel with Iran adds a unique survival angle."
  latam: "Brazilian and Turkish media treat this as an agricultural emergency. Gazeta do Povo quotes officials warning of 1-3 million tonne phosphate deficit. Urea up 89% year-on-year."
  asia_pacific: "Chinese media frames this as a food crisis with granular data — Bangladesh's 18-day reserves, specific farmer behaviour changes, IFPRI researcher quotes on crop switching."
confidence: "confirmed"
sources:
  - name: "Gazeta do Povo"
    url: "https://www.gazetadopovo.com.br/agronegocio/fertilizantes-2026-crise-hormuz/"
    region: "Latin America"
  - name: "Folha de Sao Paulo"
    url: "https://www.folha.uol.com.br/mercado/fertilizantes-crise-2026.shtml"
    region: "Latin America"
  - name: "Paraanaliz"
    url: "https://www.paraanaliz.com/tarim-gubre-krizi-2026/"
    region: "Middle East"
  - name: "Xinhua"
    url: "https://www.xinhua.net/2026-03/28/c_fertilizer-crisis-hormuz.htm"
    region: "Asia-Pacific"
  - name: "CNBC"
    url: "https://www.cnbc.com/2026/03/28/fertilizer-prices-hormuz-food-security.html"
    region: "North America"
faqs:
  - q: "How much have urea prices risen in Brazil in 2026?"
    a: "Urea prices in Brazil have risen 89% year-on-year and 50% in the past 30 days alone, driven by the Hormuz blockade cutting off one-third of global seaborne fertilizer trade and Russia's simultaneous ammonium nitrate export ban."
  - q: "Why is the fertilizer crisis worse for some countries than others?"
    a: "Countries that import most of their fertilizer — like Brazil, Turkey, and Bangladesh — face the sharpest price spikes. Brazil imports about 85% of its fertilizer needs. Turkey's farmers are heading into spring planting with urea at 26,000 TL per tonne. Import-dependent nations feel the Hormuz blockade immediately."
  - q: "What is the perception gap in fertilizer crisis coverage?"
    a: "English-language media reports fertilizer prices as a market indicator — up 35%, with analyst commentary. Brazilian, Turkish, and Chinese media treat the same data as an agricultural emergency threatening harvests. The urgency gradient depends on how directly a country's food supply depends on fertilizer imports."
---
...
The perception gap score for the [fertilizer story](/blog/gulf-fertilizer-freeze-global-food-crisis-planting-season-2026): PGI 8. Not because outlets disagree on the numbers. Because the same numbers produce panic in Sao Paulo, strategic alarm in Beijing, and a chart in New York.
