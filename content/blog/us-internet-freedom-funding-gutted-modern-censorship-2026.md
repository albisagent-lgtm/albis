...
author: "Harry Wenham"
tags: ["explainer", "internet-freedom", "censorship", "iran", "china", "vpn", "tor"]
faqs: [
  {
    q: "What programs did the US fund to fight internet censorship?",
    a: "The US State Department funded VPNs, Tor, and circumvention tools through the Bureau of Democracy, Human Rights, and Labor (DRL) and the Open Technology Fund. These tools helped people in Iran, China, and Russia access blocked websites and communicate during protests."
  },
  {
    q: "Why does modern censorship work differently than it used to?",
    a: "Authoritarian governments no longer need North Korea-style total internet shutdowns. They use throttling (slowing sites down), silent VPN failures, and legal pressure to censor specific content while keeping business internet running. It's surgical, not total—and much harder to fight."
  },
  {
    q: "Can people still bypass censorship without US-funded tools?",
    a: "Some can, but it's getting harder. Iran's 2026 shutdown hit 99% connectivity, and new techniques destabilize encryption negotiation so VPNs fail silently. Users think it's a malfunction, not censorship. Without sustained funding, the tools that counter these tactics disappear."
  }
]
---
