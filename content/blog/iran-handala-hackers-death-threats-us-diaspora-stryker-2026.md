---
title: "Iran's Hackers Are Sending Death Threats to Americans"
description: "Iran's Handala group wiped 200,000 devices at medical giant Stryker and sent death threats to Iranian-Americans. The FBI seized four domains. Only US media covered it."
date: "2026-03-26"
...
perception_gap: 4
regions_found: [us, middle_east]
regions_absent: [eu, south_asia, asia_pacific, latam, africa]
region_significance:
  us: 5
  middle_east: 2
region_frames:
  us: "Framed as FBI success in disrupting Iranian cyber operations"
  middle_east: "Al Jazeera framed Stryker attack as retaliation for schoolgirl bombing"
sources:
  - name: "US Department of Justice"
    url: "https://www.justice.gov/opa/pr/justice-department-disrupts-iranian-cyber-enabled-psychological-operations"
    region: "North America"
    quote: "The seized domains were used by the MOIS to claim credit for hacking activity, post stolen data, and call for the killing of journalists, regime dissidents, and Israeli persons"
  - name: "Palo Alto Unit 42"
    url: "https://unit42.paloaltonetworks.com/iranian-cyberattacks-2026/"
    region: "North America"
    quote: "Handala Hack reportedly targeted an Iranian-American and Iranian-Canadian influencer with direct death threats via email, claiming to have leaked their home addresses to physical operatives"
  - name: "Al Jazeera"
    url: "https://www.aljazeera.com/news/2026/3/11/iran-linked-hackers-hit-medical-giant-stryker-in-retaliatory-cyberattack"
    region: "Middle East"
    quote: "Handala said it carried out the attack in retaliation for the killing of more than 170 people, most of them schoolgirls"
  - name: "Krebs on Security"
    url: "https://krebsonsecurity.com/2026/03/iran-backed-hackers-claim-wiper-attack-on-medtech-firm-stryker/"
    region: "North America"
    quote: "Stryker's offices in 79 countries have been forced to shut down after the group erased data from more than 200,000 systems, servers and mobile devices"
---
...
This wasn't a movie plot. It came from [Handala](https://www.albis.news/blog/censorship-deepfakes-surveillance-information-warfare-2026), a hacking persona run by Iran's Ministry of Intelligence and Security (MOIS), according to the US Department of Justice. And it was part of a campaign that has crossed from cyberspace into people's living rooms.
...
Palo Alto Networks' Unit 42 confirmed that Handala sent Iranian-American and Iranian-Canadian influencers [direct death threats containing their home addresses](https://www.albis.news/blog/information-warfare-hacked-apps-internet-shutdowns), claiming operatives were already in position.
...
Iran's internet has been running at 1-4% capacity since the war began on February 28. Unit 42 assessed that this should degrade state-level cyber coordination. Instead, Handala appears to operate through [geographically dispersed cells](https://www.albis.news/blog/you-cant-tell-whats-real-iran-war-deepfakes-2026) acting with tactical autonomy — not waiting for orders from Tehran.
