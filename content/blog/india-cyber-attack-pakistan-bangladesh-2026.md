...
sources:
  - name: "The Record"
    ...
    quote: "An espionage campaign last year targeted government agencies and critical infrastructure operators in Pakistan, Bangladesh and Sri Lanka"
  - name: "Carnegie Endowment for International Peace"
    url: "https://carnegieendowment.org/research/2025/03/interpreting-indias-cyber-statecraft"
    region: "North America"
    quote: "India has focused on developing cyber capabilities for intelligence collection, defensive, and offensive operations"
  - name: "The Hacker News"
    url: "https://thehackernews.com/2026/03/sloppylemming-targets-pakistan-and.html"
    region: "International"
    quote: "SloppyLemming is the moniker assigned to a threat actor that's known to target government, law enforcement, energy, telecommunications, and technology entities in Pakistan, Sri Lanka, Bangladesh, and China since at least 2022"
  - name: "Defence Cyber Agency Wikipedia"
    url: "https://en.wikipedia.org/wiki/Defence_Cyber_Agency"
    region: "International"
    quote: "The DCyA would have the capability to hack into networks, mount surveillance operations, lay honeypots, recover deleted data from hard drives and cellphones, break into encrypted communication channels"
  - name: "RUSI"
    url: "https://www.rusi.org/explore-our-research/publications/commentary/operation-sindoor-and-india-pakistans-escalated-rivalry-cyberspace"
    region: "Europe"
    quote: "Such attacks particularly surged after the formation of the Defence Cyber Agency in 2019, which is reportedly responsible for India's offensive cyber operations"
faqs:
  - q: "What is SloppyLemming and who's behind it?"
    a: "SloppyLemming is an Advanced Persistent Threat (APT) group linked to India that's targeted government agencies and critical infrastructure across Pakistan, Bangladesh, and Sri Lanka since at least 2022. The operations escalated after India formed its Defence Cyber Agency in 2019."
  - q: "What targets did India-linked hackers hit?"
    a: "Pakistan's Nuclear Regulatory Authority, Pakistan Navy, DESCON, Power Grid Company of Bangladesh, and telecommunications and financial institutions across Sri Lanka. These are critical infrastructure targets that could impact millions."
  - q: "Why doesn't the world know about India's cyber operations?"
...
But India's been building offensive cyber capabilities since 2019, when it formed the [Defence Cyber Agency](https://en.wikipedia.org/wiki/Defence_Cyber_Agency) (DCyA).
...
India unveiled its [Joint Doctrine for Cyberspace Operations](https://www.orfonline.org/expert-speak/india-and-cyberspace-balance-between-offence-and-defence) in June 2024, integrating cyber capabilities across all three military services.
...
India, Pakistan, Bangladesh, and Sri Lanka are all democracies (with varying degrees of backsliding, but still). They're all members of regional trade agreements. They play [cricket](/topics/cricket) together in tournaments watched by billions.
...
**First**, offensive cyber capabilities are spreading faster than anyone admits. India isn't alone. Vietnam runs operations. Indonesia's building capacity. Every mid-tier power with a tech sector is developing these tools.

**Second**, there's no clear line between espionage and pre-positioning for sabotage. Infiltrating a power grid to steal intelligence looks identical to infiltrating it to shut it down later.

**Third**, democracies hacking democracies sets a dangerous norm. If India can justify targeting Bangladesh's critical infrastructure, what stops every regional power from doing the same?

The [Stimson Center's analysis](https://www.stimson.org/2025/india-pakistan-cyber-skirmishes-and-the-challenge-of-attribution/) warns that India and Pakistan need to establish cyber hotlines, commit to non-proliferation of intrusive cyber tools to non-state groups, and institutionalize attribution processes.
