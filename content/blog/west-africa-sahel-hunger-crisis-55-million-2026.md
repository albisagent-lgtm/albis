---
title: "West Africa Hunger Crisis: 55 Million Face Famine"
description: "55 million people in West Africa and the Sahel face crisis-level hunger by summer 2026. French and Arabic media treat it as existential. English media barely notices. The absence is the story."
date: "2026-03-27"
author: "Harry Wenham"
...
regions_absent: [us, middle_east, south_asia, asia_pacific, latam]
region_significance:
  africa: 5
  eu: 3
region_frames:
  africa: "Existential food security emergency demanding immediate collective action"
  eu: "Humanitarian crisis linked to aid funding cuts and displacement"
  us: "Near-total absence from English-language coverage"
confidence: "confirmed"
sources:
  - name: "World Food Programme"
    url: "https://www.wfp.org/news/humanitarian-aid-cuts-push-millions-deeper-hunger-amid-rising-violence-and-population"
    region: "International"
    quote: "A staggering 55 million people in the region are expected to endure crisis levels of hunger, or worse, during the June–August 2026 lean season."
  - name: "FAO"
    url: "https://www.fao.org/africa/news-stories/news-detail/west-africa-and-the-sahel--nearly-52.8-million-people-could-face-acute-food-insecurity-during-the-2026-lean-season-(june-august)/en"
    region: "International"
    quote: "If additional action is not taken, up to 52.8 million people could face acute food insecurity during the upcoming lean season."
  - name: "Human Rights Watch"
    url: "https://www.hrw.org/world-report/2026/country-chapters/sudan"
    region: "International"
    quote: "24.6 million people suffer from acute hunger and 2 million face famine or risk of famine."
  - name: "UNICEF"
    url: "https://www.unicef.org/press-releases/children-sudan-have-endured-1000-days-agony"
    region: "International"
    quote: "33.7 million people, about two-thirds of the population, are expected to need urgent humanitarian assistance."
  - name: "The Atlantic"
    url: "https://www.theatlantic.com/health/2026/02/trump-state-department-ending-aid-seven-african-countries/686106/"
    region: "North America"
    quote: "These projects are being canceled because there is no strong nexus between the humanitarian response and U.S. national interests."
faqs:
  - q: "How many people face hunger in West Africa in 2026?"
    a: "The World Food Programme warns that 55 million people across West and Central Africa will face crisis-level hunger or worse during the June-August 2026 lean season. Over 13 million children are expected to suffer from malnutrition. Nigeria, Chad, Cameroon, and Niger account for 77% of the crisis."
  - q: "Why is West Africa's hunger crisis getting worse in 2026?"
    a: "Three forces are converging: conflict and displacement are pushing millions from their farms, humanitarian aid funding has been slashed (the US canceled USAID programmes in seven African countries), and the Hormuz blockade has driven up fertilizer and fuel costs across the region. Each factor feeds the others."
  - q: "Why is the Sahel food crisis not in the news?"
    a: "The Albis Global Attention Index scored this story 6.69 — an 'Information Shadow' rating meaning it's covered in French and Arabic media but nearly invisible in English. The Iran war dominates global attention, and slow-onset hunger crises lack the visual drama that drives clicks in English-language outlets."
---
...
**Conflict is emptying the farms.** Sudan alone has displaced 11.8 million people — 7.4 million internally, 4.2 million across borders. The war recently passed its 1,000th day. The WHO calls it the world's worst health and humanitarian crisis. UNICEF says 33.7 million Sudanese — two-thirds of the entire population — need urgent humanitarian help. Arabic media marked the milestone with detailed reporting. Al Jazeera's Arabic service documented [9.6 million displaced, 21 million in acute hunger, 34 million needing aid](/blog/sudan-famine-wfp-food-stocks-depleted-world-ignores-2026). In English, the milestone barely registered.

Next door, the Democratic Republic of Congo is heading for 9 million displaced this year, driven by Rwanda-backed M23 forces. Combined with Sudan, that's 18 million people uprooted — more than the population of the Netherlands — across just two countries.
...
WFP needs $453 million over the next six months to maintain basic operations across the region. The funding isn't coming.

**The Hormuz blockade is making everything more expensive.** Oil at $106 a barrel means fertilizer costs have surged 30% or more. Diesel — the fuel that moves food from port to plate across West Africa — is scarce and getting scarcer. [Brazil's 166 cities are running out of diesel](/blog/latin-america-fuel-food-fiscal-crisis-iran-war-2026) right now for the same reason, and [the sulfur shortage from the Hormuz blockade threatens next year's harvest globally](/blog/sulfur-shortage-hormuz-blockade-threatens-2027-food-supply). The Sahel, which imports most of its fuel and much of its fertilizer, sits at the end of every supply chain that's currently breaking.

Each crisis amplifies the others. Conflict displaces farmers. Displaced farmers can't grow food. Food aid fills the gap — until funding gets cut. Rising fuel costs make what food exists harder to transport. The spiral tightens.
