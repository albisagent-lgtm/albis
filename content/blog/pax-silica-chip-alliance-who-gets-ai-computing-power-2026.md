...
regions: ["us", "asia-pacific", "europe", "middle-east", "south-asia"]
seoKeyword: "pax silica chip alliance semiconductor 2026"
perception_gap: 7
...
region_significance:
  ...
  asia_pacific: 4
region_frames:
  us: "Framed as historic economic security achievement uniting allies"
  eu: "Framed with concern over exclusion of Taiwan, Germany, and France from full membership"
  asia_pacific: "China frames it as a desperate bluff; India and Japan celebrate access to US tech stack"
...
sources:
  - name: "Tom's Hardware"
    ...
    quote: "SoftBank, Singapore's Temasek, and Abu Dhabi's Mubadala Investment Co. collectively manage more than $1 trillion in combined assets"
  - name: "CEPA"
    url: "https://cepa.org/article/pax-silica-can-it-stop-china/"
    region: "Europe"
    quote: "Discipline for the coalition, carve-outs for Washington"
  - name: "Reuters"
    url: "https://www.reuters.com/world/us-charges-three-people-with-conspiring-divert-ai-tech-china-2026-03-19/"
    region: "International"
    quote: "Three people associated with Super Micro Computer charged with helping smuggle at least $2.5 billion of U.S. AI chips to China"
  - name: "South China Morning Post"
    url: "https://www.scmp.com/opinion/world-opinion/article/3343940/pax-sinica-vs-pax-silica-how-china-us-mineral-war-taking-shape"
    region: "Asia-Pacific"
    quote: "The year ahead will be marked by strategic repositioning rather than genuine peace"
  - name: "New York Times"
    url: "https://www.nytimes.com/2026/03/23/business/economy/trump-pax-silica-fund.html"
    region: "North America"
    quote: "SoftBank and Temasek would be among a group of founding members with more than $1 trillion in combined assets"
faqs:
  - q: "What is Pax Silica and which countries are members?"
    a: "Pax Silica is a US-led alliance launched in December 2025 to secure semiconductor and AI supply chains among trusted partners. As of March 2026, 13 nations have signed: the US, Japan, South Korea, Singapore, Australia, UK, Israel, Netherlands, Qatar, UAE, India, Greece, and Sweden."
  - q: "Does Pax Silica ban China from getting advanced chips?"
    a: "Pax Silica coordinates export controls and supply chain alignment among members, but doesn't directly ban chip sales. China is excluded from the alliance. However, enforcement gaps exist — a $2.5 billion chip smuggling ring was just exposed, and ByteDance is accessing Nvidia chips through Malaysia."
  - q: "How much money is the Pax Silica investment fund?"
    a: "The US announced a target of $4 trillion in investment. The US government will contribute $250 million in seed funding. Founding members SoftBank, Temasek, and Mubadala manage over $1 trillion in combined assets."
---

Thirteen nations now control who gets advanced computing power and who doesn't. The US-led [Pax Silica semiconductor alliance](/blog/us-india-pax-silica-ai-treaty-nobody-noticed-2026) has grown from seven founding members to 13 signatories since December 2025, backed by a newly announced investment fund targeting $4 trillion. China isn't invited. But a $2.5 billion chip smuggling prosecution and ByteDance's 36,000-GPU workaround in Malaysia suggest the fortress has cracks. The Albis Perception Gap Index scored this story 6.5 — 3.87 billion people in excluded regions didn't even see it announced.
...
The scope expanded after the Iran war. What started as an AI supply chain pact now includes energy infrastructure projects, driven by the [Hormuz blockade's impact on chip production](/blog/qatar-helium-shortage-chip-supply-crisis-2026). Helium from Qatar — essential for cooling semiconductor fabs and MRI machines — became a strategic weapon overnight.
...
**The fortress argument:** Pax Silica members account for roughly 90% of the world's advanced chip manufacturing capacity. TSMC (Taiwan, a guest participant), Samsung (South Korea), and Intel (US) produce virtually every chip below 7nm. ASML's EUV lithography machines — which only the Netherlands makes — are the bottleneck for anyone trying to build cutting-edge fabs. No ASML, no advanced chips. Period.

**The bluff argument:** On March 19, the US Justice Department [charged Super Micro Computer co-founder Wally Liaw](/blog/super-micro-nvidia-chip-smuggling-arrest-export-controls-failing-2026) with smuggling $2.5 billion worth of Nvidia AI servers to China. The scheme ran for years through shell companies and false end-user certificates. SMCI's stock crashed 22% in a day.

That's not a leak. That's a river.

Days earlier, ByteDance — TikTok's parent company — [secured access to 36,000 Nvidia Blackwell B200 GPUs](/blog/bytedance-nvidia-chips-malaysia-us-export-controls-failing-2026) through a Malaysian cloud operator. Nvidia confirmed no objections. The chips sit in Malaysia, not China. ByteDance's engineers access them remotely. Technically legal. Practically, it defeats the entire point of export controls.
...
Arm's announcement this month of its [first custom-designed chip in 35 years](/blog/arm-first-chip-agi-cpu-meta-alibaba-risc-v-2026), purpose-built for AI workloads, underscores the stakes. The architecture that powers 99% of the world's smartphones is now competing directly in the AI chip space — and it's a Pax Silica member's technology.
