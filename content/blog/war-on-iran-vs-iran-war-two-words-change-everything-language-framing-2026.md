...
date: 2026-03-22
image: https://images.pexels.com/photos/5505718/pexels-photo-5505718.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800&w=1200
author: Harry Wenham
tags:
  - media-literacy
  - iran-war
...
sources:
  - name: "Al Jazeera"
    ...
    region: "Middle East"
    quote: "US-Israel war on Iran — stay on top of latest developments"
  - name: "Outlook India"
    url: "https://www.outlookindia.com/international/saying-everything-except-who-did-it-western-media-the-iran-war-and-the-language-of-euphemism"
    region: "South Asia"
    quote: "Passive headlines, vague verbs and zero blame when America or Israel strike civilians"
  - name: "CNN"
    url: "https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-21-26"
    region: "North America"
    quote: "Iran war news: Tehran fires ballistic missiles at US-UK military base"
  - name: "The Nation"
    url: "https://www.thenation.com/article/society/iran-war-media-coverage-60-minutes/"
    region: "North America"
    quote: "Donald Trump's surreal, unjustified, and illegal war on Iran"
  - name: "The Bull & Bear (McGill)"
    url: "https://bullandbearmcgill.com/war-on-words-how-language-shapes-the-perception-of-armed-conflict/"
    region: "North America"
    quote: "Governments of the post-Geneva era devised an unexpected solution: they ceased calling war by its proper name"
confidence: "confirmed"
faqs:
  - q: "Why does Al Jazeera call it the 'US-Israel war on Iran' instead of the 'Iran war'?"
    a: "Al Jazeera's naming convention identifies the attackers (US and Israel) and positions Iran as the target, not the aggressor. The preposition 'on' assigns directional blame. Western outlets like CNN and Reuters use 'Iran war,' which names the location without specifying who initiated hostilities — a framing that implicitly centres Iran as the problem."
  - q: "Does the name of a war actually change how people understand it?"
    a: "Yes. Research on the 'War on Terror' showed that framing Iraq as part of a 'war on terror' rather than a 'war in Iraq' shifted American public support by double digits. The name determines whether a conflict is perceived as defensive or aggressive, which directly shapes public opinion on whether to continue or end it."
  - q: "What do other outlets call the 2026 Iran conflict?"
    a: "CNN and Reuters use 'Iran war.' Al Jazeera uses 'US-Israel war on Iran.' Fox News uses 'U.S.-Iran war.' Wikipedia settled on '2026 Iran war' after editorial debate. The BBC alternates between 'Iran conflict' and 'Iran war.' Each name carries a different assumption about who is responsible."
---
