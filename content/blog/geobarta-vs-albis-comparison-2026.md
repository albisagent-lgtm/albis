...
image: "https://images.pexels.com/photos/7235894/pexels-photo-7235894.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800&w=1200"
...
region_significance:
  ...
  south_asia: 3
region_frames:
  us: "Framed as strategic military success against Iranian nuclear programme"
  middle_east: "Framed as Western aggression destabilising regional sovereignty"
  eu: "Framed as humanitarian crisis with diplomatic failure"
  asia_pacific: "Framed through energy disruption and economic fallout"
  south_asia: "Framed as cooking gas and fuel price crisis affecting daily life"
faqs:
  - q: "Is GeoBarta free?"
    a: "GeoBarta offers a free tier with daily AI-generated news briefings and no ads. It also has a Pro plan with additional features. The core 60-second briefing experience is available at no cost."
  - q: "What is the difference between GeoBarta and Albis?"
    a: "GeoBarta uses AI to summarise news into 60-second briefings organised by geographic level — global, regional, national, and local. Albis measures how different regions frame the same story differently, using a Perception Gap Index. GeoBarta tells you what happened. Albis shows you how the same event looks different depending on where you read about it."
  - q: "Which is better for understanding media bias?"
    a: "They measure different things. GeoBarta aggregates from 1,000+ sources and aims for neutral AI summaries. Albis doesn't try to be neutral — it shows you the specific framing differences between regions so you can see the bias patterns yourself. If you want quick, balanced summaries, GeoBarta works well. If you want to see how geography shapes the news, Albis goes deeper."
  - q: "Does GeoBarta show news from different countries?"
    a: "GeoBarta organises news by four geographic levels — Global, Regional, National, and Local — and draws from over 1,000 sources. But its AI combines those sources into a single summary. Albis keeps regional framings separate so you can compare them side by side."
  - q: "What is the best AI news app in 2026?"
    a: "It depends on what you need. GeoBarta is best for fast daily briefings. Ground News is best for political bias awareness. Albis is best for understanding how geography shapes news framing. Each solves a different problem."
---
...
If you checked Albis, you got something else entirely. CNN framed it as a strategic chokepoint. Al Jazeera framed it as collective punishment. India's NDTV led with cooking gas shortages. Brazilian outlets barely mentioned it. Same event. The [Perception Gap Index](/indexes/pgi) read 8.4 out of 10.
...
The [Perception Gap Index](/perception-gap/about) scores this difference numerically. A PGI of 2 means most regions agree on the story. A PGI of 8 means they're describing different realities.

On the Hormuz blockade, Albis shows you five distinct framings:

**US media:** Strategic naval operation. Containment of Iranian nuclear threat.
**Middle Eastern media:** Western aggression. Collective economic punishment.
**European media:** Diplomatic failure. Humanitarian consequences.
**South Asian media:** Cooking gas and fuel crisis. Threat to daily life.
**Latin American media:** Near-silence. Minimal coverage.
...
The AI summary tells you the Strait of Hormuz is closed. The [perception gap](/indexes/pgi) shows you that closure means five different things to five different populations — and one population that hasn't heard about it at all.
