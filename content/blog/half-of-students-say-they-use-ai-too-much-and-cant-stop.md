---
title: "Half of Students Say They Use AI Too Much — and Can't Stop"
...
**Ask harder questions.** When AI handles the easy stuff, classrooms need problems requiring genuine human thinking — creativity, judgment, messy real-world synthesis.

**Make the thinking visible.** Oral exams, explain-your-reasoning assignments, and peer discussions force students to demonstrate understanding, not just produce answers. Hard to fake comprehension at a blackboard.

**Teach smart AI use.** The coding study found programmers who asked AI to generate code *and* explain it outperformed those who just copied output. The explanation step kept their brains engaged.

**Start with foundations.** Students need basic skills before AI enters the picture. You need to understand the chain rule before you can use AI to push past it.
