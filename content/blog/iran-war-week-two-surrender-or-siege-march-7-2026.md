...
sources:
  - name: "Al Jazeera"
    ...
    region: "Middle East"
    quote: "The Israeli military claims to have achieved near-complete air superiority, stating it has carried out 2,500 strikes and destroyed 80 percent of Iran's air defence systems."
  - name: "NPR"
  ...
  - name: "The Guardian"
    ...
    region: "Europe"
    quote: "Brent crude has risen 28% this week, its biggest weekly gain since April 2020."
  - name: "Dawn"
    url: "https://www.dawn.com/news/1979341/petrol-bomb-falls-on-pakistan-amid-war"
    region: "South Asia"
    quote: "Global oil prices had increased by 50 to 70 per cent due to the crisis."
  - name: "Reuters"
    url: "https://www.reuters.com/world/middle-east/israel-backing-iranian-kurdish-plans-seize-iran-border-areas-sources-say-2026-03-06/"
    region: "International"
    quote: "Israel has been bombing parts of western Iran to support Iranian Kurdish militias who hope to exploit the U.S.-Israeli war on Iran to seize towns near the frontier."
faqs:
  - q: "What is happening in the Iran war right now in March 2026?"
    a: "As of March 7, Operation Epic Fury has entered its second week. The US and Israel have carried out 2,500 strikes, destroyed 80% of Iran's air defences, and killed Supreme Leader Khamenei. Iran's retaliatory missile capacity is down 90% from day one. Trump is demanding unconditional surrender. Oil hit $92.69 per barrel — its biggest weekly gain since 1983."
  - q: "Is the Strait of Hormuz still closed?"
    a: "Effectively yes. No oil shipments passed through Hormuz in the past 24 hours as of March 7. The near-total halt is entering its seventh day. Kuwait has started cutting production because it ran out of storage. China is negotiating with Iran for safe passage for its own tankers, which could partially reopen the strait."
  - q: "How is the Iran war affecting Pakistan?"
    a: "Pakistan is fighting its own war with Afghanistan while absorbing the economic shock of the Iran conflict. Petrol prices jumped PKR 55 per litre in a single hike. The government is considering COVID-style measures like work-from-home mandates to conserve fuel. Pakistan has roughly 26 days of fuel reserves and its defence pact with Saudi Arabia could theoretically drag it into the Iran war if Saudi Arabia is attacked more aggressively."
---
