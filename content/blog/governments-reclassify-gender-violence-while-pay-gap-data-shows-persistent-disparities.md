...
faqs:
  ...
  - q: "How wide is Australia's gender pay gap in 2026?"
    a: "Australia's gender pay gap is 11.2 percent, down 0.9 percentage points from the previous year according to the Workplace Gender Equality Agency. However, men are nearly twice as likely as women to earn salaries above A$220,000. The financial services sector has the highest gap at 21.4 percent."
  - q: "What is Texas HB 7 and how does it affect abortion access across state lines?"
    a: "Texas House Bill 7 allows private citizens to sue anyone who provides abortion pills to Texas residents, including out-of-state providers. It directly challenges California's shield law, which protects in-state providers from other states' prosecution. This is the first state law specifically designed to counteract another state's shield protections."
---
