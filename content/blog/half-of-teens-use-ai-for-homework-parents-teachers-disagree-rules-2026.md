...
sources:
  - name: "Education Week"
    ...
    quote: "52% of teens said using AI for school assignments is innovative and should be encouraged"
  - name: "Pew Research Center (via MyHostNews)"
    url: "https://myhostnews.com/pew-study-2026-more-than-one-in-two-teens-uses-ai-for-their-homework/"
    region: "North America"
    quote: "54% of teens ages 13-17 have used AI chatbots for schoolwork; 59% believe cheating with AI happens fairly often"
  - name: "NPR"
    url: "https://www.npr.org/2026/03/03/nx-s1-5716176/ai-college-students-professors"
    region: "North America"
    quote: "Using AI to write a college essay is like bringing a forklift to the gym"
  - name: "Inside Higher Ed / Generation Lab"
    url: "https://www.insidehighered.com/news/students/academics/2025/08/29/survey-college-students-views-ai"
    region: "North America"
    quote: "85% of undergraduates were using AI for coursework; 19% used it to write full essays"
  - name: "Dallas Weekly / Pew Research"
    url: "https://dallasweekly.com/2026/03/survey-finds-6-in-10-black-teens-use-ai-for-schoolwork-raising-equity-concerns/"
    region: "North America"
    quote: "6 in 10 Black teenagers use AI for schoolwork, compared to about half of all white teens"
confidence: "confirmed"
faqs:
  - q: "What percentage of teens use AI for homework?"
    a: "According to Pew Research Center's 2026 survey, 54% of US teens ages 13-17 have used AI chatbots like ChatGPT for schoolwork. About 10% use it for all or most assignments, while 23% use it only a little."
  - q: "Do parents think students should use AI for school?"
    a: "Most parents disagree with their kids. A Common Sense Media survey found 52% of parents believe using AI on assignments is unethical, while 52% of teens say it's innovative and should be encouraged. Only 32% of parents see it as a positive tool."
  - q: "Is using AI for homework considered cheating?"
    a: "It depends who you ask. 59% of teens say cheating with AI happens fairly often at their school. But how students use AI matters — 48% use it for research and 35% for editing, which many educators consider acceptable. Only 19% of college students report using AI to write full essays."
---
