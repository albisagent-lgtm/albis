...
author: "Harry Wenham"
category: "Explainer"
tags: ["china", "solar", "energy", "ai", "geopolitics", "iran", "renewables"]
image: "https://images.pexels.com/photos/6876535/pexels-photo-6876535.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
seoKeyword: "China 315 GW solar record 2025 US energy comparison"
confidence: "confirmed"
faqs:
  - q: "How much solar did China install in 2025?"
    a: "China's National Energy Administration confirmed 315 GW of new solar capacity added in 2025 — a new global record. That's more solar than the entire US has ever built in its history. China's cumulative solar capacity now stands at 1.2 terawatts."
  - q: "Why is China building so much solar?"
    a: "Two reinforcing forces: a twenty-year national electrification strategy designed to reduce oil import dependency, and surging AI data center electricity demand that is projected to double by 2030. Solar is China's fastest and cheapest way to power both."
  - q: "Does China's solar capacity protect it from the Hormuz oil crisis?"
    a: "Partly, yes. Analysts at OCBC said China is 'less sensitive to a prolonged closure of the Strait of Hormuz than many of its Asian peers.' Oil and gas flowing through Hormuz now account for roughly 6% of China's total energy consumption — a share that has been declining for a decade as electrification deepens."
sources:
  - name: "pv magazine International"
    url: "https://www.pv-magazine.com/2026/01/28/china-adds-315-gw-of-solar-in-2025/"
    region: "International"
    quote: "China installed a record 315 GW (AC) of new solar capacity in 2025, lifting cumulative installed PV capacity to 1.2 TW and pushing non-fossil power sources past thermal generation for the first time."
  - name: "SEIA / Wood Mackenzie"
    url: "https://seia.org/research-resources/solar-market-insight-report-2025-year-in-review/"
    region: "North America"
    quote: "Cumulative US solar capacity reached 279 GWdc installed at year-end 2025."
  - name: "Latitude Media"
    url: "https://www.latitudemedia.com/news/the-iran-war-doesnt-give-china-an-energy-advantage-the-us-did/"
    region: "North America"
    quote: "The current disruption in the Strait of Hormuz, which would have been an economic emergency for China a decade ago, is now a supply shock the country can likely absorb better than almost any other major importer."
  - name: "CNBC"
    url: "https://www.cnbc.com/2026/03/09/china-oil-shock-iran-war-hormuz-energy-transition.html"
    region: "North America"
    quote: "OCBC analysts said China may be 'less sensitive to a prolonged closure of the Strait of Hormuz than many of its Asian peers.'"
  - name: "Columbia University CGEP"
    url: "https://www.energypolicy.columbia.edu/implications-of-the-conflict-in-the-middle-east-for-chinas-energy-security/"
    region: "International"
    quote: "Half of China's oil imports and nearly one-third of its LNG imports transit this waterway. However, China has several options to manage disruptions and is likely to view the conflict as the latest geopolitical upheaval that supports its efforts to gradually transition away from fossil fuels."
---
...
That comparison is the story. Not as a point-scoring exercise, but as a structural fact with direct consequences for who gets hurt by the current crisis in the [Strait of Hormuz](/topics/iran) and who, quietly, does not.
...
The loop is self-reinforcing. AI needs power. Cheap solar provides it. The revenue from [AI exports and technology](/topics/ai) funds more solar. More solar reduces oil dependency. Less oil dependency insulates China from exactly the kind of shock the rest of the world is absorbing right now.
...
China didn't just get lucky. It deliberately redesigned its economy around electricity. The [Strait of Hormuz crisis](/topics/iran) is the first real test of whether that bet paid off. Early signs: it did.
...
The [geopolitical blind spot](/indexes/gai) here is significant. Western analysis has spent years framing China's renewable buildout as an environmental or industrial policy story. It's neither, primarily. It's a strategic hedge against exactly the vulnerability that's currently breaking the global economy.
...
The [Perception Gap Index](/indexes/pgi) on this story is telling: Western media covers China's solar record as a climate story. Chinese state media covers it as a national security achievement. One of those framings is closer to the truth.
