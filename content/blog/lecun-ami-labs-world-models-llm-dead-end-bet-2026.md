---
title: "The AI Godfather Just Bet That ChatGPT Is a Dead End"
...
LLMs learn from text (predicting the next word). World models learn from video, spatial data, and sensors (predicting what happens next in the physical world).

**Is this just hype?**  
LeCun won the Turing Award for foundational AI work. Investors are backing him at a $3.5B valuation before any product launch. The tech community is split — some think he's right, others think LLMs will scale to solve these problems.
