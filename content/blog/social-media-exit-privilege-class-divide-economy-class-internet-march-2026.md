...
date: "2026-03-09"
author: "Albis"
image: "https://images.pexels.com/photos/5678243/pexels-photo-5678243.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800&w=1200"
tags: ["information-attention", "social-media", "digital-detox", "class-divide", "privilege"]
confidence: "confirmed"
sources:
  - name: "CNBC"
    url: "https://www.cnbc.com/2026/02/07/young-people-quiet-revolution-social-media.html"
    region: "North America"
    quote: "We're definitely seeing a trend where people that are offline, unreachable, have a sort of cool factor around them...this person doesn't need validation."
  - name: "Thred"
    url: "https://thred.com/style/is-being-offline-a-privilege/"
    region: "Europe"
    quote: "logging off is easier if you already have a seat at the table. If you're not already established or financially secure, social media provides a necessary safety net."
  - name: "Deloitte UK Consumer Trends Survey"
    url: "https://www.deloitte.com/uk/en/about/press-room/gen-zs-favour-social-media-ban-for-under-16s-as-digital-fatigue-hits.html"
    region: "Europe"
    quote: "nearly a quarter of all consumers had deleted a social media app in the previous 12 months, rising to nearly a third for Gen Zers"
  - name: "Insight Trends World"
    url: "https://www.insighttrendsworld.com/post/wellness-offline-is-the-new-luxury-how-digital-detox-experiences-became-the-ultimate-social-status"
    region: "International"
    quote: "The truly wealthy now measure richness in time, not attention."
faqs:
  - q: "Why are wealthy people leaving social media first?"
    a: "They don't need it. Established professionals already have networks, clients, and visibility. Social media was a tool for access — if you already have access, the tool becomes optional. Meanwhile, freelancers, small business owners, and job hunters depend on these platforms for income and opportunity."
  - q: "Is it actually becoming a status symbol to not have social media?"
    a: "Yes. A 23-year-old account manager told CNBC: 'people that are offline, unreachable, have a sort of cool factor around them.' When opting out of something becomes exclusive, that thing has become a trap for everyone who can't leave."
  - q: "Can you really succeed professionally without social media in 2026?"
    a: "It depends on your industry and existing network. Writers, creatives, and entrepreneurs increasingly rely on these platforms to circulate work and find clients. One writer put it bluntly: 'to delete your accounts is not simply to remove an app — it is, potentially, to disappear from the informal economy that now governs cultural relevance.'"
---
