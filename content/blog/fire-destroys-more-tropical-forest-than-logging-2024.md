...
image: "https://images.pexels.com/photos/4070727/pexels-photo-4070727.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800&w=1200"
...
faqs:
  - q: "How fast can rainforest become grassland once fire takes over?"
    a: "Scientists studying the Amazon found that once the fire cycle starts, forests can convert to grassland systems in less than a decade. It's not a gradual 100-year transition — it's a rapid flip."
  - q: "Can savannification be reversed?"
    a: "Once rainforest crosses the threshold and converts to grassland, it's unlikely to revert naturally. Trees that aren't adapted to fire don't survive, grasses take over, and the new ecosystem becomes self-reinforcing through drier conditions and more frequent burns."
  - q: "Why doesn't traditional conservation work against fire?"
    a: "Most forest protection focuses on stopping illegal logging and land clearing. But when fire becomes the main threat — driven by drought and climate, not people with chainsaws — enforcement can't stop it. You can't arrest the atmosphere."
sources:
  - name: "World Resources Institute"
    url: "https://www.wri.org/insights/global-trends-forest-fires"
    region: "International"
    quote: "In 2024, fires were responsible for nearly half (48%) of all tree cover loss in tropical primary forests like the Amazon and Congo Basin."
  - name: "New Scientist"
    url: "https://www.newscientist.com/article/2480926-tropical-forest-loss-doubled-in-2024-as-wildfires-rocketed/"
    region: "International"
    quote: "Five times more primary forest was lost from fires in the tropics in 2024 than in 2023, accounting for 48 per cent of all primary rainforest loss."
  - name: "The New York Times"
    url: "https://www.nytimes.com/2025/05/22/climate/deforestation-wri-report.html"
    region: "North America"
    quote: "Those fires emitted 4.1 gigatons of planet-warming greenhouse gasses, which is more than four times the emissions from air travel in 2023."
  - name: "Science Advances (Amazon Tipping Point study)"
    url: "https://www.science.org/doi/10.1126/sciadv.aat2340"
    region: "International"
    quote: "Many studies show that in the absence of other contributing factors, 4° Celsius of global warming would be the tipping point to degraded savannas in most of the central, southern, and eastern Amazon."
  - name: "Colorado Public Radio (Jennifer Balch interview)"
    url: "https://www.cpr.org/2019/09/05/how-quickly-could-the-amazon-rainforest-become-the-amazon-grassland-within-10-years-this-boulder-scientist-discovered/"
    region: "North America"
    quote: "We can reach that tipping point with fire and drought very, very quickly. We had the influx of new grasses, and essentially, could convert that forest to a grassland system in less than a decade."
