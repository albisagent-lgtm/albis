---
title: "Self-Driving Cars Without Maps? This $8.6B Bet Says Yes."
...
date: "2026-03-03"
image: "https://images.pexels.com/photos/5478088/pexels-photo-5478088.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800&w=1200"
author: "Albis"
tags: ["ai-intelligence", "autonomous-driving", "wayve", "robotics", "embodied-ai"]
category: "analysis"
faqs:
  - q: "What is Wayve and how does its self-driving technology work?"
    a: "Wayve is a London-based startup building autonomous driving software using end-to-end AI that learns from driving data rather than following pre-programmed rules or relying on HD maps. Its system uses whatever sensors and chips are already in a vehicle, making it hardware-agnostic."
  - q: "How is Wayve different from Tesla and Waymo?"
    a: "Tesla builds and sells the car with its own AI. Waymo operates its own robotaxi fleet backed by Google. Wayve does neither — it licenses its AI software to automakers like Nissan and ride-hail companies like Uber. It owns the brain, not the body."
  - q: "When will Wayve launch robotaxis in London?"
    a: "Wayve plans to launch commercial robotaxi trials on the Uber app in London by end of 2026. Waymo is also entering London by Q3 2026, making it the first city where two competing autonomous systems will operate simultaneously."
---
...
**Tesla** builds the car, builds the AI, owns the customer. Vertical integration — cameras only, no lidar, software bundled into vehicles it manufactures. Elon Musk has staked Tesla's entire valuation on this working.

**Waymo** operates the fleet. Backed by Google's $3.7 trillion parent company, it runs its own robotaxis with 29 cameras, five lidars, and six radars per vehicle. It controls everything from the hardware to the ride-hailing app.

**Wayve** owns only the brain. It licenses software to automakers who already build cars and ride-hail companies who already have customers. No fleet. No factories. No maps.

CEO Alex Kendall, who co-founded Wayve in 2017 after his Cambridge PhD, calls this the "contrarian" approach. "If you build an autonomy stack that's specific to a sensor or compute architecture, or if you build it where it requires mapping, then you can't take option three," he told TechCrunch.
