...
faqs:
  - q: "Is Gen Z really less cognitively capable than previous generations?"
    a: "Yes. Neuroscientist Jared Cooney Horvath testified before the US Senate that for the first time in modern history, today's generation has failed to outperform their parents on standardized assessments. PISA data from 15-year-olds worldwide shows a correlation between more screen time in schools and worse test scores."
  - q: "Does AI tutoring actually improve student learning?"
    a: "Early evidence is mixed but promising in narrow cases. A Google/Eedi Labs trial found AI tutoring matched or outperformed human tutors in math. But less than 10% of edtech tools used in schools have verified proof of learning impact, according to Instructure's 2026 evidence report."
  - q: "How much time do US students spend on screens in school?"
    a: "American grade schoolers spend an average of 98 minutes per day on school-issued digital devices, and use 42 different educational technology tools per year. The edtech industry is now worth hundreds of billions of dollars globally."
sources:
  - name: "Fortune"
    url: "https://fortune.com/2026/03/01/american-schools-broken-silicon-valley-edtech-gen-z-test-scores/"
    region: "North America"
    quote: "Gen Z is the first generation to be less cognitively capable than their predecessors."
  - name: "Boston Globe"
    url: "https://www.bostonglobe.com/2026/03/13/opinion/ai-artificial-intelligence-literacy-education/"
    region: "North America"
    quote: "Less than 10 percent of educational technology tools have verified proof of impact on learning."
  - name: "FutureEd / Georgetown"
    url: "https://www.future-ed.org/research-notes-two-emerging-strategies-for-using-ai-in-tutoring/"
    region: "North America"
    quote: "Supervising tutors approved 76.4 percent of LearnLM's responses with little or no edits."
  - name: "AP News / NWEA"
    url: "https://apnews.com/article/reading-test-scores-first-second-grade-03a914085a69edc8fe4dcc7c2530e6c1"
    region: "North America"
    quote: "While math scores have inched up every year, reading scores remain stagnant."
  - name: "Christian Science Monitor"
    url: "https://www.csmonitor.com/Editorials/the-monitors-view/2026/0313/Students-and-AI-Mastery-not-misuse"
    region: "North America"
    quote: "84% of students now use AI in school assignments, up from zero three years ago."
...
The [Economist asked in January](https://www.economist.com/letters/2026/02/12/is-education-technology-mostly-useless) whether edtech is "mostly useless." The responses filled a letters page. Schools across the world had invested billions into digital platforms, adaptive learning software, and classroom hardware. The learning gains? Modest at best.
...
In a [Google/Eedi Labs study](https://www.future-ed.org/research-notes-two-emerging-strategies-for-using-ai-in-tutoring/), 165 students aged 13-15 were randomly assigned to chat with a human tutor, an AI tutor called LearnLM, or receive static hints. Supervising tutors approved 76.4% of the AI's responses with little or no editing. Students who worked with the AI performed better on harder follow-up topics — a 66% success rate, versus 61% for human-tutored students and 56% for those receiving static hints.
