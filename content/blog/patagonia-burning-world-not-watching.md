...
author: "Albis"
tags: ["unseen", "gai", "climate", "argentina", "patagonia", "wildfires"]
faqs:
  - question: "How much forest has burned in Patagonia in 2026?"
    answer: "More than 45,000 hectares — an area almost twice the size of Buenos Aires — have burned across four Argentine provinces since November 2025, surpassing last year's entire fire season in a single month."
  - question: "Why is nobody covering the Patagonia wildfires?"
    answer: "The Albis Global Attention Index scored this story at 6.64, meaning only two of seven global regions covered it. The Iran-Israel war has consumed nearly all international attention, leaving climate disasters in the Southern Hemisphere invisible."
  - question: "What role did Argentina's budget cuts play in the fires?"
    answer: "President Milei's austerity program slashed the National Fire Management Service budget by 71% in real terms, according to the environmental group FARN. Critics say reduced prevention capacity made the fires worse."
sources:
  - name: "The Guardian"
    url: "https://www.theguardian.com/world/2026/feb/11/climate-fuelled-wildfires-patagonia-argentina-chile-oldest-trees"
    region: "Europe"
    quote: "Ancient forests were devastated, as was the unique biodiversity in the area. These are ancient giants that have stood undisturbed for thousands of years."
  - name: "Bulletin of the Atomic Scientists"
    ...
    quote: "More than 45,000 hectares — an area almost twice the size of the city of Buenos Aires — have already been consumed by fire in Northern Patagonia this summer."
  - name: "Al Jazeera"
    url: "https://www.aljazeera.com/gallery/2026/2/3/wildfires-devastate-argentinas-patagonia-threaten-ancient-forests"
    region: "Middle East"
    quote: "His administration's 'chainsaw' spending cuts have slashed the National Fire Management Service's budget by 71 percent in real terms."
  - name: "Reuters"
    url: "https://www.reuters.com/sustainability/climate-energy/patagonia-wildfires-stir-criticism-over-milei-austerity-cuts-2026-01-30/"
    region: "International"
    quote: "The burned area has already surpassed the roughly 80,000 acres of Patagonian forest scorched during last summer's fire season."
  - name: "Mongabay"
    url: "https://news.mongabay.com/2026/01/patagonia-fires-reignite-debate-over-argentinas-underfunded-environmental-agencies/"
    region: "International"
    quote: "The fires have destroyed at least 21,000 hectares of forest and grassland in and around the park, home to the alerce tree, a cypress that can live for more than 3,600 years."
