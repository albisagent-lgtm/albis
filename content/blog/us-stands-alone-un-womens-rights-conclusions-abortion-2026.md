...
image: "https://images.pexels.com/photos/6257540/pexels-photo-6257540.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
...
sources:
  ...
  - name: "Inter Press Service"
    ...
    region: "International"
    quote: "No country in the world has achieved full legal equality."
  - name: "Equal Rights Advocates"
    url: "https://www.equalrights.org/news/california-advocates-introduce-legislation-to-increase-protections-for-immigrant-workers-transgender-patients-sexual-violence-survivors-and-more/"
    region: "North America"
    quote: "As the federal government attacks our rights as women, workers, LGBTQI+ people, and parents, California must continue to lead."
  - name: "Reproductive Freedom for All"
    url: "https://newsletter.usareproductivefreedomforall.org/p/reproductive-freedom-for-all-march-20-2026"
    region: "North America"
    quote: "Hawley targets mifepristone, Kansas disguises an abortion ban."
confidence: "confirmed"
faqs:
  - q: "Why did the US vote against the UN women's rights conclusions in 2026?"
    a: "The US objected to language on abortion rights, AI regulation, and what the White House called 'gender ideology' in the CSW70 Agreed Conclusions. Washington also attempted to redefine 'gender' in UN documents to mean strictly 'men and women,' but the EU blocked this proposal through a no-action motion."
  - q: "What is the Stronger California 2026 legislative agenda?"
    a: "It is a 15-bill package from a coalition of 70 organisations that aims to protect immigrant workers from deportation threats, expand abortion access, ban AI bias in hiring, provide 14 weeks paid parental leave for teachers, and crack down on forced arbitration in sexual assault cases."
  - q: "What happened at CSW70 in March 2026?"
    a: "The 70th session of the UN Commission on the Status of Women adopted Agreed Conclusions on access to justice for women and girls. The US was the sole vote against adoption, breaking a near seven-decade consensus. Six countries that initially abstained ultimately voted in favour."
perception_gap: 7
regions_found: ["us", "eu", "middle_east", "africa", "latam"]
regions_absent: ["south_asia", "asia_pacific"]
region_significance:
  us: 5
  eu: 4
  middle_east: 2
  ...
  latam: 2
region_frames:
  us: "Framed as culture war over gender ideology and abortion rights"
  eu: "Framed as defence of established multilateral consensus on women's rights"
  middle_east: "Initial reservations about specific provisions but ultimately voted in favour"
  africa: "Focused on justice access and protecting women from violence"
  latam: "Connected gender equality to climate resilience and grassroots empowerment"
---
...
In Haiti, the Rasin organisation held its annual Fanm Djanm programme celebrating International Women's Day, planning 13 gender equality training sessions for 2026 after reaching 662 women across nine regions in 2025. The contrast between grassroots empowerment work and high-level diplomatic battles illustrates how the fight for [women's rights](/topics/womens-rights) operates simultaneously at vastly different scales.
