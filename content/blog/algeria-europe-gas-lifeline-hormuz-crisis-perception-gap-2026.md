...
perception_gap: 5
regions_found: [eu, africa, middle_east]
regions_absent: [us, south_asia, asia_pacific, latam]
region_significance:
  eu: 4
  africa: 5
  middle_east: 3
region_frames:
  eu: "Pragmatic supply route adjustment to replace lost Gulf LNG"
  africa: "Strategic vindication — Algeria coming to Europe's rescue, Mediterranean pipelines prove their worth"
  middle_east: "Shifting energy dependencies as Gulf's post-oil economy faces disruption"
sources:
  - name: "Energy Capital & Power"
    url: "https://energycapitalpower.com/hormuz-is-europes-gas-wake-up-call-and-north-africas-pipelines-are-the-strategic-hedge/"
    region: "Africa"
    quote: "Africa is once again in the spotlight... a physical, fixed connection to Mediterranean supply that is immune to naval blockades"
  - name: "Reuters"
    url: "https://www.reuters.com/business/energy/europe-faces-gas-storage-scramble-iran-conflict-tightens-supply-2026-03-05/"
    region: "International"
    quote: "Some of that will be delivered via pipeline from Norway, Algeria and to a much smaller degree from Russia"
  - name: "Pravda Algeria"
    url: "https://algeria.news-pravda.com/en/world/2026/03/17/4321.html"
    region: "Africa"
    quote: "Algeria is strengthening its position in Europe due to the crisis: in Spain, Algeria accounts for about 29-34% of all imported gas"
  - name: "Real Instituto Elcano"
    url: "https://www.realinstitutoelcano.org/en/analyses/another-round-of-algerian-gas-for-europe/"
    region: "Europe"
    quote: "The risk of the Mediterranean pipelines being damaged is much lower than in the Baltic"
  - name: "Euronews"
    url: "https://www.euronews.com/my-europe/2026/03/04/what-are-europes-oil-route-alternatives-to-the-strait-of-hormuz"
    region: "Europe"
    quote: "North Africa, particularly Algeria and Libya, provides very short-haul Mediterranean supply routes into Southern Europe"
faqs:
  - q: "Is Algeria replacing Qatar as Europe's gas supplier?"
    a: "Not fully, but Algeria is filling a growing share of the gap. French gas imports from Algeria jumped from 65,000 tonnes to 108,000 tonnes in early March 2026 — nearly doubling. Algeria supplies 29-34% of Spain's gas and about 31% of Italy's imports. Its Mediterranean pipelines bypass the Strait of Hormuz entirely, making them immune to the current crisis."
  - q: "What pipelines connect Algeria to Europe?"
    a: "Three main routes: TransMed (32.7 bcm/year capacity, linking Algeria to Italy via Tunisia), Medgaz (connecting directly to Spain), and two LNG terminals at Arzew and Skikda that ship liquefied gas across the Mediterranean. A Trans-Saharan Gas Pipeline from Nigeria through Algeria to Europe is planned to begin construction in 2026."
  - q: "Can Algeria produce enough gas to replace Gulf supplies?"
    a: "Not in the short term. Algeria produces about 100 billion cubic meters of gas annually, but roughly half goes to domestic consumption. Existing export pipelines — especially Medgaz — are near capacity. Algeria has announced a $60 billion investment plan for 2025-2029 with Chevron, ExxonMobil, and Sinopec, but new production will take 5-10 years."
---
...
In European media, Algeria appears as a footnote — one of several "alternative supply routes" mentioned alongside Norway, Libya, and remaining Russian flows. Reuters [reported](https://www.reuters.com/business/energy/europe-faces-gas-storage-scramble-iran-conflict-tightens-supply-2026-03-05/) that Europe faces a "gas storage scramble" and noted that some supply "will be delivered via pipeline from Norway, Algeria and to a much smaller degree from Russia." Algeria gets one clause in one sentence.

Euronews covered [Europe's oil route alternatives](https://www.euronews.com/my-europe/2026/03/04/what-are-europes-oil-route-alternatives-to-the-strait-of-hormuz) and described North Africa as providing "very short-haul Mediterranean supply routes into Southern Europe." Factual, brief, and buried in a listicle of options.
...
Energy Capital & Power [published the clearest analysis](https://energycapitalpower.com/hormuz-is-europes-gas-wake-up-call-and-north-africas-pipelines-are-the-strategic-hedge/) of what's happening. "Africa is once again in the spotlight," it wrote. "The continent represents more than a backup supplier — it is a physical, fixed connection to Mediterranean supply that is immune to naval blockades, insulated from maritime insurance spikes, and increasingly central to Europe's energy security calculus."
...
The Real Instituto Elcano, a Spanish think tank, [noted](https://www.realinstitutoelcano.org/en/analyses/another-round-of-algerian-gas-for-europe/) that "the risk of the Mediterranean pipelines being damaged is much lower than in the Baltic" — a reference to the Nord Stream sabotage that disrupted European gas from Russia in 2022. Algeria's pipelines sit at depths and in waters where sabotage risks are structurally lower.
...
The [Albis Global Attention Index](/indexes/gai) scores this story at 4.64 — "Selective Visibility." Only Europe, Africa, and the Middle East are covering it. The US, South Asia, Asia-Pacific, and Latin America — 3.98 billion people — don't see this energy realignment happening.
...
Now the rigidity is the advantage. You can close a strait. You can mine a shipping lane. You can charge ships [$2 million to transit](/blog/iran-hormuz-transit-fee-shipping-system-international-law-2026). You can't close a pipe that runs under the seabed from Hassi R'Mel to Mazara del Vallo.
