---
title: "AI Deepfakes Are Running Both Sides of the Iran War"
...
faqs:
  - q: "Are both sides using deepfakes in the Iran war?"
    a: "Yes. Researchers have documented pro-Iran AI-generated content — including fake carrier sinkings — as well as Israeli-linked networks using AI imagery. The New York Times identified over 110 deepfakes with pro-Iran messaging in two weeks. Citizen Lab documented a separate Israeli-backed AI campaign called PRISONBREAK that used deepfakes timed to coincide with actual military strikes."
  - q: "How are platforms handling Iran war disinformation?"
    a: "Inconsistently. YouTube expanded its deepfake detection to politicians and journalists in March 2026. But X's Grok AI chatbot was caught verifying a deepfake with another AI-generated image. Community Notes corrections take hours — by which point millions have already seen the false version."
  - q: "What happened to US internet freedom funding?"
    a: "DOGE-driven cuts in 2025 gutted a $500M+ program that funded censorship-resistance tools in Iran, China, and Myanmar. The main granting office issued no money in 2025. A court restored some funding in December 2025, but the Trump administration is now appealing that ruling."
sources:
  - name: "WIRED"
    url: "https://www.wired.com/story/fake-ai-content-about-the-iran-war-is-all-over-x/"
    region: "North America"
    quote: "X's Grok is failing to accurately verify video footage from the Iran conflict and is sharing its own AI-generated images about the war."
  - name: "TechCrunch"
  ...
  - name: "The Guardian"
    ...
    quote: "For nearly two decades, the US quietly funded a global effort to keep the internet from splintering into fiefdoms run by authoritarian governments."
  - name: "Erkan's Field Diary / Citizen Lab"
    url: "https://erkansaka.net/2026/03/06/iran-war-disinformation-ai-2026-6-march/"
    region: "International"
    quote: "Researchers at the University of Toronto's Citizen Lab documented a coordinated Israeli-backed network called PRISONBREAK that routinely used AI-generated imagery and video, mimicked real news outlets, and deployed deepfakes during periods of actual kinetic attacks."
  - name: "Foundation for Defense of Democracies"
    url: "https://www.fdd.org/analysis/2026/03/19/deepfakes-on-the-front-lines-irans-ai-disinformation-campaign/"
    region: "North America"
    quote: "The New York Times has identified in the past two weeks more than 110 unique deepfakes that convey a pro-Iran message through battlefield images, missile strike depictions, and general war footage."
---
...
The [Albis Perception Gap Index](/indexes/pgi) shows diverging public beliefs about the same conflict. The gap isn't about access to information. It's about which version platforms served first.
...
For how different regions are processing this conflict, see the [Iran perspectives page](/perspectives/iran).
