...
sources:
  - name: "World Food Programme"
    url: "https://www.wfp.org/news/families-sudan-pushed-brink-amidst-brutal-conflict-and-famine-wfp-resources-dry"
    region: "International"
    quote: "By the end of March, we will have depleted our food stocks in Sudan."
  - name: "The Guardian"
    url: "https://www.theguardian.com/global-development/ng-interactive/2026/mar/10/extraordinary-cruelty-images-show-longterm-starvation-strategy-in-sudan"
    region: "Europe"
    quote: "People were at the brink of starvation and objects indispensable to their survival were being destroyed."
  - name: "Deutsche Welle"
    url: "https://www.dw.com/en/civil-war-in-sudan-is-a-never-ending-humanitarian-crisis/a-76335589"
    region: "Europe"
    quote: "Sudan is facing a deep and prolonged humanitarian crisis that is increasingly disappearing from international attention."
  - name: "Arab News"
    url: "https://www.arabnews.pk/node/2636153"
    region: "Middle East"
    quote: "The war in Sudan has often received limited attention from the international media and global leadership."
  - name: "The Borgen Project"
    url: "https://borgenproject.org/hunger-in-sudan-2/"
    region: "North America"
    quote: "The impact on food security is not an unfortunate by-product of the conflict. Instead, the two warring civil factions have orchestrated it as a war tactic."
confidence: "confirmed"
faqs:
  - q: "How many people are starving in Sudan in 2026?"
    a: "Over 21 million Sudanese — nearly half the country's population — face acute food insecurity. Famine has been confirmed in Al Fasher and Kadugli, with 375,000 people at risk of starvation. The WFP warns its food stocks will be fully depleted by the end of March 2026."
  - q: "Why is the Sudan famine being ignored?"
    a: "The Iran-Israel war has consumed global media attention since late February 2026. Sudan's crisis is covered primarily in Africa, the Middle East, and parts of Europe, but remains almost completely invisible to audiences in the US, Asia-Pacific, South Asia, and Latin America — roughly 4.7 billion people."
  - q: "Who is causing the famine in Sudan?"
    a: "Both the Sudanese Armed Forces (SAF) and Rapid Support Forces (RSF) are accused of weaponizing hunger. The RSF has blocked aid convoys, looted humanitarian supplies, destroyed farming infrastructure, and imposed sieges designed to starve civilian populations. Yale researchers documented the targeted destruction of 41 villages' food-production capacity."
---
...
Sudan holds a grim triple record: the world's largest hunger crisis, largest displacement crisis, and one of its most invisible wars. The [Albis Global Attention Index](/indexes/gai) scored it at 5.15 — covered in [Africa](/perspectives/sudan), the Middle East, and parts of Europe, but invisible to the US, Asia-Pacific, South Asia, and Latin America.
...
The UN Human Rights Council's report on the RSF's [attack on Al Fasher](/topics/sudan) last year used a phrase rarely deployed: "hallmarks of genocide."
...
But the two are connected. The Iran war has already disrupted [global food supply chains](/topics/food-security). Fertilizer shipments through Hormuz are stuck. Spring planting windows are closing. Destroy Sudan's agricultural base while global food logistics are also breaking — the cascade hits everywhere.
