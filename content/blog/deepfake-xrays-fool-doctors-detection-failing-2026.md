---
title: "Deepfake X-Rays Now Fool Doctors. Detection Is Losing."
...
perception_gap: 7
regions_found: ["us", "eu", "middle_east", "africa"]
regions_absent: ["latam", "south_asia"]
region_significance:
  us: 5
  eu: 4
  middle_east: 4
  africa: 3
region_frames:
  us: "Framed as detection and security problem — how to catch fakes"
  eu: "Framed as regulatory and market opportunity for detection tools"
  middle_east: "Framed as military AI reshaping the Iran-Israel-US conflict"
  africa: "Framed as institutional readiness for financial sector defence"
confidence: "confirmed"
sources:
  - name: "ScienceDaily / Radiology (RSNA)"
  ...
  - name: "Biometric Update"
    url: "https://www.biometricupdate.com/202603/shufti-warns-that-lab-tested-deepfake-tools-are-failing-in-the-real-world"
    region: "International"
    quote: "The industry needs to stop treating lab accuracy as deployment readiness"
  - name: "404 Media"
    url: "https://www.404media.co/iran-is-winning-the-ai-slop-propaganda-war/"
    region: "North America"
    quote: "Iran is currently doing a better job of speaking to the concerns of the broad American population than the American president"
  - name: "IT Brief Asia / Resemble AI"
    url: "https://itbrief.asia/story/resemble-ai-launches-deepfake-detector-threat-report"
    region: "Asia-Pacific"
    quote: "Europol estimates that as much as 90% of online content could contain some form of AI-generated material by the end of 2026"
  - name: "Shafaq News"
    url: "https://shafaq.com/en/Report/AI-reshapes-Iran-Israel-US-conflict-as-cyber-warfare-expands"
    region: "Middle East"
    quote: "Military advantage now depends less on numerical strength and more on the ability to process information, interpret signals, and act with speed"
faqs:
  - q: "Can AI generate fake X-rays that fool doctors?"
    a: "Yes. A March 2026 study in Radiology tested 17 radiologists across six countries on AI-generated X-rays from ChatGPT and Stanford's RoentGen model. Even when warned fakes were present, doctors couldn't reliably tell real from synthetic. Researchers warn this creates risks for fraudulent litigation and hospital cyberattacks."
  - q: "Are deepfake detection tools actually working?"
    a: "Many aren't. Detection tools that pass lab tests often fail under real-world conditions — low bandwidth, compressed uploads, cheap phone cameras strip the signals they depend on. Shufti warns the gap between lab accuracy and deployment readiness is growing, creating a 'trust tax' on digital transactions."
  - q: "How is AI being used in propaganda during the Iran conflict?"
    a: "Both Iran and the US are producing AI-generated propaganda content. Iran's 'Explosive News Team' creates viral Lego-style videos mocking Trump and Netanyahu, while the White House posts stylised AI imagery. Researchers at 404 Media note Iran's content resonates more broadly with American audiences concerned about economic impacts."
---
...
Meanwhile in South Africa, Reality Defender just partnered with Certified AI Access to deploy enterprise-grade [deepfake detection across the financial sector](/blog/deepfakes-broke-identity-verification). It's a pattern: each country scrambling to patch its own defences while the attack surface grows globally.
...
Iran's "Explosive News Team" — a propaganda operation identified by 404 Media — [has been producing AI-generated Lego-style videos](/blog/iran-ai-war-propaganda-flooding-social-media-2026) depicting Trump and Netanyahu. The latest went viral this week across Instagram, Reddit, and Facebook, set to a catchy rap about American foreign policy. Snopes verified the videos as Iranian propaganda distributed across multiple platforms.
...
Here's where the [perception gap](/indexes/pgi) opens wide.
