...
sources:
  ...
  - "Reuters - US charges 3 tied to Super Micro with smuggling billions"
  - "Tom's Hardware - Hair dryer serial number swap detail from indictment"
  - "CNAS - Countering AI Chip Smuggling report (June 2025)"
  - "FDD - Exposure of Major Chinese-Linked Chip Smuggling Operations"
confidence: "confirmed"
perception_gap: 5
regions_found: [us, asia_pacific, eu]
regions_absent: [middle_east, south_asia, africa, latam]
region_significance:
  us: 5
  asia_pacific: 5
  eu: 3
region_frames:
  us: "National security enforcement success — biggest chip smuggling prosecution ever"
  asia_pacific: "Evidence that US tech containment is porous and overreaching"
---
...
Yih-Shyan "Wally" Liaw co-founded [Super Micro Computer](/topics/ai) in 1993. He's 71 years old and held $464 million in company stock. Federal agents arrested him last week alongside two co-conspirators: SuperMicro's Taiwan general manager Ruei-Tsang Chang (now a fugitive) and a third-party fixer named Ting-Wei Sun.
...
Here's why this case matters beyond the headlines. The Center for New American Security [estimated in June 2025](https://www.cnas.org/publications/reports/countering-ai-chip-smuggling-has-become-a-national-security-priority) that approximately 140,000 export-controlled AI chips were smuggled into China in 2024 alone — with estimates ranging from 10,000 to several hundred thousand.
