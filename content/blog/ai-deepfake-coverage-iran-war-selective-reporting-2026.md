---
title: "Iran War AI Coverage: Which Deepfakes Get Reported?"
...
region_significance:
  ...
  asia_pacific: 3
region_frames:
  us: "Iranian/IRGC deepfake operations threatening information integrity"
  middle_east: "Both sides deploying AI propaganda symmetrically — Israeli PRISONBREAK and Iranian IRGC operations"
  eu: "AI governance failure enabling wartime disinformation"
  asia_pacific: "Technology arms race extending to information warfare"
faqs:
  - q: "Are both sides using AI deepfakes in the Iran war?"
    a: "Yes. The New York Times identified 110+ pro-Iran deepfakes. Citizen Lab documented Israel's PRISONBREAK network using 50+ fake accounts and AI-generated imagery timed to military strikes. Both campaigns are well-documented — but English-language media covers Iranian operations far more prominently."
  - q: "What is the PRISONBREAK AI operation?"
    a: "PRISONBREAK is an AI-enabled influence campaign documented by Citizen Lab at the University of Toronto. It uses 50+ coordinated fake X profiles to push anti-regime narratives to Iranian audiences, with activity synchronised to Israeli military operations. Researchers assess it's most likely run by an Israeli government agency or sub-contractor."
  - q: "Is Palantir AI being used in the Iran war?"
    a: "Yes. The Pentagon confirmed using Palantir's Maven Smart System with Anthropic's Claude AI for target generation and prioritisation during Iran strikes. Admiral Brad Cooper, CENTCOM chief, publicly touted the use of 'advanced AI tools' in Operation Epic Fury. Iran struck AWS data centres in the UAE partly in response to their role in this infrastructure."
sources:
  - name: "The Guardian"
    url: "https://www.theguardian.com/world/2026/mar/22/iran-social-media-strategy-information-war-us-israel-attack"
    region: "Europe"
    quote: "There were accounts run by the IRGC pretending to be Scottish and Irish and talking about Scottish and Irish politics one day and then exclusively focused the war in Iran and unabashed Iranian propaganda the next."
  - name: "Citizen Lab"
    url: "https://citizenlab.ca/2025/10/ai-enabled-io-aimed-at-overthrowing-iranian-regime/"
    region: "North America"
    quote: "We assess that the hypothesis most consistent with the available evidence is that an unidentified agency of the Israeli government, or a sub-contractor working under its close supervision, is directly conducting the operation."
  - name: "Erkan's Field Diary"
    url: "https://erkansaka.net/2026/03/23/ai-native-war-disinformation-iran-israel-us/"
    region: "International"
    quote: "The Iran-Israel-US war has produced what researchers are calling the first truly 'AI-native' conflict information environment."
  - name: "Democracy Now"
    url: "https://www.democracynow.org/2026/3/18/ai_warfare"
    region: "North America"
    quote: "The system, known as Project Maven, was created by Palantir, and it incorporates the AI model Claude, built by Anthropic. The Pentagon is investigating if the AI system played a role in the US strike on the Iranian girls' school."
  - name: "Foreign Affairs Forum"
    url: "https://www.faf.ae/home/2026/3/19/x1"
    region: "Middle East"
    quote: "AI-generated content now constitutes a larger share of the disinformation ecosystem than content produced through traditional manipulation methods."
---
...
The result: people who read only English know that Iran runs deepfakes. They don't know, with the same specificity and confidence, that [Israel runs AI influence campaigns](/topics/information-warfare) timed to kinetic strikes, or that the US military's own AI targeting system is under investigation for its role in civilian deaths.
