...
sources:
  - name: "Block Club Chicago"
    ...
    quote: "Alpha Schools look more like a tech startup than a school. Its biggest break from tradition is an education model that uses AI to teach core subjects while adults serve as 'guides,' not teachers."
  - name: "Chalkbeat New York"
    url: "https://www.chalkbeat.org/newyork/2026/03/24/preliminary-ai-policy-nyc-schools/"
    region: "North America"
    quote: "All decisions made about students, including grading, development of special education plans, discipline, counseling and crisis intervention, are strictly forbidden."
  - name: "404 Media"
    url: "https://www.404media.co/students-are-being-treated-like-guinea-pigs-inside-an-ai-powered-private-school/"
    region: "North America"
    quote: "Alpha School's AI is generating faulty lesson plans that internal company documentation find sometimes do 'more harm than good.'"
  - name: "UK Government (GOV.UK)"
    ...
    region: "Europe"
    quote: "Social media bans, digital curfews, and time limits on apps will be piloted in the homes of 300 teenagers in a first of its kind trial."
  - name: "Mashable"
    url: "https://mashable.com/article/ai-alpha-school-trump-administration"
    region: "North America"
    quote: "A 2024 study found that highly motivated students could benefit from AI-assisted studying — but the tech had little effect on actual test scores."
...
region_significance:
  ...
  eu: 3
region_frames:
  us: "Polarised between AI-as-liberation (conservative/tech) and AI-as-risk (educators/parents)"
  eu: "UK frames screen restrictions as child protection; cautious on AI replacing teachers"
faqs:
  - q: "Does Alpha School's AI teaching actually work?"
    a: "Alpha claims students score in the top 1% on MAP tests and grow 2.6 times faster than peers. But Wikipedia notes this data has not been independently verified. A 404 Media investigation found the AI generates faulty lesson plans that internal documents say sometimes do 'more harm than good.'"
  - q: "Can AI grade students in New York City schools?"
    a: "No. NYC's new AI guidelines, released March 24, 2026, explicitly ban AI from grading, discipline decisions, special education plans, counseling, and crisis intervention. Teachers can use AI for lesson planning and drafting communications, but a human must make all decisions about students."
