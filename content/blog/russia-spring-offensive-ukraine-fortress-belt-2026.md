...
perception_gap: 6.7
regions_found: [us, eu]
regions_absent: [middle_east, asia_pacific, south_asia, africa, latam]
region_significance:
  us: 4
  eu: 5
region_frames:
  eu: "Offensive doomed to fail — unsustainable casualties"
  asia_pacific: "Russian forces advancing triumphantly (Sohu) vs desperate attrition (NetEase)"
confidence: "confirmed"
sources:
  - name: "Institute for the Study of War (ISW)"
    url: "https://understandingwar.org/research/russia-ukraine/russian-offensive-campaign-assessment-march-21-2026/"
    region: "North America"
    quote: "Russian forces have likely begun their anticipated Spring-Summer 2026 offensive against the Ukrainian Fortress Belt"
  - name: "The Guardian"
    ...
    region: "Europe"
    quote: "Ukraine has begun the compulsory evacuation of children from the city of Sloviansk"
  - name: "Kyiv Independent"
    url: "https://kyivindependent.com/russian-daily-losses-surge-ukrainian-commander-claims-hundreds-picked-off-by-drones/"
    region: "Europe"
    quote: "1,520 Russian casualties on March 19, following 1,710 on March 18 — about twice the daily losses"
  - name: "Reuters"
    url: "https://www.reuters.com/business/aerospace-defense/ukraine-begins-compulsory-evacuation-children-donbas-city-2026-03-20/"
    region: "International"
    quote: "Russian forces are about 20km from the edge of the city"
faqs:
  - q: "What is Ukraine's Fortress Belt?"
    a: "The Fortress Belt is Ukraine's main defensive line in Donetsk Oblast — a chain of fortified cities including Sloviansk, Kramatorsk, Druzhkivka, and Kostyantynivka. These are the last major urban centres Ukraine controls in the Donbas region, and Russia sees capturing them as its key military objective."
  - q: "How many casualties has Russia suffered in Ukraine by 2026?"
    a: "Open-source estimates put total Russian casualties at roughly 1.29 million killed or wounded as of March 22, 2026. Russia has been losing about 40,000 troops per month since November 2025 while recruiting approximately 35,000 — a net monthly deficit of 5,000."
  - q: "Will Russia's 2026 spring offensive succeed?"
    a: "The Institute for the Study of War (ISW) assessed on March 21 that Russian forces are unlikely to seize the Fortress Belt in 2026 but will make some tactical gains at heavy cost. Initial attacks saw 81% casualty rates, with 900 troops lost in 36 hours across a 100km front."
---
...
Total Russian casualties now stand at roughly [1.29 million](/topics/russia) killed or wounded since February 2022 — more than the total number of American casualties in all of World War I. The Telegraph reported in February 2026 that this figure had crossed 1.25 million, surpassing total US casualties in the entire war.
...
Meanwhile, US Patriot air defence missiles are being quietly moved from Europe toward the Middle East to deal with the [Iran war](/topics/iran-war). Defence officials told the Associated Press that Patriot missile stocks in Europe were "absolutely" dwindling. One official called the situation "pretty concerning."
