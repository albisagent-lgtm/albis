---
title: "Israel Kills 3 Journalists, 9 Paramedics in Lebanon"
...
region_significance:
  ...
  asia_pacific: 3
region_frames:
  us: "Reported as strike on Hezbollah-linked journalist, incident under investigation"
  eu: "Framed as press freedom violation and possible war crime"
  middle_east: "Framed as deliberate targeting of press and medical infrastructure, connected to systematic pattern"
  south_asia: "Covered as escalation in Lebanon with international law implications"
  asia_pacific: "Secondary reporting focused on regional stability"
sources:
  - "Al Jazeera — Three journalists killed in Israeli strike on marked press car in Lebanon"
  - "The Guardian — Lebanon condemns 'blatant war crime' after Israel kills three journalists"
  - "Committee to Protect Journalists — Israeli strike on media car targets, kills 3 journalists in south Lebanon"
  - "Haaretz — Nine Paramedics Killed in IDF Strikes in Southern Lebanon, WHO Says"
  - "Amnesty International — Lebanon: Israel must halt attacks on healthcare workers"
confidence: "confirmed"
faqs:
  - q: "Which journalists were killed in the Lebanon press car strike?"
    a: "Ali Shoeib of Al-Manar TV, Fatima Ftouni of Al-Mayadeen TV, and her brother Mohammed Ftouni, a freelance photojournalist, were killed on the Jezzine highway on March 28, 2026."
  - q: "How many paramedics were killed in Lebanon on the same day?"
    a: "Nine paramedics were killed in five separate attacks in southern Lebanon on March 28, bringing the total health workers killed in March 2026 to 51, according to the WHO."
  - q: "Did Israel confirm the strike on the journalists?"
    a: "Yes. The IDF confirmed targeting Ali Shoeib, calling him a Hezbollah Radwan Force member who operated 'under the guise of a journalist.' It provided no evidence. CPJ and international press organisations rejected the characterisation."
---

An Israeli airstrike killed three journalists in a marked press car on Lebanon's Jezzine highway on March 28, 2026, while nine paramedics died in five separate strikes the same day. The [Albis Perception Gap Index](/indexes/pgi) scored this story 6.98 — the highest divergence of any story in the midday scan. How outlets described the same strike split along a single fault line: whether a journalist can be reclassified as a combatant after death.

Four precision missiles hit the car. Press helmets, singed vests, tripods, and microphones were pulled from the wreckage. The three dead: Ali Shoeib, who'd covered southern Lebanon for Al-Manar TV for nearly three decades; Fatima Ftouni, an Al-Mayadeen reporter whose uncle and his family were [killed in earlier Israeli strikes this month](/blog/israel-128-medical-sites-lebanon-hezbollah-healthcare-framing-2026); and her brother Mohammed Ftouni, a freelance photojournalist.
...
**CNN's headline:** "Israel kills 3 journalists in Lebanon, including reporter for Hezbollah-run broadcaster." The affiliation is in the headline. The killing is contextualised before it's condemned.

**Al Jazeera's headline:** "Three journalists killed in Israeli strike on marked press car in Lebanon." The press car is in the headline. The protection violation leads.

Same dead journalists. Same missiles. Two completely different entry points for the reader.
...
Arabic-language outlets — Al Jazeera Arabic, Ultra Palestine, Sky News Arabic — [connected the journalist and paramedic killings](/blog/lebanon-1-million-displaced-26-days-framing-gap-2026) into a single story of systematic targeting. English-language coverage largely treated them as separate events on the same day.
...
The [PGI score of 6.98](/indexes/pgi) reflects the widest framing gap in this scan cycle. The US-Middle East divergence hit 8.5 out of 10. Actor portrayal — who Shoeib was — scored 7.5. The question of who benefits from each framing scored 7.5.
