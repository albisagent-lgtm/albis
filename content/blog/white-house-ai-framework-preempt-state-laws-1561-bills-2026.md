...
sources:
  - name: "TechCrunch"
    ...
    quote: "The framework would centralize power in Washington by preempting state AI laws"
  - name: "Roll Call"
    url: "https://rollcall.com/2026/03/20/white-house-ai-framework-calls-for-preemption-of-state-laws/"
    region: "North America"
    quote: "The four-page document fulfilled a request from President Donald Trump's December executive order on state AI laws"
  - name: "MultiState.ai"
    url: "https://www.multistate.ai/artificial-intelligence-ai-legislation"
    region: "North America"
    quote: "As of March 2026, state lawmakers in 45 states have introduced 1,561 AI-related bills"
  - name: "CNBC"
    url: "https://www.cnbc.com/2026/03/20/trump-ai-policy-framework.html"
    region: "North America"
    quote: "Aiming to create uniform safety and security guardrails while preempting states from enacting their own AI rules"
...
It landed on the same day that 1,561 AI-related bills sit active across [45 state legislatures](/topics/ai).
...
This isn't new. In December 2025, Trump signed an executive order directing the DOJ to create an [AI Litigation Task Force](/topics/ai) — a unit whose job is to sue states over AI laws in federal court. That task force has been active since January 10. The Commerce Department was given 90 days to compile a list of "onerous" state laws. States that make the list risk losing federal broadband funding.
...
Two approaches to the same technology, running at completely different speeds. Europe's betting that [rules attract trust](/indexes/pgi). Washington's betting that rules slow you down. Both can't be right — but every AI company operating globally has to comply with both.
