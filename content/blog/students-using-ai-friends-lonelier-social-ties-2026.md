---
title: "Students Using AI as Friends Are Getting Lonelier"
...
sources:
  - name: "HEPI"
    ...
    region: "Europe"
    quote: "Around 15% of students report using AI for companionship, advice or to address loneliness."
  - name: "Psychology & Marketing"
    url: "https://doi.org/10.1002/mar.70093"
    region: "South Asia"
    quote: "Interacting with emotionally intelligent AI chatbots can boost mental health while simultaneously isolating users from real human relationships."
  - name: "The Atlantic"
    url: "https://www.theatlantic.com/family/2026/03/ai-friendship-chatbot/686345/"
    region: "North America"
    quote: "16 percent of American adults had used AI for companionship."
  - name: "Times of India"
    url: "https://timesofindia.indiatimes.com/education/news/the-rise-of-ai-companions-among-students-raises-difficult-questions-are-humans-no-longer-enough/articleshow/129628559.cms"
    region: "South Asia"
    quote: "Heavy users show increasing signals of loneliness, depression, and suicidal ideation over time."
  - name: "PsyPost"
    ...
    quote: "Users admitted they were spending so much time talking to their digital companions that they felt disconnected from their real-life friends."
faqs:
  - q: "Are students using AI chatbots as friends?"
    a: "Yes. A 2026 UK survey of 1,054 undergraduates found 15% use AI for companionship, advice, or to address loneliness. In the US, 16% of adults report using AI for companionship. For students dealing with exam pressure, relocation, or social anxiety, AI chatbots feel like a patient listener that is always available."
  - q: "Does talking to AI chatbots make you lonelier?"
    a: "Research published in Psychology & Marketing found that emotionally intelligent AI chatbots can improve short-term psychological wellbeing but simultaneously erode real-world social connections. A separate paper accepted at CHI 2026 found heavy AI companion users show increasing signals of loneliness, depression, and suicidal ideation over time."
  - q: "Should universities regulate student use of AI companions?"
    a: "Most universities have no policy addressing AI companionship specifically. Only 20% of universities have any formal AI policy at all. Experts recommend structured AI induction, clear guidance on healthy use, and investment in human counselling services alongside digital tools."
---
...
AI companions don't judge. They don't get tired. They don't cancel plans. For students already dealing with [AI pressures on academic honesty](/blog/95-percent-students-using-ai-assessments-universities-lost-2026), extending that relationship into emotional territory feels natural.
...
Same campus. Same course. Possibly the same tutorial group. The gap between [using AI well and using it as a crutch](/blog/half-of-students-say-they-use-ai-too-much-and-cant-stop) is paper-thin.
...
The [American Federation of Teachers launched a $23 million AI training academy](/blog/teachers-unions-ai-training-strike-protections-2026) in March, covering 400,000 educators. The White House released an AI legislative blueprint calling for skills training. Both treat AI as a learning tool. Neither addresses AI as an emotional relationship.
...
The story splits along economic lines. In wealthy nations, the worry is students replacing human friendships with AI. In countries where [fuel crises are shutting down schools](/blog/asia-schools-close-fuel-crisis-ai-teachers-2026), AI companionship isn't on the radar — access to any education is the emergency.
