...
image: "https://images.pexels.com/photos/2348809/pexels-photo-2348809.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800&w=1200"
featured: true
...
sources:
  - name: "Reuters"
    ...
    quote: "Pakistani and Afghan troops exchanged fire at dozens of points along their border on Friday as the U.N. said their week-old conflict has forced the displacement of more than 100,000 people."
  - name: "Al Jazeera"
    url: "https://www.aljazeera.com/news/2026/3/6/tehran-hit-by-heavy-bombing-on-day-seven-of-us-israel-war-on-iran"
    region: "Middle East"
    quote: "The Iranian Red Crescent said the death toll from attacks since Saturday had risen to at least 1,332."
  - name: "New York Times"
    url: "https://www.nytimes.com/2026/03/06/us/politics/trump-unconditional-surrender-iran.html"
    region: "North America"
    quote: "When he, as commander in chief, determines the goal of Operation Epic Fury has been fully realized, then Iran will essentially be in a place of unconditional surrender."
  - name: "News18"
    url: "https://www.news18.com/world/pakistans-petrol-bomb-fuel-prices-hiked-by-pkr-55-amid-west-asia-conflict-exclusive-details-9946942.html"
    region: "South Asia"
    quote: "Since Pakistan imports nearly 90% of its oil and 99% of its LNG through this route, the blockade has created a terrifying supply-chain vacuum."
  - name: "Bloomberg"
    url: "https://www.bloomberg.com/news/articles/2026-03-06/strait-of-hormuz-shipping-traffic-at-near-total-halt-jmic-says"
    region: "International"
    quote: "No oil shipments going through in the past 24 hours."
faqs:
  - q: "How are the Iran war and Pakistan-Afghanistan conflict connected?"
    a: "Pakistan sits between both wars geographically and strategically. The Strait of Hormuz closure from the Iran conflict has cut Pakistan's oil imports — 90% arrive via that route — while it fights Afghanistan on its western border. Pakistan also has a mutual defence pact with Saudi Arabia, which is under Iranian missile attack, potentially dragging Islamabad into a third front."
  - q: "Why is oil so expensive right now in March 2026?"
    a: "Brent crude hit $92.69 per barrel — a 35% weekly gain, the biggest in futures trading history since 1983. The Strait of Hormuz, which carries 20% of global oil, has been at a near-total shipping halt for seven days. Kuwait and Iraq have cut production because they've run out of storage space."
  - q: "What is China doing about the Strait of Hormuz crisis?"
    a: "China is negotiating directly with Iran for safe passage of Chinese-flagged oil and LNG vessels through the Strait of Hormuz. If successful, this would create a two-tier shipping system where Chinese vessels pass while others can't — giving Beijing enormous leverage over global energy markets."
---
...
No country on Earth has a worse strategic position right now than Pakistan.

To its west: open war with Afghanistan. Pakistani and Afghan troops exchanged fire at dozens of border points on Friday — the deadliest day yet. The UN says 100,000 people are displaced. At least 56 Afghan civilians are dead. Nearly half were children.

To its southwest: the Iran war raging across a shared border. Balochistan province takes pressure from three directions — Afghan fighting to the northwest, Iranian chaos to the southwest, and a BLA insurgency that never went away.

From the sea: the Hormuz closure is strangling Pakistan's economy. The country imports 90% of its oil and 99% of its LNG through that strait. Zero tankers passed through in the past 24 hours.
...
Whether that's realistic matters less than the fact that Pakistan's defence minister said it on the record. It reveals how Islamabad sees its position: existential.

## The oil weapon nobody aimed

Nobody designed the Hormuz closure to hurt Pakistan. But it's hitting harder there than almost anywhere else.
...
The implications reach far beyond this war. For decades, the US guaranteed freedom of navigation through Hormuz. If China replaces that guarantee for its own vessels, it reshapes who controls global energy. A geopolitical shift hiding inside a shipping deal.
...
Chinese state media calls the US-Israeli strikes "unprovoked armed aggression" — while quietly pursuing the Hormuz deal that could make China the gatekeeper of Gulf energy.

## The invisible crisis

A humanitarian catastrophe is forming in the spaces between these wars. Almost nobody's covering it.
...
And in the security vacuum, ISIS-K sees opportunity. The group operates across the Iran-Afghanistan-Pakistan tri-border area. The Taliban and Pakistan's military are distracted fighting each other. Iran's eastern security forces are redeploying west. The exact conditions ISIS-K thrives in are forming right now. Nobody has bandwidth to stop it.
