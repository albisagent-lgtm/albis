...
faqs: [
  {
    q: "Why is Sudan's crisis so underreported?",
    a: "It's hard to access (both sides block journalists), has no Western military involvement, and lacks the visual drama that drives clicks. Protracted crises fade even when the need grows."
  },
  {
    q: "How does media coverage affect aid?",
    a: "Research shows intense news coverage directly pressures governments to increase emergency aid budgets. Low-visibility crises get less funding, even when the need is greater. Some donors now deliberately target 'forgotten crises' to compensate."
  },
  {
    q: "How many people have died in Sudan's war?",
    a: "Official counts severely underestimate deaths. One study estimated over 61,000 deaths in Khartoum state alone by late 2024. Total casualties across the country are likely far higher but difficult to track amid internet blackouts and journalist targeting."
  }
]
---
