...
date: "2026-03-15"
author: "Albis"
image: "https://images.pexels.com/photos/8413428/pexels-photo-8413428.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800&w=1200"
tags: ["health-longevity", "epigenetic-reprogramming", "aging", "biotech", "gene-therapy", "longevity"]
seoKeyword: "epigenetic reprogramming therapy human trials 2026"
faqs:
  - q: "What is epigenetic reprogramming therapy?"
    a: "Epigenetic reprogramming uses transcription factors to reset age-related changes in gene expression, essentially telling old cells to behave like younger ones. Life Biosciences' ER-100 uses three Yamanaka factors (OSK) delivered via gene therapy to rejuvenate damaged retinal cells without altering DNA itself."
  - q: "Is there a drug that reverses aging in humans?"
    a: "ER-100 by Life Biosciences is the first therapy designed to reverse cellular aging to enter human clinical trials, receiving FDA clearance in January 2026. It targets age-related eye diseases first. Results from the Phase 1 safety trial are expected by late 2026 or early 2027."
  - q: "What are the risks of epigenetic reprogramming?"
    a: "The main risk is cancer. Yamanaka factors are pro-oncogenic, and full reprogramming has caused tumors in lab animals. ER-100 mitigates this by excluding c-Myc (the most cancer-linked factor) and using a doxycycline-controlled genetic switch that limits how long the remaining factors stay active."
sources:
  - name: "MIT Technology Review"
    ...
    quote: "Reprogramming is so powerful that it sometimes creates risks, even causing cancer in lab animals."
  - name: "Lifespan.io"
    url: "https://lifespan.io/news/first-human-cellular-reprogramming-trial-cleared-by-the-fda/"
    region: "North America"
    quote: "This is a huge milestone for the entire partial reprogramming field."
  - name: "Longevity Technology"
    url: "https://longevity.technology/news/fda-clears-first-human-trial-of-epigenetic-reprogramming-therapy/"
    region: "Europe"
    quote: "ER-100 employs three of the factors (OSK) delivered transiently to reset age-associated epigenetic markers."
  - name: "Nature"
    url: "https://www.nature.com/articles/s41586-020-2975-4"
    region: "International"
    quote: "Expression of three Yamanaka transcription factors restores youthful DNA methylation patterns and reverses vision loss."
  - name: "PMC/Longevity Clinics Study"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC12606959/"
    region: "Europe"
    quote: "Annual memberships frequently range from 10,000 to 50,000 euros, with some executive health packages exceeding 100,000 euros."
...
Life Biosciences already showed [preclinical results](https://www.lifebiosciences.com/life-biosciences-presents-new-data-at-ardd-2025-on-the-companys-partial-epigenetic-reprogramming-platform-in-liver-and-ocular-diseases/) in liver disease models at the 2025 Aging Research & Drug Discovery conference. The company's platform isn't a single drug. It's a delivery system for cellular age reversal across multiple tissues.
...
Nobody in [longevity research](/topics/health) pretends this is risk-free. The same Yamanaka factors that rejuvenate cells are pro-oncogenic. Continuous expression in mice causes rapid death from liver and intestinal failure. Shorter protocols have produced teratomas — tumors containing tissue from all three germ layers.
...
Glaucoma alone costs the US healthcare system an estimated $5.8 billion annually. Heart disease: $239 billion. Alzheimer's: $345 billion. If a single [platform](/topics/health) could address the underlying mechanism driving all of them, the math shifts dramatically.
