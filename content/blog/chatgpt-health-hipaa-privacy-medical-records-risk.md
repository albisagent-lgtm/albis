...
faqs:
  - q: "Is ChatGPT Health HIPAA compliant?"
    a: "No. ChatGPT Health is a consumer product, not a healthcare provider. HIPAA only covers doctors, hospitals, and insurers. Once you upload medical records to ChatGPT, those protections disappear entirely."
  - q: "Can OpenAI use my medical data to train AI models?"
    a: "OpenAI says health data is excluded from model training. But this is a company policy, not a legal requirement. There's no federal law stopping them from changing that policy in the future."
  - q: "How does Europe handle AI health data differently from the US?"
    a: "The EU's GDPR protects all personal data regardless of who holds it, with fines up to 4% of global revenue. The US has no equivalent federal privacy law for consumer health data shared outside traditional healthcare providers."
sources:
  - name: "TIME"
    url: "https://time.com/7344997/chatgpt-health-medical-records-privacy-open-ai/"
    region: "North America"
    quote: "No federal regulatory body governs the health information provided to AI chatbots"
  - name: "The Record (Recorded Future)"
    url: "https://therecord.media/chatgpt-health-draws-concern-privacy-critics"
    region: "North America"
    quote: "Sharing medical records with ChatGPT Health would remove the HIPAA protection from those records, which is dangerous"
  - name: "BBC News"
    url: "https://www.bbc.com/news/articles/cpqy29d0yjgo"
    region: "Europe"
    quote: "Campaigners warn it raises privacy concerns"
  - name: "Fierce Healthcare"
    url: "https://www.fiercehealthcare.com/ai-and-machine-learning/40m-people-use-chatgpt-answer-healthcare-questions-openai-says"
    region: "North America"
    quote: "More than 40 million turn to ChatGPT every day with healthcare questions"
...
Of ChatGPT's 800 million users, one in four asks a [health](/topics/health) question every week. That's not curiosity — that's desperation. Getting a doctor's appointment takes weeks. Understanding a lab result takes a medical degree. Decoding a hospital bill takes a lawyer.
