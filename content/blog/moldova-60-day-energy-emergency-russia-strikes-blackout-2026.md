---
title: "Moldova Declares 60-Day Energy Emergency"
description: "Russian strikes on Ukraine severed Moldova's main power link with Europe. 3.5 million face rolling blackouts — and 5.8 billion people have no idea."
date: "2026-03-25"
author: "Harry Wenham"
...
perception_gap: 5
regions_found: [eu]
regions_absent: [us, middle_east, south_asia, asia_pacific, latam, africa]
region_significance:
  eu: 4
region_frames:
  eu: "Framed as consequence of Russian aggression on Ukraine's infrastructure affecting a neighbour"
sources:
  - name: "European Pravda"
    url: "https://www.eurointegration.com.ua/eng/news/2026/03/24/7233910/"
    region: "Europe"
    quote: "Moldova has introduced a 60-day state of emergency in the energy sector and has not ruled out rolling power outages"
  - name: "The Moscow Times"
    url: "https://www.themoscowtimes.com/2026/03/24/moldova-accuses-russia-of-damaging-key-power-line-connecting-it-with-romania-a92316"
    region: "International"
    quote: "Overnight strikes disconnected Moldova's key power link with Europe. Alternative routes are in place, but the situation remains fragile."
  - name: "Romania Insider"
    url: "https://www.romania-insider.com/romania-moldova-power-line-down-march-2026"
    region: "Europe"
    quote: "Current consumption was approximately 620 MW, of which 320 MW was domestically generated, approximately 120 MW from Transnistria"
  - name: "Interfax"
    url: "https://en.interfax.com.ua/news/general/1153952.html"
    region: "Europe"
    quote: "Cabinet of Ministers approved declaration of state of emergency in energy sector throughout Republic of Moldova for period of 60 days, starting March 25, 2026"
confidence: "confirmed"
faqs:
  - question: "Why did Moldova declare an energy emergency?"
    answer: "Russian drone strikes on Odesa, Ukraine on March 23 severed the Isaccea–Vulcănești power line — Moldova's main electricity import link with Romania. The government declared a 60-day state of emergency starting March 25 to manage the risk of rolling blackouts."
  - question: "How many people in Moldova are affected?"
    answer: "All 3.5 million Moldovans face potential rolling power outages. The country generates only about half its electricity domestically and depends on imports from Romania and Ukraine for the rest."
  - question: "Why is nobody outside Europe covering this?"
    answer: "Moldova's energy emergency scored a GAI of 6.61 — the highest invisibility score in our March 25 scan. Only European outlets reported it. 5.79 billion people across the US, Middle East, South Asia, Asia-Pacific, Latin America, and Africa have zero coverage of the story."
---

Moldova declared a 60-day energy emergency on March 25, 2026, after Russian drone strikes on Ukraine severed the country's main electricity link to Europe. The Isaccea–Vulcănești power line went offline on March 23. All 3.5 million Moldovans now face rolling blackouts. The [Albis Global Attention Index](/indexes/gai) scored this story at 6.61 — 5.79 billion people, 93% of the world, have zero coverage.
...
This isn't new. It's old vulnerability hitting a breaking point. Moldova's been trapped in an [energy crisis since 2025](/blog/hormuz-crisis-accelerating-clean-energy-transition-asia-2026), when Russian gas cutoffs to Transnistria triggered heating emergencies. Three people died from carbon monoxide poisoning. Thousands lost heat. Electricity tariffs surged 75%. The country — GDP per capita $8,161, the lowest in Europe — was already spending more on energy than it could afford.
...
Global attention is locked on the [Iran war and Hormuz blockade](/blog/iea-worst-energy-crisis-history-iran-war-markets-rally-2026). Oil prices, shipping lanes, fuel rationing — that's where every camera points. Moldova's blackout comes from a different direction: Russian strikes on Ukraine's grid, a war now in its fourth year, wrecking a neighbour that never fired a shot.

But the two crises share a root. The [IEA has called this the worst energy shock on record](/blog/iea-oil-reserve-release-400-million-barrels-how-much-left-2026). Global energy infrastructure is under attack from multiple conflicts at once. Moldova sits between them — dependent on Russian-linked gas from Transnistria, dependent on European electricity routed through a war zone, too poor to build alternatives fast enough.
