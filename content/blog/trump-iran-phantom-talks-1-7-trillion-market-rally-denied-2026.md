...
region_significance:
  ...
  asia_pacific: 4
region_frames:
  us: "Framed as diplomatic progress and relief rally"
  eu: "Framed as market volatility driven by unverified claims"
  middle_east: "Framed as US fabrication to manipulate oil markets"
  south_asia: "Framed as backchannel diplomacy through Pakistan, Turkey, Egypt"
  asia_pacific: "Framed through energy supply anxiety and IEA crisis warning"
sources:
  - name: "Fortune"
    url: "https://fortune.com/2026/03/23/trump-taco-iran-markets-rally-sp-500-crude-oil-peace-talks/"
    region: "North America"
    quote: "Trump has TACO'd again, this time in Iran, sparking a $1.7 trillion stock market rally in minutes"
  - name: "Al Jazeera"
    url: "https://www.aljazeera.com/news/2026/3/23/iran-denies-any-talks-with-us-after-trump-claims-productive-discussions"
    region: "Middle East"
    quote: "Iran says no negotiations with the US have taken place since the start of the war"
  - name: "Reuters"
    ...
    quote: "Iran's powerful parliament speaker said there had been no such talks, and ridiculed the suggestion as an attempt to rig financial markets"
  - name: "Axios"
    url: "https://www.axios.com/2026/03/23/trump-suspends-iran-strikes-hormuz-negotiations"
    region: "North America"
    quote: "Egyptian Foreign Minister had a call on Sunday with Witkoff, Araghchi and counterparts from Pakistan, Turkey and Qatar"
  - name: "NPR"
    url: "https://www.npr.org/2026/03/23/nx-s1-5757172/iran-defiant-trump-hormuz"
    region: "North America"
    quote: "There is no dialogue between Tehran and Washington"
confidence: "disputed"
---
...
If you followed Iranian state media, the story was the opposite. IRNA ran denial after denial. Ghalibaf's accusation of [market manipulation](/blog/iran-war-three-victory-claims-simultaneous-information-warfare-2026) got top billing. The framing: American lies designed to profit insiders.
...
Latin American and African outlets? Near-silence. The story that moved $1.7 trillion didn't lead a single major outlet in either region. Their populations are living with the [fuel rationing](/blog/latin-america-fuel-subsidies-oil-crisis-perception-gap-2026) and [food price spikes](/blog/hormuz-strait-food-crisis-100-million-people-oil-framing-2026) caused by this war, but the diplomatic narrative is written by and for the countries conducting it.
...
Hormuz remains closed. Ships aren't transiting. The [helium that semiconductor factories need](/blog/qatar-helium-shortage-chip-supply-crisis-2026) isn't flowing. The [cooking gas that 310 million Indian households depend on](/blog/india-cooking-gas-shortage-hormuz-lpg-crisis-2026) is rationed. Laos shortened its school week to three days because it can't afford fuel for buses.
...
This story scores a [PGI](/indexes/pgi) of 9 — among the highest we've recorded. The same event, on the same day, was framed as diplomatic breakthrough (US), market manipulation (Iran), backchannel progress (South Asia), and didn't register at all in the regions most affected by the war's economic fallout.
