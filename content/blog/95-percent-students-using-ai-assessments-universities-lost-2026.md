...
sources:
  - name: "HEPI"
    ...
    region: "Europe"
    quote: "AI use is now almost universal. Some 95% of students report using AI in at least one way."
  - name: "BritBrief"
    url: "https://britbrief.co.uk/politics/devolution/ai-use-in-university-assessments-hits-95-among-students.html"
    region: "Europe"
    quote: "One respondent candidly stated, 'It is making us all lazy.' Another lamented, 'I'm not using my brain at all.'"
  - name: "Pew Research Center"
    url: "https://www.pewresearch.org/internet/2026/02/24/how-teens-use-and-view-ai/"
    region: "North America"
    quote: "Many teens think cheating with AI has become a regular feature of student life."
  - name: "District Administration"
    url: "https://districtadministration.com/article/8-ways-students-are-using-ai-in-2026/"
    region: "North America"
    quote: "34% of teens cheat 'extremely' or 'very often,' and another 25% cheat 'somewhat often.'"
  - name: "Phys.org"
    url: "https://phys.org/news/2026-02-greatest-ai-higher-isnt-erosion.html"
    region: "International"
    quote: "The greatest risk of AI in higher education isn't cheating — it's the erosion of learning itself."
faqs:
  - q: "What percentage of university students use AI for assignments in 2026?"
    a: "A major HEPI survey of 1,054 UK undergraduates found 95% use AI in at least one way for their studies, with 94% using it specifically for assessed work. The proportion submitting AI-generated text directly rose from 3% in 2024 to 12% in 2026."
  - q: "Are universities banning AI or encouraging it?"
    a: "Most universities are stuck in between. Only 37% of UK students say their institution encourages AI use, while 36% say it doesn't. Leading institutions are moving toward AI literacy programs rather than bans, which are considered unenforceable."
  - q: "Is AI making students less capable?"
    a: "Students themselves think so. In the HEPI survey, respondents said AI is 'making us all lazy' and 'I'm not using my brain at all.' Meanwhile, a Pew Research study found 34% of US teens admit to cheating with AI 'extremely' or 'very often.'"
---
...
That's the headline from the [Student Generative AI Survey 2026](https://www.hepi.ac.uk/reports/student-generative-ai-survey-2026/), published this week by the Higher Education Policy Institute (HEPI). It surveyed 1,054 full-time UK undergrads and paints a system that's lost control of one of the biggest changes in how humans learn.
...
These aren't critics of [AI in education](/topics/ai). They're the users.
...
A [February analysis in Phys.org](https://phys.org/news/2026-02-greatest-ai-higher-isnt-erosion.html) argued that the entire cheating debate misses the point. The real danger isn't students faking assignments. It's the quiet erosion of the cognitive skills those assignments were supposed to build.
...
The HEPI survey backs this up. Nearly half of students (49%) say AI has improved their experience — mostly by saving time and providing instant answers. But 16% say it's made things worse, citing skill erosion, unfairness, and [social isolation](/topics/health).
...
Some universities are adapting. The UK government's [AI Opportunities Action Plan](https://www.gov.uk/government/publications/ai-opportunities-action-plan/ai-opportunities-action-plan) positions Britain as a global leader in AI adoption. HEPI recommends universities provide AI induction sessions for all incoming students, specialized training for staff, and clear published guidance on ethical use.
...
The enrollment cliff is already hitting universities in 2026. Declining birth rates from the Great Recession era mean [fewer students showing up](/perspectives/united-kingdom) this fall. At the same time, public confidence in higher education is dropping. Deloitte's 2026 higher education outlook warns that policymakers are questioning the sector's entire business model.
