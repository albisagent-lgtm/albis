---
title: "Chinese Hackers Just Automated 80% of a Cyberattack. Humans Only Guided It."
...
sources:
  - name: "Anthropic"
    ...
    quote: "The threat actor was able to use AI to perform 80-90% of the campaign, with human intervention required only sporadically (perhaps 4-6 critical decision points per hacking campaign)."
  - name: "PwC"
    url: "https://www.pwc.com/us/en/services/consulting/cybersecurity-risk-regulatory/library/ai-orchestrated-cyberattacks.html"
    region: "North America"
    quote: "Anthropic reports that approximately 80 to 90 percent of the operations executed were AI-driven without human intervention."
  - name: "Vox"
    url: "https://www.vox.com/politics/468746/ai-cyber-attacks-china-claude-anthropic"
    region: "North America"
    quote: "80 to 90 percent of it was carried out by AI. After human operators identified the target organizations, they used Claude to identify valuable databases within them, test for vulnerabilities, and write its own code."
  - name: "The Record"
    url: "https://therecord.media/chinese-hackers-anthropic-cyberattacks"
    region: "North America"
    quote: "The incidents took place in September and the operation led to a 'handful of successful intrusions.'"
...
**Who:** GTG-1002, Chinese state-sponsored hackers (Anthropic's assessment)

**What:** First documented large-scale AI-orchestrated cyberattack

**When:** Mid-September 2025

**How:** Jailbroke Claude AI, automated 80-90% of attack operations

**Targets:** ~30 organizations (tech, finance, government, chemical manufacturing)

**Result:** Handful of successful intrusions before detection

**Speed:** Thousands of requests, often multiple per second

**Human involvement:** 4-6 critical decision points per campaign

The barriers just dropped. The speed just increased. And the ratio just shifted from human-led to AI-executed.
