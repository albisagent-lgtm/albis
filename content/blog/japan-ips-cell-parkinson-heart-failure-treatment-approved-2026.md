---
title: "Japan Approves First Treatments From Reprogrammed Cells"
...
faqs:
  - q: "What are iPS cell treatments and how do they work?"
    a: "Induced pluripotent stem cells (iPS cells) are adult cells — like skin or blood — reprogrammed back into a stem cell state that can become any cell type. Japan's new treatments use donor iPS cells to grow dopamine-producing neurons for Parkinson's patients and heart muscle sheets for heart failure patients. The cells are then surgically implanted."
  - q: "Are the Japan iPS cell therapies available outside Japan?"
    a: "Not yet. Both Amchepry (Parkinson's) and ReHeart (heart failure) have conditional approval only in Japan. A Phase 1/2 trial for Amchepry is running at UC San Diego, expected to finish in 2028. Commercial availability outside Japan is likely years away."
  - q: "How were iPS cells discovered?"
    a: "Shinya Yamanaka at Kyoto University discovered in 2006 that four specific proteins could reprogram adult mouse cells back to an embryonic-like state. He won the Nobel Prize in 2012. Japan's new approvals come exactly 20 years after that original discovery in mice."
sources:
  - name: "WIRED"
    url: "https://www.wired.com/story/japan-approves-the-worlds-first-treatment-made-with-reprogrammed-human-cells/"
    region: "North America"
    quote: "These will be the world's first practical application of iPS cell-derived products"
  - name: "Nature"
    url: "https://www.nature.com/articles/d41586-026-00585-x"
    region: "International"
    quote: "Some researchers say that the therapies are not yet ready for prime time"
  - name: "Parkinson's News Today"
    url: "https://parkinsonsnewstoday.com/news/japan-grants-conditional-approval-amchepry-parkinsons/"
    region: "North America"
    quote: "Brain imaging showed a 44.7% increase in dopamine levels in the striatum"
  - name: "NHK World"
    url: "https://www3.nhk.or.jp/nhkworld/en/news/20260306_17/"
    region: "Asia-Pacific"
    quote: "Japan's health ministry has announced formal approval for the domestic manufacture and sale of two products"
  - name: "Science (AAAS)"
    url: "https://www.science.org/content/article/stem-cell-therapies-come-age-two-conditional-approvals-japan"
    region: "North America"
    quote: "Surgeons drilled holes into the skulls of six Parkinson's patients and injected the replacement cells"
...
The therapy is now also being tested at UC San Diego in a [Phase 1/2 trial](https://www.albis.news/blog/epigenetic-reprogramming-therapy-human-trials-aging-reversal-2026) of seven American patients, expected to wrap up in 2028.
