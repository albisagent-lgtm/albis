...
faqs:
  - q: "Is AllSides really unbiased?"
    a: "AllSides doesn't claim to be unbiased — it explicitly states no news source is. Instead, it shows you bias labels (left, center, right) so you can read across the spectrum. The ratings come from blind surveys and editorial reviews, not algorithms."
  - q: "What's the difference between political bias and regional framing?"
    a: "Political bias is left vs right ideology. Regional framing is what stories different countries prioritize and how they present them. A story can be politically neutral but still framed differently in New York vs New Delhi based on regional interests."
  - q: "Can I use both AllSides and Albis together?"
    a: "Yes. AllSides shows you US political spectrum coverage. Albis shows you global regional differences. One maps ideology, the other maps geography. Using both gives you a fuller picture."
  - q: "Which is better for escaping echo chambers?"
    a: "It depends on your echo chamber. If you're stuck in a US left or right bubble, AllSides helps. If you only read Western sources and miss non-Western perspectives, Albis helps. Most people need both."
  - q: "Does AllSides work outside the US?"
    a: "AllSides primarily rates US news outlets and focuses on American political spectrum bias. It's less useful if you want perspectives from Europe, Asia, Latin America, or Africa."
---
...
The [Perception Gap Index](/indexes/pgi) quantifies this. A high PGI means a story is being told completely differently depending on where you are. Western outlets might bury a story that dominates Asian headlines. African media might frame an event as economic while European outlets frame it as humanitarian.
