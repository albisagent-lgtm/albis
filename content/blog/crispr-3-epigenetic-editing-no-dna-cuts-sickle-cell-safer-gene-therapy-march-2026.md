---
title: "CRISPR 3.0 Doesn't Cut Your DNA. That Changes Everything."
...
sources:
  - name: "ScienceDaily"
    ...
    quote: "Whenever you cut DNA, there's a risk of cancer. And if you're doing a gene therapy for a lifelong disease, that's a bad kind of risk."
  - name: "UNSW Sydney"
    url: "https://www.unsw.edu.au/newsroom/news/2025/08/new-CRISPR-technique-could-rewrite-future-genetic-disease-treatment"
    region: "Asia-Pacific"
    quote: "Therapies based on this technology are likely to have a reduced risk of unintended negative effects compared to first or second generation CRISPR."
  - name: "Drug Target Review"
    url: "https://www.drugtargetreview.com/news/183354/new-crispr-breakthrough-could-transform-sickle-cell-treatment/"
    region: "Europe"
    quote: "Turning certain genes on or off by altering methyl groups avoids having to cut DNA strands."
  - name: "Reuters"
    url: "https://www.reuters.com/business/healthcare-pharmaceuticals/vertexcrispr-price-sickle-cell-disease-gene-therapy-22-mln-2023-12-08/"
    region: "International"
    quote: "Vertex Pharmaceuticals and its partner CRISPR Therapeutics said their sickle cell disease gene therapy Casgevy would be available at a list price of $2.2 million."
  - name: "The Lancet Haematology / Global Burden of Disease Study"
    url: "https://pubmed.ncbi.nlm.nih.gov/37331373/"
    region: "International"
    quote: "The number of people living with sickle cell disease globally increased by 41.4%, from 5.46 million in 2000 to 7.74 million in 2021."
confidence: "confirmed"
faqs:
  - q: "What is epigenetic editing and how is it different from regular CRISPR?"
    a: "Regular CRISPR cuts DNA strands to disable or replace genes, which carries a risk of unintended mutations and cancer. Epigenetic editing removes chemical tags (methyl groups) that silence genes, switching them back on without cutting or altering the DNA sequence itself. It's like removing a mute button rather than rewiring the speaker."
  - q: "Can epigenetic editing cure sickle cell disease?"
    a: "Researchers at UNSW Sydney believe it could treat sickle cell by reactivating the fetal globin gene, which helps deliver oxygen before birth but gets silenced afterward. Reactivating it could bypass the defective adult gene that causes sickle cell. The technique has worked in human cells in the lab but hasn't been tested in animals or humans yet."
  - q: "How much does current CRISPR gene therapy for sickle cell cost?"
    a: "Casgevy, the first FDA-approved CRISPR therapy for sickle cell disease, costs $2.2 million per patient. A competing therapy, Lyfgenia, costs $3.1 million. These prices put treatment out of reach for most of the 7.74 million people living with sickle cell worldwide, the vast majority in sub-Saharan Africa."
---
