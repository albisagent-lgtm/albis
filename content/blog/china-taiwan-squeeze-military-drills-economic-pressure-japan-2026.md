...
faqs:
  - q: "What's a blockade, and how's it different from an invasion?"
    a: "An invasion sends troops to occupy territory. A blockade cuts off food, energy, and supplies until the target surrenders without a shot fired. China's rehearsing the latter — not tanks crossing beaches, but ships stopping cargo."
  - q: "Why is 2027 important?"
    a: "It's the 100th anniversary of the PLA's founding. Xi directed the military to complete readiness for major operations by then. Not an invasion deadline, but the date when China wants the capability ready if needed."
  - q: "Could Taiwan survive a blockade?"
    a: "Taiwan imports 70% of its food and 100% of its energy. It's got 6-10 months of food stockpiles and enough fuel for a few months. A full blockade would strangle the island slowly. The clock starts ticking the moment ships stop arriving."
  - q: "Why does South Korea's neutrality matter?"
    a: "Seoul's caught between its biggest trade partner (China) and its security ally (US/Japan). If South Korea picks a side, it reshapes the entire regional balance. Right now, it's trying to court both — but experts say that won't last."
sources:
  - name: "Reuters"
    url: "https://www.reuters.com/world/asia-pacific/china-bans-exports-dual-use-items-military-purposes-japan-2026-01-06/"
    region: "International"
    quote: "China has banned exports of dual-use items to Japan that can be used for military purposes"
  - name: "CSIS ChinaPower"
    url: "https://features.csis.org/chinapower/china-blockade-taiwan/"
    region: "North America"
    quote: "Taiwan has less than [several] months of food stockpiles. In the most likely blockade scenarios, these stockpiles would be subject to Chinese bombardment"
  - name: "Everstream Analytics"
    url: "https://www.everstream.ai/risk-centers/china-taiwan-relations-potential-risk-scenarios/"
    region: "North America"
    quote: "Without access to energy imports, total electricity production could potentially be reduced by 80%, ceasing all manufacturing activities"
  - name: "Time Magazine"
    url: "https://time.com/7345772/china-japan-south-korea-relations-export-controls-taiwan/"
    region: "North America"
    quote: "Beijing needs to stabilize and improve its relations with Seoul in the hope that the latter can maintain a more neutral position in the U.S.-China strategic rivalry"
  - name: "BBC"
    url: "https://www.bbc.com/news/articles/c87l7xjp235o"
    region: "Europe"
    quote: "China is holding military drills around Taiwan simulating the seizure and blockade of the island's key areas"
...
**Path 1: China backs off.** Drills stay drills. Sanctions stay limited. Everyone goes home. Possible but unlikely — Xi's got political reasons to push.

**Path 2: Gray-zone squeeze.** Not a full blockade, but increasing pressure. More drills. More sanctions. More disruption. Slowly testing how far China can push without triggering war. This is where we are now.

**Path 3: Full blockade.** Ships stop. Planes turn around. Taiwan's isolated. This one ends in either Taiwan surrendering or the US deciding whether to fight.

Right now, we're on Path 2. The squeeze is slow. The pressure's building. Nobody's calling it a blockade yet — but Taiwan's watching the ships circle and doing the math on its food reserves.
