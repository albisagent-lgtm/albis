---
title: "Japan Drains 80M Barrels of Oil — Why No One Noticed"
...
regions_absent: [us, eu, south_asia, latam, africa]
region_significance:
  asia_pacific: 5
  middle_east: 2
region_frames:
  asia_pacific: "Front-page domestic emergency with operational detail on refiners, reserves, and subsidy caps"
  middle_east: "Background data point in broader oil market coverage"
sources:
  - "The Guardian — Japan to begin biggest-ever oil release from national reserves (March 24, 2026)"
  - "Reuters — Japan to tap joint oil stockpiles, PM says (March 24, 2026)"
  - "The Japan Times — Japan begins its largest-ever oil release from strategic reserves (March 16, 2026)"
  - "CSIS — What Are the Implications of the Iran Conflict for Japan? (March 23, 2026)"
  - "Reuters — Japan's Middle East energy dependency and how it mitigates shocks (March 4, 2026)"
confidence: "confirmed"
faqs:
  - q: "How much oil is Japan releasing from reserves?"
    a: "80 million barrels — equivalent to 45 days of domestic demand. This is 1.8 times larger than the release after the 2011 Fukushima disaster."
  - q: "Why is Japan so vulnerable to the Hormuz crisis?"
    a: "Japan imports 95% of its crude oil from the Middle East, with roughly 74% of those imports transiting the Strait of Hormuz. It's more exposed than any other major economy."
  - q: "How long can Japan's oil reserves last?"
    a: "Japan held about 470 million barrels at end of 2025, equivalent to 254 days of consumption. But at the current rate of release, that buffer is shrinking fast."
---
...
The numbers explain the urgency. According to Japan's Ministry of Economy, Trade and Industry, [95.1% of Japan's crude oil imports come from the Middle East](/blog/hormuz-blockade-global-systems-stress-test-who-benefits-chaos). Roughly 74% of that oil transits the Strait of Hormuz — the same waterway Iran has kept effectively closed since late February.
...
The knock-on effects run deeper than fuel. The yen has weakened to a 20-month low. Foreign investors have dumped Japanese stocks at the highest rate in five months. Real wage gains achieved earlier in 2026 are evaporating as [fuel and food costs climb](/blog/fertilizer-crisis-hormuz-blockade-spring-planting-2026).
