...
regions_absent: [middle_east, asia_pacific, africa, latam]
region_significance:
  us: 4
  eu: 3
  south_asia: 5
region_frames:
  us: "Consumer drug prices may rise in 4-6 weeks — framed as supply chain risk"
  south_asia: "Existential pharmaceutical manufacturing crisis — raw material costs surging 25-106%"
  eu: "Humanitarian supply route disruption threatening aid delivery"
sources:
  - name: "CNBC"
    url: "https://www.cnbc.com/2026/03/16/strait-of-hormuz-closure-generic-drug-prescriptions.html"
    region: "North America"
    quote: "Nearly half of U.S. generic prescriptions originate in India, which relies on the Strait of Hormuz for the arrival of key inputs in drug manufacturing."
  - name: "Reuters"
    url: "https://www.reuters.com/business/healthcare-pharmaceuticals/sudan-clinics-face-stock-out-weeks-due-middle-east-war-ngo-says-2026-03-17/"
    region: "International"
    quote: "Medical supplies to clinics dealing with the humanitarian crisis in Sudan could run out within two weeks unless shipments are rapidly rerouted."
  - name: "IRC"
    url: "https://www.rescue.org/press-release/closure-strait-hormuz-and-regional-airspace-closures"
    region: "International"
    quote: "Approximately $130,000 worth of essential pharmaceutical supplies intended for IRC's humanitarian response in Sudan are currently stranded in Dubai."
  - name: "Health Policy Watch"
    url: "https://healthpolicy-watch.news/attacks-on-healthcare-escalating-crisis/"
    region: "Europe"
    quote: "There were 2,723 recorded conflict-related attacks on medical facilities, transport, and personnel in 2025."
  - name: "OpenPR / India Pharma"
    url: "https://www.openpr.com/news/4424503/indian-pharmaceutical-industry-faces-perfect-storm-glp-1"
    region: "South Asia"
    quote: "Paracetamol raw material costs up 26%, glycerin up 64%, amoxicillin trihydrate up 45% since December 2025."
confidence: "confirmed"
faqs:
  - q: "Will there be a medicine shortage in the US from the Hormuz crisis?"
    a: "US pharmacies and wholesalers currently hold 30-60 days of generic drug inventory. If Hormuz stays closed, shortages could appear within 4-6 weeks — starting with high-volume generics like diabetes medications, statins, and antibiotics. Nearly half of US generic prescriptions originate in India, which depends on Hormuz for petroleum-based drug ingredients."
  - q: "How does the Strait of Hormuz affect medicine supply chains?"
    a: "India manufactures 60% of the world's generic drugs using petroleum-derived chemicals. 40% of India's crude oil imports transit Hormuz. Chemical inputs from China also route through Gulf logistics hubs like Dubai before reaching Indian factories. When the strait closes, the entire pharmaceutical pipeline — from raw materials to finished pills — gets disrupted."
  - q: "Which countries are most affected by Hormuz drug supply shortages?"
    a: "Sudan's clinics face stock-outs within days. Gulf states are reporting hospital inventory strain. India's pharmaceutical raw material costs have surged 25-106% since December. The IRC reports essential pharma supplies stranded in Dubai. Countries relying on Indian-made generics — including much of Africa, Southeast Asia, and the US — face downstream disruption."
---
...
One detail captures the absurdity. The IRC has $130,000 worth of essential pharmaceutical supplies for Sudan — one of the world's worst humanitarian crises, where a hospital was [drone-struck last week](/blog/sudan-hospital-drone-strike-64-killed-darfur-2026) killing 64 people — sitting in a Dubai warehouse. The drugs exist. The people who need them are dying. The route between the two is closed.
...
The question isn't whether the [Hormuz crisis](/topics/hormuz) will affect global health. It already has. The question is how many empty shelves it takes before anyone notices.
