...
region_significance:
  us: 5
region_frames:
  us: "Framed as public health crisis with political undertones around vaccine policy"
sources:
  - name: "CIDRAP"
    url: "https://www.cidrap.umn.edu/measles/us-measles-outbreak-approaches-1500-cases"
    region: "North America"
    quote: "The United States will likely lose its measles elimination status — which it gained in 2000 — in November, when officials assess the data."
  - name: "The Guardian"
    url: "https://www.theguardian.com/us-news/2026/mar/02/measles-south-carolina-rfk-jr-vaccine-laws"
    region: "Europe"
    quote: "Groups with ties to the US health secretary are pushing to eliminate immunization requirements that protect children."
  - name: "Reuters"
    url: "https://www.reuters.com/world/us-judge-blocks-efforts-reshape-childhood-vaccine-policy-2026-03-16/"
    region: "International"
    quote: "The ruling dealt a significant setback for the reduced childhood vaccination schedule championed by Kennedy."
  - name: "CDC"
    url: "https://www.cdc.gov/measles/data-research/index.html"
    region: "North America"
    quote: "94% of confirmed cases are outbreak-associated. 92% of case-patients are unvaccinated or have an unknown vaccine status."
  - name: "UN News"
    url: "https://news.un.org/en/story/2026/02/1166940"
    region: "International"
    quote: "Measles cases across Europe and Central Asia declined by 75 per cent in 2025 compared to 2024."
confidence: "confirmed"
faqs:
  - question: "How many measles cases are in the US in 2026?"
    answer: "The CDC confirmed 1,487 measles cases as of March 19, 2026, across 31 states and New York City. This is on track to surpass the 2,285 cases reported for all of 2025 — which was already a 35-year high."
  - question: "Why is measles coming back in the United States?"
    answer: "Childhood MMR vaccination rates dropped from 95.2% in 2019-2020 to 92.5% in 2024-2025, falling below the 95% threshold needed for herd immunity. In January 2026, HHS cut recommended childhood vaccinations from 17 to 11 — a move a federal judge blocked on March 16 as 'arbitrary and capricious.'"
  - question: "Will the US lose its measles elimination status?"
    answer: "PAHO will review the US measles elimination status in November 2026. The US has held elimination status since 2000. With sustained community transmission across multiple states, public health experts say losing that status is likely."
---
...
The Albis [Global Attention Index](/indexes/gai) scored this story at **6.64** — deep in the "Information Shadow" tier. Only one of seven world regions covers America's measles crisis: America itself. That's 5.87 billion people with no idea the country that declared measles eliminated in 2000 is on track to lose that status.
...
The [Perception Gap Index](/indexes/pgi) scores this story at just 3.3 on framing distortion — unusually low. There's no real disagreement about the facts. The problem isn't how the story's told. It's that 94% of the world isn't being told at all.
