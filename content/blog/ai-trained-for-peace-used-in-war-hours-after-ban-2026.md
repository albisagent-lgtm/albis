...
**Path 1:** The Anthropic model dies. Companies that refuse military contracts get sidelined. OpenAI, Microsoft, Google partner with the Pentagon. Safeguards become negotiable, not fixed.

**Path 2:** Congress steps in. Legislation mandates review periods before civilian AI can be repurposed for combat. The DoD hates it, but policy catches up to deployment speed.

**Path 3:** Nothing changes. AI gets faster, wars get faster, the gap between "should we?" and "we did" disappears entirely.

Right now, we're on Path 3.
