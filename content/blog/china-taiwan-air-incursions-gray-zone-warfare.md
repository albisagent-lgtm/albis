...
faqs:
  - q: "How many Chinese military aircraft entered Taiwan's airspace in 2025?"
    a: "Over 5,700 PLA aircraft entered Taiwan's Air Defense Identification Zone in 2025, up from 380 in 2020—a 1,400% increase. In just the first nine months of 2025, Taiwan logged over 4,000 incursions."
  - q: "Why did Taiwan stop scrambling jets to intercept Chinese aircraft?"
    a: "In March 2021, Taiwan stopped scrambling jets for every incursion because it was exhausting resources. Around 9% of Taiwan's defense budget in 2020 went to responding to Chinese sorties. Now they track using ground-based missiles instead."
  - q: "What is gray zone warfare?"
    a: "Gray zone warfare uses non-military coercive actions that stay below the threshold of war—like air incursions, naval drills, or cyber operations—to exhaust an opponent and normalize aggression without triggering armed conflict."
sources:
  - name: "TaiwanPlus"
    url: "https://www.taiwanplus.com/news/taiwan-news/military/251021002/why-does-china-intrude-into-taiwans-air-defense-identification-zone"
    region: "Asia-Pacific"
    quote: "Taiwan has logged more than 4,000 Chinese military aircraft entering its ADIZ in the first 9 months of 2025—hundreds more than during the same period last year."
  - name: "BBC News"
    url: "https://www.bbc.com/news/world-asia-66851118"
    region: "International"
    quote: "This normalisation may one day serve to mask the first moves of a real attack, making it difficult for Taiwan and the United States to prepare accordingly."
  - name: "Foreign Policy Research Institute"
    ...
    quote: "In March 2021, the MND decided that the air force would not scramble aircraft to intercept every single PLA sortie, but instead, it would track those aircraft using ground-based missiles."
  - name: "American Enterprise Institute"
    url: "https://www.aei.org/articles/china-taiwan-update-december-5-2025/"
    region: "North America"
    quote: "The normalization of more frequent ADIZ incursions by PLA aircraft raises the threshold of coercive activity that would trigger a Taiwanese response, making it more difficult for Taiwan to detect and respond to a real threat in time."
  - name: "Wikipedia - Chinese Salami Slicing Strategy"
    url: "https://en.wikipedia.org/wiki/Chinese_salami_slicing_strategy"
    region: "International"
    quote: "It took control of the Paracel Islands in 1974, Johnson Reef in 1988, Mischief Reef in 1995, and Scarborough Shoal in 2012."
...
The Albis Perception Gap Index scored this story 5.35, with [Asia-Pacific](/perspectives/taiwan) outlets framing Chinese incursions as intimidation and sovereignty threats, while [US outlets](/perspectives/united-states) framed them as aggression requiring allied support. China, when covering the story, frames the flights as internal affairs—policing its own territory.
...
Taiwan's defense minister warned last week against interpreting recent reductions in Chinese flights as a retreat. Some analysts think Beijing is conserving fuel as oil prices surge due to the [Iran war](/topics/iran). Others think it's posturing ahead of a Trump-Xi summit.
...
The same strategy is playing out in [Taiwan's airspace](/topics/china). Incremental. Relentless. Designed to avoid triggering a red line while steadily moving the goalposts.
