...
faqs:
  - q: "How does lecanemab actually work to treat Alzheimer's?"
    a: "Lecanemab clears amyloid plaques by activating the brain's immune cells (microglia) through a specific part of the antibody called the Fc fragment. This fragment acts as an anchor that microglia latch onto near plaques, prompting them to clear the toxic deposits. Without an intact Fc fragment, the drug has no effect."
  - q: "What are the side effects of lecanemab?"
    a: "About 1 in 5 patients develops amyloid-related imaging abnormalities (ARIA) — brain bleeding or swelling. Most cases are mild and symptom-free, but in rare instances ARIA can cause seizures, severe bleeds, or accelerated cognitive decline. This risk is why understanding the mechanism matters for designing safer alternatives."
  - q: "Will this discovery lead to a better Alzheimer's treatment?"
    a: "Potentially yes. Now that researchers know the Fc fragment drives microglia to clear plaques, they can engineer future antibodies that optimize this effect while minimizing the immune reactions that cause ARIA. Researchers are already exploring bispecific antibodies that target both amyloid and tau simultaneously."
sources:
  - name: "ScienceDaily / VIB-KU Leuven"
    url: "https://www.sciencedaily.com/releases/2026/03/260317064457.htm"
    region: "International"
    quote: "The Fc fragment works as an anchor that microglia latch onto when they are near plaques, as a consequence of which these cells are reprogrammed to clear plaques more efficiently."
  - name: "Nature Neuroscience"
    url: "https://www.nature.com/articles/s41593-025-02125-8"
    region: "International"
    quote: "Lecanemab mediates amyloid clearance by activating microglial effector functions; effective amyloid removal depends on the engagement of microglia through the Fc fragment."
  - name: "UCSF Memory and Aging Center"
    url: "https://memory.ucsf.edu/lecanemab"
    region: "North America"
    quote: "About 2 in 10 people who receive lecanemab develop brain changes called amyloid-related imaging abnormalities (ARIA), which involve brain bleeding, brain swelling, or a combination of the two."
  - name: "KFF Health News"
    url: "https://kffhealthnews.org/news/article/the-real-costs-of-the-new-alzheimers-drug-most-of-which-will-fall-to-taxpayers/"
    region: "North America"
    quote: "Medicare and Medicaid patients will make up 92% of the market for lecanemab, according to Eisai Co., which sells the drug under the brand name Leqembi."
  - name: "Alzheimer's Disease International"
    url: "https://www.alzint.org/about/dementia-facts-figures/dementia-statistics/"
    region: "International"
    quote: "In India, one study suggests 90% of dementia cases remain undiagnosed. In high income countries, only 20-50% of dementia cases are recognised and documented in primary care."
...
*Related: What the [global health equity gap](/topics/health) means for access to Alzheimer's treatments — and how the [information divide](/indexes/gai) shapes who even knows these drugs exist.*
