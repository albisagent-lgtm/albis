...
region_significance:
  ...
  eu: 2
region_frames:
  ap: "Existential energy crisis threatening daily life, schools, and transport"
  us: "Abstract supply chain disruption from Hormuz closure"
  eu: "Market data point about Asian fuel tightening"
sources:
  - name: "Reuters"
    url: "https://www.reuters.com/business/energy/chinas-fuel-export-ban-further-tighten-asia-supply-2026-03-17/"
    region: "International"
    quote: "China's ban on exports of diesel, gasoline and jet fuel is poised to exacerbate fuel shortages and further boost prices for Asian industry and transportation buyers"
  - name: "Laotian Times"
    url: "https://laotiantimes.com/2026/03/20/laos-cuts-school-week-to-three-days-amid-fuel-shortage/"
    region: "Asia-Pacific"
    quote: "Preschools and all other centres of education, both public and private, are instructed to reduce the number of school days from the usual five to three days a week"
  - name: "Bloomberg"
    url: "https://www.bloomberg.com/news/articles/2026-03-23/myanmar-to-step-up-vehicle-fuel-rationing-as-shortages-grow"
    region: "International"
    quote: "Customers will be allowed to buy fuel once or twice a week depending on the size of their vehicle engines"
  - name: "Malay Mail"
    url: "https://www.malaymail.com/news/money/2026/03/20/vietnam-petrol-prices-surge-over-20pc-after-middle-east-war-triggers-fuel-fears/213313"
    region: "Asia-Pacific"
    quote: "The cost of petrol was up by more than 20 per cent in Vietnam today after the government announced an overnight hike"
  - name: "Rappler"
    url: "https://www.rappler.com/philippines/gulf-crisis-impact-disruptions-global-oil-supply/"
    region: "Asia-Pacific"
    quote: "President Marcos warned that the Philippines' oil reserve is sufficient for only 50 to 60 days"
confidence: "confirmed"
---

Children in Laos went to school five days a week until March 19. Now they go three. The government cut two days because fuel got too expensive to run school buses.

The war driving this decision is 7,000 kilometres away.
...
Over 2,000 fuel stations and depots across Cambodia shut down in early March — unable to afford or source fuel at the new global prices. By March 13, around 400 remained closed, waiting for deliveries that kept getting delayed. Cambodia turned to Singapore and Malaysia after its traditional suppliers — Vietnam and China — both restricted exports.

Laos, Cambodia, and Myanmar share a vulnerability that rarely makes headlines: they have little to no domestic refining capacity. They depend entirely on neighbours who are now hoarding their own supply.
...
The Albis Perception Gap Index scored the [Southeast Asia fuel rationing story](/blog/southeast-asia-four-day-work-week-oil-crisis-invisible) at 5.0, with coverage almost entirely absent from US, European, Middle Eastern, Latin American, and African media. Chinese domestic media covers its own export ban as prudent self-protection. In the countries absorbing the impact, it looks different.

Here's the chain: Hormuz closes → crude supply drops → China bans fuel exports to protect itself → Southeast Asian nations lose their swing supplier → Myanmar rations by license plate → Laos cuts school to three days → Vietnam hikes fuel 20% overnight → Cambodia's gas stations shut down → the Philippines starts counting days.
