---
title: "The Battery Revolution Happened While Nobody Was Watching"
...
sources:
  - name: "TechCrunch"
    ...
    quote: "Google paid startup Form Energy $1B for its massive 100-hour battery. It works by breathing, in a sense — oxygen pumped into the cells rusts iron, which releases electrons."
  - name: "BloombergNEF"
    url: "https://about.bnef.com/insights/clean-transport/new-record-lows-for-battery-prices/"
    region: "International"
    quote: "The average pack price for stationary storage systems dropped to $70/kWh, 45% lower than in 2024. This is the sharpest drop across all segments."
  - name: "Form Energy"
    url: "https://formenergy.com/technology/battery-technology/"
    region: "North America"
    quote: "Our first commercial product is an iron-air battery system that can cost-effectively store and discharge energy for up to 100 hours."
  - name: "MIT Technology Review"
    url: "https://www.technologyreview.com/2024/10/01/1104382/2024-climate-tech-companies-form-energy-iron-batteries/"
    region: "North America"
    quote: "Form has demonstrated that iron-air batteries can be built at one-tenth the cost of lithium-ion batteries, largely because the primary materials used to make them are cheap and abundant."
confidence: "confirmed"
faqs:
  - q: "Why does 100 hours matter when most lithium-ion batteries only last 4-8 hours?"
    a: "It's the difference between storing energy for a few hours versus multiple days. With 100-hour storage, solar and wind can power the grid even during multi-day storms or windless periods. It transforms renewables from 'works when weather cooperates' to 'works all week.'"
  - q: "How cheap is iron-air compared to lithium-ion batteries?"
    a: "Form Energy claims one-tenth the cost of lithium-ion batteries. BloombergNEF reports stationary battery storage costs fell to $70/kWh in 2025 — a 45% drop from 2024. Iron is one of Earth's most abundant materials, unlike lithium and cobalt."
  - q: "Can this actually replace fossil fuel power plants?"
    a: "For multi-day reliability, yes. The Google-Xcel deal pairs 1.4 GW wind + 200 MW solar with 300 MW / 30 GWh iron-air storage. That's enough to run a data center 24/7 on renewables, even when the wind doesn't blow for days. The tech now exists. The question is scaling fast enough."
---
