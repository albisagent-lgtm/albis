...
sources:
  - name: "Reuters"
    ...
    quote: "Other foreign but open AI tools, such as China's Qwen or DeepSeek, could however be safely adapted and rolled out in a closed environment on the proprietary infrastructure of Russian government organisations and companies."
  - name: "United24 Media (Ukraine)"
    url: "https://united24media.com/latest-news/russia-proposes-restrictions-on-foreign-ai-models-like-chatgpt-and-gemini-to-uphold-traditional-values-17096"
    region: "Eastern Europe"
    quote: "The proposed regulations are expected to benefit domestic AI tools developed by Russian entities such as state lender Sberbank and technology group Yandex."
  - name: "CNN"
    url: "https://www.cnn.com/2026/02/12/tech/russia-whatsapp-social-media-clampdown-intl"
    region: "North America"
    quote: "Russia has confirmed that it has blocked instant messaging app WhatsApp, instead directing Russian citizens to use its state-backed Max app."
  - name: "Euronews / Microsoft Report"
    url: "https://www.euronews.com/next/2026/01/09/deepseeks-ai-gains-traction-in-developing-nations-microsoft-report-says"
    region: "Europe"
    quote: "A recent report from Microsoft found that DeepSeek's market share was an estimated 43 percent in Russia."
  - name: "BBC"
    url: "https://www.bbc.com/news/articles/clygd10pg5lo"
    region: "International"
    quote: "Trying to isolate over 100 million Russian WhatsApp users."
---
