...
regions_absent: ["africa", "latam", "asia_pacific"]
region_significance: {"us": 3, "eu": 3, "middle_east": 5, "south_asia": 4}
region_frames: {"us": "Framed as infrastructure collateral damage in military operations", "eu": "Framed as humanitarian risk requiring diplomatic attention", "middle_east": "Framed as existential civilizational threat to Gulf populations", "south_asia": "Framed through lens of shared water vulnerability"}
sources:
  - name: "Atlantic Council"
    url: "https://www.atlanticcouncil.org/dispatches/attacks-on-desalination-plants-in-the-iran-war-forecast-a-dark-future/"
  - name: "CSIS"
    url: "https://www.csis.org/analysis/could-iran-disrupt-gulf-countries-desalinated-water-supplies"
  - name: "The Guardian"
    url: "https://www.theguardian.com/world/2026/mar/11/severe-water-stress-why-desalination-plants-are-gulf-greatest-weakness"
  - name: "AP News"
...
faqs:
  - q: "How much of the Gulf's drinking water comes from desalination?"
    a: "Qatar gets 99% from desalination, Kuwait and Bahrain around 90%, Oman 86%, Saudi Arabia 70%, and the UAE 42%. Without these plants, roughly 100 million people would lose regular access to drinking water."
  - q: "Have desalination plants been attacked in the Iran war?"
    a: "Yes. On March 7, a desalination plant on Iran's Qeshm Island was struck, cutting water to 30 villages. On March 8, an Iranian drone damaged a Bahraini desalination plant. Kuwait and the UAE have also reported missile-related damage."
  - q: "Why aren't more people aware of the water crisis in the Gulf?"
    a: "Western media frames desalination damage as infrastructure collateral — a data point in a larger war. Arabic media treats it as an existential threat. The GAI score of 7.38 means approximately 4.4 billion people are in information blind zones for this story."
---
...
**An estimated 4.4 billion people have little to no awareness this is happening.** The Albis Global Attention Index scores this story at 7.38 — firmly in Information Shadow territory — with Africa, Latin America, and Asia-Pacific almost completely blind to it.
...
And the concentration is staggering. According to a 2010 CIA analysis — declassified and [cited by AP News](https://apnews.com/article/iran-war-desalination-water-oil-middle-east-12b23f2fa26ed5c4a10f80c4077e61ce) — more than 90% of the Gulf's desalinated water comes from just 56 plants. The CIA's assessment: "Each of these critical plants is extremely vulnerable to sabotage or military action."
...
This connects to a pattern we've been tracking at Albis. The Iran war is generating cascading crises — from [oil shortages hitting Japan's 90% import dependency](/blog/japan-oil-reserves-crisis-hormuz-blockade-90-percent-supply-2026) to [India's fuel crisis shutting down restaurants](/blog/india-fuel-crisis-lpg-shortage-hormuz-oil-invisible-2026) to [Africa bearing oil shocks with no bypass routes](/blog/africa-oil-shock-iran-war-no-bypass-route-2026).
