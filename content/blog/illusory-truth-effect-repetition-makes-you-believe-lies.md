---
title: "The Illusory Truth Effect: Why Your Brain Believes Lies It's Heard Before"
...
sources:
  - name: "Cognitive Research: Principles and Implications (PMC)"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC8116821/"
    region: "North America"
    quote: "The largest increase in perceived truth came from encountering a statement for the second time"
  - name: "Journal of Experimental Psychology (APA)"
    url: "https://pubmed.ncbi.nlm.nih.gov/26301795/"
    region: "North America"
    quote: "Illusory truth effects occurred even when participants knew better"
  - name: "MIT News / Science (Vosoughi et al.)"
    url: "https://news.mit.edu/2018/study-twitter-false-news-travels-faster-true-stories-0308"
    region: "North America"
    quote: "False news reached 1,500 people about six times faster than the truth"
  - name: "The Decision Lab"
    url: "https://thedecisionlab.com/biases/illusory-truth-effect"
    region: "North America"
    quote: "Even if we originally receive these myths with a critical mind, we eventually begin to believe there is some truth to them — simply because of repetition"
  - name: "Psychology Today"
    url: "https://www.psychologytoday.com/us/basics/illusory-truth-effect"
    region: "North America"
    quote: "There is no way to catch up with the accelerating speed of repetition of falsehoods once they are unleashed on social media"
confidence: "confirmed"
faqs:
  - q: "What is the illusory truth effect?"
    a: "The illusory truth effect is a cognitive bias where repeated statements feel truer than new ones, regardless of whether they're actually true. Your brain uses processing fluency — how easily it handles information — as a shortcut for truth. First documented in 1977 by researchers at Villanova and Temple University."
  - q: "Does knowing something is false protect you from the illusory truth effect?"
    a: "No. A 2015 study published in the Journal of Experimental Psychology found that people rated repeated false statements as more true even when they already knew the correct answer. Knowledge reduces the effect but doesn't eliminate it."
  - q: "How does repetition spread misinformation on social media?"
    a: "Social media algorithms amplify engaging content, and repeated claims get shared more. An MIT study of Twitter found false news reached 1,500 people six times faster than true stories. Each exposure makes the false claim feel slightly more true to the reader, compounding the effect."
---
...
Usually, that rule works fine. You've heard "the Earth orbits the Sun" thousands of times. It processes smoothly. It's also true. But the shortcut doesn't check whether the source of that familiarity is actual truth or just [repetition](/topics/ai).
...
Recent experiments have mapped how the [illusory truth effect](/indexes/pgi) scales with repetition. In a 2021 study published in Cognitive Research: Principles and Implications, researchers showed participants trivia statements up to 27 times and measured truth ratings at each stage.
...
**Track the source, not the feeling.** When a claim feels obviously true, ask yourself: do I believe this because I've seen evidence, or because I've seen it repeated? These are different things.

**Be suspicious of familiarity.** The feeling of "I've heard this before, so it's probably true" is exactly the bias in action. Familiarity is not evidence.

**Watch for multi-source repetition.** If you see the same claim across five accounts, check whether they're citing the same original source or whether each one independently verified the claim. Five people sharing one unverified tweet isn't five sources. It's one source and four repetitions.

**Slow down on the second exposure.** The biggest truth-rating jump happens when you encounter something the second time. That's your highest-risk moment. If you notice yourself thinking "oh yeah, I saw that" — that's the moment to fact-check, not the moment to scroll past.

The illusory truth effect isn't a flaw you can patch. It's a feature of how human cognition processes the world. The only real defense is understanding how it works and building habits that account for it. Your brain will always trust familiarity. Your job is to make sure familiarity hasn't been manufactured for you.
