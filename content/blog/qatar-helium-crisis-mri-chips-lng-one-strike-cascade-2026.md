---
title: "Qatar Helium Crisis Hits MRI Scans and Chips"
description: "One Iranian strike on Ras Laffan knocked out LNG exports, 30% of global helium, and the cooling gas that keeps MRI machines and chip fabs running. Four weeks in, the shortages are arriving."
date: "2026-03-29"
author: "Priya Sharma"
...
sources:
  - name: "Fortune"
    ...
    quote: "Nobody's run out of helium yet. But it's a few weeks out when the shortage really hits."
  - name: "Euronews"
    url: "https://www.euronews.com/business/2026/03/25/helium-supply-crunch-puts-mri-services-at-risk-amid-qatar-disruptions"
    region: "Europe"
    quote: "Without sufficient helium, the scanner can't operate and effectively becomes a very expensive paperweight."
  - name: "Al Jazeera"
    url: "https://www.aljazeera.com/economy/2026/3/26/helium-hitch-why-us-israel-war-on-iran-could-cause-mri-scan-delays"
    region: "Middle East"
    quote: "South Korea, Japan, Taiwan and China are the biggest consumers of helium from Qatar."
  - name: "AGBI"
    url: "https://www.agbi.com/industry/2026/03/qatari-lng-shutdown-puts-11-of-global-helium-supply-at-risk/"
    region: "Middle East"
    quote: "Around 200 specialised containers used to transport liquid helium are currently stuck in Qatar with no clear route out."
  - name: "bne IntelliNews"
    url: "https://www.intellinews.com/how-iran-s-strike-on-qatar-is-choking-the-global-ai-economy-433882/"
    region: "International"
    quote: "A single facility hit has simultaneously disrupted European energy security, shocked Asian LNG import markets, triggered force majeure on contracts stretching from Italy to South Korea."
---

On March 2, Iranian drones hit Qatar's Ras Laffan Industrial City. The headlines said "[LNG](/blog/qatar-lng-force-majeure-20-percent-global-supply-march-2026)." What they didn't say: that single strike also knocked out a third of the world's helium supply — and four weeks later, the consequences are arriving at hospitals and chip factories simultaneously.

This is the anatomy of a [cascade](/blog/cascade-economics-how-one-shock-breaks-everything). One facility. One strike. Three global crises that most media still treat as separate stories.
...
The headline coverage has focused on [chips and AI](/blog/qatar-helium-shortage-chip-supply-crisis-2026). But the most immediate human impact may be in healthcare.
...
Four weeks ago, Tom's Hardware called it a "[two-week clock](/blog/qatar-helium-shortage-chip-supply-crisis-2026)" before fab inventories ran dry. That clock has passed.
...
Korean chipmakers say they're prepared. Gasworld reported last week that [South Korea's chip industry](/blog/south-korea-chip-factory-triple-crisis-helium-energy-carbon) claims six months of helium stockpiles. SK Hynix says it has "diverse supply chains and sufficient inventory." Samsung has activated helium recycling on some production lines, recovering 60-80% of gas used.
...
That's the pattern Albis tracks through the [Global Attention Index](/indexes/gai): the same reality, sliced into regional fragments, with the full picture visible only when you lay the fragments side by side.
