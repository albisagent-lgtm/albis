...
sources:
  - name: "Al Jazeera"
    ...
    region: "Middle East"
    quote: "Nearly half of the world's traded urea – the most widely used fertiliser – and large volumes of other fertilisers are exported from Gulf countries via the Strait of Hormuz."
  - name: "World Food Programme"
    url: "https://www.wfp.org/news/wfp-projects-food-insecurity-could-reach-record-levels-result-middle-east-escalation"
    region: "International"
    quote: "Almost 45 million more people could fall into acute food insecurity or worse (IPC3+) if the conflict does not end by the middle of the year, and if oil prices remain above USD 100 a barrel."
  - name: "Carnegie Endowment for International Peace"
    ...
    quote: "U.S. importers have seen the price of urea at the port in New Orleans rise more than 25 percent since the end of February."
  - name: "Food Ingredients First / CSIS"
    url: "https://www.foodingredientsfirst.com/news/hormuz-fertilizer-crisis-food-ingredient-costs.html"
    region: "International"
    quote: "Urea prices at the New Orleans import hub jumped from US$516 per metric ton on February 27, 2026, to US$683 on March 5, 2026 — a 32% increase in a single week."
  - name: "Reuters"
    url: "https://www.reuters.com/business/brazil-sounds-alarm-fertilizers-price-spike-spurs-cheaper-alternatives-2026-03-18/"
    region: "Latin America"
    quote: "Brazil could face fertilizer supply problems if the conflict in the Middle East does not ease soon."
faqs:
  - q: "How many people could the Iran war push into hunger?"
    a: "The World Food Programme projects that almost 45 million more people could fall into acute food insecurity if the Iran conflict continues through June and oil stays above $100 per barrel. That would push the global total above 364 million people — a new record."
  - q: "Why is the Strait of Hormuz so important for food and fertilizer?"
    a: "Nearly half of the world's traded urea — the most widely used fertilizer — is exported from Gulf countries through the Strait of Hormuz. Qatar, Saudi Arabia, and Iran together are major producers. With the strait effectively blocked, urea prices have surged over 40% since late February 2026."
  - q: "When will we know if the food crisis is real?"
    a: "Not until harvest time — likely October and November 2026. But the decision that determines the harvest is being made right now. Farmers in the northern hemisphere must apply nitrogen fertilizer in April and May. If they skip or reduce applications because urea costs too much, yields will fall. We won't see that in food prices until autumn."
---
...
The [food security implications](/topics/climate) are global but unevenly distributed. Asian countries receive 35% of Gulf urea exports. Brazil — the world's largest exporter of soybeans and corn — is heavily dependent on Middle Eastern urea. Brazil's own agricultural ministry has already sounded the alarm, warning that supply problems are coming if the conflict doesn't ease. Given that China relies on Brazilian soybeans to feed its pigs and cows, a Brazilian crop shortfall doesn't stay in Brazil.
...
The [fertilizer crisis](/topics/ai) already published on March 18 documented the Hormuz mechanism in detail. What's changed since then is the time pressure. Every day the strait stays closed is another day the April planting window shortens.
