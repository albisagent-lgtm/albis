...
sources:
  - name: "NetBlocks"
    url: "https://www.cnbc.com/2026/03/07/irans-internet-blackout-extends-into-second-week-netblocks.html"
    region: "International"
  - name: "The Guardian"
    url: "https://www.theguardian.com/us-news/2026/mar/07/trump-iran-hype-videos"
    region: "North America"
  - name: "The Guardian"
    url: "https://www.theguardian.com/world/2026/mar/02/internet-blackout-regime-iranians-experts-digital-censorship"
    region: "Europe"
  - name: "The Eagle Online"
    url: "https://theeagleonline.com.ng/menace-of-propaganda-information-manipulation-in-times-of-conflict-by-sk-usman/"
    region: "Africa"
  - name: "The420.in"
    url: "https://the420.in/cyber-warfare-digital-attacks-nuclear-level-threat/"
    region: "South Asia"
faqs:
  - q: "What is information warfare?"
    a: "Information warfare is the use of digital tools, propaganda, and cyber attacks to shape public perception, control narratives, and disrupt enemy communications. It targets how people understand events rather than just physical assets."
  - q: "Why did Iran shut down its internet?"
    a: "Iran's government intentionally cut internet connectivity to approximately 1% of normal levels to prevent citizens from organizing, documenting events, or communicating with the outside world during the US-Israel strikes. This gives authorities more control during conflict."
  - q: "How effective are propaganda videos on social media?"
    a: "Mixed. While the White House's game-style Iran strike videos targeted young right-wing men online, public response was largely skeptical. Only 36% of Americans approve of the Iran strikes, and many criticized the videos as inappropriate 'hype edits.'"
---

Information warfare isn't coming—it's already here. Nations now fight battles in digital spaces just as aggressively as they do on physical ground. The past week showed exactly how this works.
...
According to NetBlocks, the measure remains in place, leaving the public isolated without vital updates and alerts while officials and state media retain access.

Most of the blackout appears intentional, not damage from strikes. Iran's government controls the kill switch.

Digital censorship experts working with Project Ainita and the Outline Foundation explained the motivation. When people can't communicate, they can't organize.
...
SK Usman, a former Nigerian Army spokesman, described a telltale sign in The Eagle Online: dramatic claims about completely destroyed capabilities or victories overnight being "hidden from the world" are often propaganda rather than factual reporting.
...
Cybersecurity expert Triveni Singh described the shift: conflicts today aren't fought only on borders. Enemy nations can target power grids, banking systems, and communication networks through cyberattacks without using conventional weapons.
...
Kathryn Raines, cyber threat intelligence lead at Flashpoint, noted about Iran's blackout: the actual cause is still unclear, but it's almost certainly a combination of both state-ordered suppression and external cyber disruption.
