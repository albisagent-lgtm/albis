...
tags: ["health-longevity", "neuroscience", "aging", "klotho", "clinical-trials", "alzheimers"]
faqs:
  - q: "What is klotho and how does it affect brain aging?"
    a: "Klotho is a protein produced mainly in the kidneys and brain. It enhances synaptic plasticity — the brain's ability to form and strengthen connections between neurons. In animal studies, a single injection reversed age-related cognitive decline within hours. Levels drop steadily as people age, which may explain why cognition declines even in otherwise healthy adults."
  - q: "Is there a klotho treatment available for humans?"
    a: "Not yet. Jocasta Neuroscience raised $35 million to develop JN-0413, a klotho-based compound. They plan to submit an Investigational New Drug application to the FDA in Q4 2026. If Phase 1 trials succeed, a larger Phase 2 trial could begin around 2027-2028."
  - q: "Can klotho protect against Alzheimer's disease?"
    a: "Research suggests it can reduce risk. A meta-analysis of 22 cohorts found that people carrying a genetic variant producing higher klotho levels were 35% less likely to develop Alzheimer's, even if they carried the APOE4 gene — the strongest known genetic risk factor for the disease."
---
