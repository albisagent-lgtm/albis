---
title: "Asia Closes Schools for Fuel While US Trains AI Teachers"
description: "Pakistan shut all schools until March 31 to save diesel. The US just spent $11M training AI teachers. Two education crises — one invisible."
date: "2026-03-24"
author: "Harry Wenham"
...
regions_absent: [middle_east, latam, africa]
region_significance:
  sa: 5
  ap: 4
  us: 3
  eu: 3
region_frames:
  sa: "National emergency — millions of children losing school days to fuel rationing"
  ap: "Regional energy crisis forcing education shutdowns across Southeast Asia"
  us: "AI education investment as priority, Asia school closures barely noted"
  eu: "Energy crisis spreading to social services in developing nations"
sources:
  - name: "Daily Pakistan"
    url: "https://en.dailypakistan.com.pk/23-Mar-2026/balochistan-extends-school-holidays-amid-fuel-saving-efforts"
    region: "South Asia"
    quote: "All schools in Punjab shall remain closed with effect from 10-03-2026 to 31-03-2026 for fuel conservation"
  - name: "Reuters"
    url: "https://www.reuters.com/sports/cricket/pakistans-psl-moves-behind-closed-doors-scraps-opening-ceremony-amid-fuel-crisis-2026-03-22/"
    region: "International"
    quote: "We closed schools and instituted work from home and increased the number of Eid holidays"
  - name: "NSF"
    url: "https://www.nsf.gov/news/nsf-invests-11m-expand-ai-professional-development-k-12"
    region: "North America"
    quote: "This investment will equip thousands of educators with the tools needed to bring AI and computer science into the classroom"
  - name: "Atlantic Council"
    url: "https://www.atlanticcouncil.org/dispatches/demand-destruction-has-begun-what-sri-lanka-reveals-about-the-global-energy-crisis/"
    region: "International"
    quote: "Pakistan has closed schools. Myanmar introduced mobility restrictions."
  - name: "UN News"
    url: "https://news.un.org/en/story/2026/03/1167167"
    region: "International"
    quote: "Authorities have introduced fuel conservation measures, including school closures and work-from-home policies"
confidence: "confirmed"
faqs:
  - q: "Why did Pakistan close all schools in March 2026?"
    a: "Pakistan's Punjab and Balochistan provinces closed all public and private schools from March 10-31, 2026 to conserve fuel during the Hormuz Strait energy crisis. The closure affects tens of millions of students, with online classes encouraged where feasible."
  - q: "How is the 2026 energy crisis affecting education in Asia?"
    a: "Multiple Asian countries have cut school days or closed schools entirely. Pakistan shut schools for three weeks, the Philippines moved to a four-day work week with class suspensions, and Myanmar imposed mobility restrictions. Sri Lanka declared Wednesdays a holiday to save fuel."
  - q: "What is the NSF $11 million AI teacher training program?"
    a: "On March 19, 2026, the US National Science Foundation awarded $11 million to the Computer Science Teachers Association to train 2,500-3,000 K-12 teachers in AI education across seven states, expected to reach 500,000-600,000 students."
---
...
Five days later, on March 19, the US National Science Foundation [announced $11 million](/topics/technology) for training teachers to teach AI. The programme expects to reach 500,000-600,000 students across seven states.

Two education stories. Same week. One made headlines. One didn't.

## The invisible shutdown

Pakistan's school closure isn't a snow day. It's three weeks of blanket shutdown across a country where UNICEF already counts [9.7 million children](/topics/education) not enrolled in Punjab alone. Chief Minister Maryam Nawaz's government told schools to "ensure continuity of academic activities through online platforms where feasible" — but in rural Punjab, where internet penetration hovers around 30%, "feasible" covers a sliver of the population.

Pakistan isn't alone. The [Atlantic Council reported](https://www.atlanticcouncil.org/dispatches/demand-destruction-has-begun-what-sri-lanka-reveals-about-the-global-energy-crisis/) last week that across Asia, governments are rationing their way through the Hormuz energy crisis by cutting the things that burn fuel. Schools burn fuel. Buses burn fuel. So schools close.
...
US and European media covered the NSF investment, the AI tutoring research, and the Coursera-Udemy merger as stories about [the future of education](/topics/technology). Optimistic. Forward-looking. Solvable.
...
For children already enrolled, three lost weeks compounds. Research consistently shows that [learning loss](/topics/education) from disruption doesn't recover on its own — it accumulates. Pakistan already carries scars from the COVID school closures, which the World Bank estimated cost the country 1.5 years of learning-adjusted schooling.
...
The same Hormuz blockade driving Pakistan's school closures is [disrupting semiconductor supply chains](/blog/qatar-helium-shortage-chip-supply-crisis-2026) — the chips that power AI tutoring platforms, the servers that run Coursera, the devices students need to access any of it. Helium shortages threaten chip fab output by mid-April. The AI education future assumes a stable supply chain that this war is dismantling.
