...
sources:
  - name: "BBC News"
    url: "https://www.bbc.com/news/articles/czx1rpxzyx9o"
    region: "International"
    quote: "China said it was 'deeply shocked and strongly condemns' the use of force against a sovereign country and its president."
  - name: "The Guardian"
    url: "https://www.theguardian.com/world/2026/jan/03/colombia-sends-armed-forces-venezuela-border-concern-refugee-influx"
    region: "International"
    quote: "Attacking countries, in blatant violation of international law, is the first step towards a world of violence, chaos and instability."
  - name: "The Hindu"
    ...
    region: "South Asia"
    quote: "To selectively deny amnesty is repression. The regime led by Delcy Rodriguez wants to prolong the terror."
  - name: "Washington Post"
    url: "https://www.washingtonpost.com/opinions/2026/03/13/delcy-rodriguez-trump-venezuela/"
    region: "North America"
    quote: "Ten weeks after the capture of Venezuelan strongman Nicolás Maduro, almost invisible so far is any progress toward a democratic transition."
  - name: "Atlantic Council"
    url: "https://www.atlanticcouncil.org/dispatches/us-just-captured-maduro-whats-next-for-venezuela-and-the-region/"
    region: "North America"
    quote: "The US decapitation operation marks the beginning of the restoration of democracy in the country."
confidence: "confirmed"
faqs:
  - q: "Why did the US capture Venezuela's President Maduro?"
    a: "US forces captured Nicolás Maduro on January 3, 2026, executing an outstanding 2020 federal indictment on drug trafficking charges. He pleaded not guilty in a Manhattan courtroom on January 5."
  - q: "How did Latin America react to the US capture of Maduro?"
    a: "Latin America split sharply. Brazil, Colombia, Mexico, Chile, and Cuba condemned the operation as illegal aggression against a sovereign nation. Argentina's Milei and Chile's incoming president Kast supported it."
  - q: "Who is running Venezuela after Maduro's capture?"
    a: "Delcy Rodríguez, Maduro's former vice president, is serving as interim president. She passed an amnesty law under US pressure, but opposition leader María Corina Machado has called the process 'selective justice.'"
---
...
This story scores a **9.28** on the [Albis Perception Gap Index](/indexes/pgi) — the highest PGI rating of any story tracked today. The gap runs across every dimension: who did what, why they did it, and whether it was legal.
...
On the [Latin American](/perspectives/venezuela) side, the framing is just as clean — and completely different. Brazil's President Lula wrote that the operation "crosses an unacceptable line," adding: "Attacking countries, in blatant violation of international law, is the first step towards a world of violence, chaos and instability." Colombia's Gustavo Petro called it "an assault on the sovereignty of Latin America." Cuba's Díaz-Canel said it was "state terrorism."
...
**Causal framing (9.0):** The US frames the operation as law enforcement — executing a drug indictment. Latin America's left frames it as regime change dressed up in legal language. The Brookings Institution drew a direct comparison to Panama in 1989, when US forces captured Manuel Noriega. Chatham House was blunter: the capture "has no justification in international law."

**Actor portrayal (9.5):** Maduro is a drug-trafficking dictator (Washington) or a sitting president removed by foreign military force (Caracas, Brasília, Havana). The US is a liberator (Trump administration) or an imperial power reprising its worst habits (most of the Global South).

**Cui bono (10.0):** Every party's framing serves its own interests perfectly. Washington justifies military action abroad. Latin American leftists defend sovereignty principles that protect their own positions. Argentina's Milei and Chile's incoming Kast — both right-wing — cheered the operation, seeing Maduro's fall as ideological victory.

## Ten Weeks On: Where's the Democracy?
...
Students are [protesting in Caracas](/topics/venezuela) again. Internet censorship hasn't changed. NGOs say the amnesty law is being applied unevenly.
