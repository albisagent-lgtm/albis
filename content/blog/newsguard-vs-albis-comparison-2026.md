...
date: "2026-03-22"
faqs:
  - q: "Is NewsGuard really unbiased?"
    a: "NewsGuard uses nine apolitical criteria focused on journalistic practices like corrections, transparency, and accuracy — not political leaning. A 2025 University of Vienna study found no systematic bias against conservative outlets. Critics, particularly on the right, dispute this."
  - q: "Is NewsGuard worth paying for?"
    a: "At $4.95/month, NewsGuard is useful if you regularly encounter unfamiliar news sites and want a quick credibility check. It's less useful if you already stick to well-known outlets or want to understand how stories differ across regions."
  - q: "What is the Perception Gap Index?"
    a: "The Perception Gap Index (PGI) is Albis's core metric. It measures how differently the same story is being told across world regions. A high PGI means the narrative gap between regions is wide — same event, very different coverage."
  - q: "Can I use NewsGuard and Albis together?"
    a: "Yes. NewsGuard tells you whether a source follows basic journalistic standards. Albis shows you what stories your region is missing and how framing shifts across borders. One checks the source, the other checks the coverage."
  - q: "What is the best free tool for checking news bias?"
    a: "It depends what you mean by bias. For source credibility, NewsGuard offers a free two-week trial. For regional framing differences, Albis's free tier shows Perception Gap scores. For US political spectrum bias, AllSides is free."
---
...
The [Perception Gap Index](/indexes/pgi) tracks how the same event gets covered across 50+ countries and 800+ outlets. A low PGI means everyone's telling roughly the same story. A high PGI means regions are seeing fundamentally different versions of the same event.
...
**Use NewsGuard if** you regularly encounter unfamiliar news websites and want a quick credibility check. It's especially useful for parents, educators, and anyone who shares articles on social media. The browser extension makes it effortless.

**Use Albis if** you read news from established sources but suspect you're only seeing one slice of the story. It's built for people who want geographic diversity — not just ideological diversity.

**Use both if** you want the full picture. Check the source's credibility with NewsGuard. Then check what your region might be missing with Albis.
