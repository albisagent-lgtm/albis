---
title: "Three Nuclear Sites Hit in One Day: Five Framings"
description: "Israel struck Khondab, Ardakan, and Bushehr on Day 28 of the Iran war. The IDF called it a major blow. Iran said no radiation, no damage. The IAEA has no evidence of weapons. Same strikes, five stories."
date: 2026-03-28
author: "Priya Moran"
...
region_significance:
  ...
  asia_pacific: 3
region_frames:
  us: "Framed as precision strikes degrading Iran's nuclear weapons program"
  eu: "Framed as dangerous escalation narrowing diplomatic options"
  middle_east: "Framed as illegal aggression against civilian infrastructure"
  south_asia: "Framed as regional destabilisation with energy implications"
  asia_pacific: "Framed as clinical chronology with IAEA contradiction highlighted"
sources:
  - "Al Jazeera — Israeli strikes on nuclear sites confirmed by Iran's Atomic Energy Organization"
  - "Fortune / AP — Khondab, Ardakan, Bushehr details and IRGC retaliation threat"
  - "IAEA — No evidence Iran building nuclear weapons (March 4 statement)"
  - "Arms Control Association — Analysis of war justification vs evidence"
  - "Times of Israel — IDF confirmation of Ardakan as 'only facility of its kind'"
confidence: "confirmed"
faqs:
  - q: "Which Iranian nuclear sites were struck on March 27, 2026?"
    a: "Israel struck three sites in one day: the Khondab Heavy Water Complex near Arak, the Ardakan yellowcake production plant in Yazd Province, and the Bushehr Nuclear Power Plant. Iran confirmed all three hits but reported no casualties or radiation leaks."
  - q: "Did the strikes on Iran's nuclear sites cause radiation leaks?"
    a: "No. Iran's Atomic Energy Organization and the IAEA both confirmed no radiation was released from any of the three strikes on Khondab, Ardakan, or Bushehr."
  - q: "What is the PGI score for the nuclear strikes story?"
    a: "The Albis Perception Gap Index scores this story at 7.48 out of 10, with the widest framing gap between US and Middle Eastern coverage (8.5) on how the strikes are characterised."
---

Israel struck three Iranian nuclear facilities in a single day on March 27 — the Khondab Heavy Water Complex, the Ardakan yellowcake plant, and Bushehr Nuclear Power Plant. The [Albis Perception Gap Index](/indexes/pgi) scores this story at 7.48, with the widest gap between US and Middle Eastern framing (8.5). The IAEA has stated it has no evidence Iran is building a nuclear weapon. Israel's military called Ardakan "the only facility of its kind in Iran." Both statements are true. The gap between them is where five different wars are being fought.

The IDF confirmed the strikes and described Ardakan as a "highly important" target for Iran's "nuclear weapons program." Iran's Atomic Energy Organization confirmed all three facilities were hit, reported zero casualties, zero radiation leaks, and called them attacks on "peaceful, safeguarded nuclear facilities." The IAEA, the only body with inspection authority, said on March 4 that it has [no evidence Iran is building a bomb](/blog/gabbard-iran-no-nuclear-program-war-justification-pgi-2026).
...
BBC Chinese analysis noted that both sides are now targeting nuclear-adjacent sites — Israel hitting Bushehr, Iran retaliating against Dimona — and drew a clear conclusion: "important sites are no longer off-limits." This framing treats the [escalation pattern](/blog/natanz-dimona-nuclear-strikes-framing-divided-pgi-2026) as the story, not the individual strikes.
...
**PGI Score: 7.48** — among the highest-scored stories in today's midday scan.
