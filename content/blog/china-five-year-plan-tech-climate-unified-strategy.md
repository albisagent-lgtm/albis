...
image: "https://picsum.photos/seed/china-five-year-plan-tech-climate-unified-strategy/1200/630"
seoKeyword: "China five year plan 2026 R&D spending climate"
faqs:
  - q: "How much is China increasing R&D spending?"
    a: "At least 7% per year for five years, translating to billions of additional dollars annually for AI, quantum computing, semiconductors, biotech, and 6G networks."
  - q: "Will China's emissions rise under the new plan?"
    a: "Yes. The 17% carbon intensity target allows total emissions to increase 3-6% over five years while GDP grows 4.5-5%, meaning absolute emissions can rise even as efficiency improves."
  - q: "Why does China prioritize tech independence over climate targets?"
    a: "US export controls on semiconductors and advanced technology forced China to choose between growth and climate ambition. The plan makes clear: tech self-sufficiency comes first."
sources:
  - name: "Nature"
    url: "https://www.nature.com/articles/d41586-026-00770-y"
    region: "International"
    quote: "China has proposed to increase its overall research and development (R&D) expenditure by at least 7% per year over the next five years, which translates to billions of extra dollars each year."
  - name: "Centre for Research on Energy and Clean Air"
    ...
    region: "Europe"
    quote: "The 17% carbon intensity target allows China's CO2 emissions to increase by 3-6% over the next five years, assuming 4.5-5.0% GDP growth."
  - name: "Reuters"
    url: "https://www.reuters.com/world/asia-pacific/china-vows-accelerate-technological-self-reliance-ai-push-2026-03-05/"
    region: "International"
    quote: "The government work report and five-year blueprint outlined plans to increase investment in quantum computing, 6G, embodied AI - the tech that powers humanoid robots - and areas at the cutting-edge of science, like machine-brain interfaces."
  - name: "Carbon Brief"
    url: "https://www.carbonbrief.org/china-briefing-5-march-2026-new-five-year-climate-goals-revealed-at-two-sessions-meeting/"
    region: "Europe"
    quote: "The new methodology means that this leaves space for overall emissions to rise by 3-6% over the next five years."
  - name: "CSIS"
    url: "https://www.csis.org/analysis/limits-chip-export-controls-meeting-china-challenge"
    region: "North America"
    quote: "The restrictions prompted China to implement an all-out, government-backed effort to improve the country's self-sufficiency in all aspects of semiconductor design and production."
