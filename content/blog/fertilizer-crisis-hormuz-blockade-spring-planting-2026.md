...
sources:
  - name: "Fortune"
    ...
    quote: "Geopolitical turmoil is driving fertilizer prices up 30%, forcing tough crop choices, former USDA chief economist Seth Meyer told Fortune. 'A bad decision this year could be pretty costly.'"
  - name: "Carnegie Endowment for International Peace"
    ...
    quote: "Even if the Strait of Hormuz does open soon, restarting production and transport for fertilizers and their components could take weeks—weeks that Northern Hemisphere farmers do not have."
  - name: "American Farm Bureau Federation"
    url: "https://www.fb.org/market-intel/middle-east-tensions-raise-spring-planting-concerns"
    region: "North America"
    quote: "Countries exposed to instability in the Persian Gulf account for nearly half of globally traded urea exports and roughly 30% of ammonia exports."
  - name: "The Guardian"
    url: "https://www.theguardian.com/world/2026/mar/12/asia-energy-crisis-iran-war"
    region: "International"
    quote: "Bangladesh started rationing fuel sales last week in an effort to halt panic buying, and closed all universities as it sought to sustain supplies."
  - name: "Reuters"
    url: "https://www.reuters.com/business/iran-war-deprives-us-farmers-affordable-fertilizer-spring-planting-looms-2026-03-13/"
    region: "International"
    quote: "A Canadian farmer bought his urea in December, but if he bought it today it would cost C$44,000 ($32,070) more. Some farmers in his area now face that price hike or may not even be able to buy any."
faqs:
  - q: "Why does the Strait of Hormuz closure affect fertilizer prices?"
    a: "Nearly half of globally traded urea (the main nitrogen fertilizer) exports pass through Hormuz. Natural gas from the region also powers fertilizer production. With the strait closed for 17 days, nearly a million metric tons of fertilizer are physically stranded."
  - q: "When does spring planting start and why does timing matter?"
    a: "Spring planting in North America runs from late March through May. Fertilizer must be applied before or during early growth. Ships take weeks to reach farms after loading. Missing the planting window means lower yields months later."
  - q: "How much have fertilizer prices increased since the Iran war started?"
    a: "US urea import prices have surged 32% in one week, reaching $591 per tonne—up 25% since the war began on February 28. One Canadian farmer would pay $32,070 more today than he did in December."
---
...
**Under-apply.** Use less fertilizer. Agronomists warn that cutting nitrogen and phosphate by more than 10% could drop corn and wheat yields 5% to 8% globally. That tightens grain stocks and pushes food prices higher by autumn.

**Delay.** Wait for prices to drop or supply to stabilize. But planting windows are narrow. Late planting means lower yields. Miss the window and you lose the season.

**Switch crops.** Plant something that needs less fertilizer. But rotations are planned months ahead. Switching mid-season disrupts entire supply chains.

Seth Meyer, former USDA chief economist: "A bad decision this year could be pretty costly."
