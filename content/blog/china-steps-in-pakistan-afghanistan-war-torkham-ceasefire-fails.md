...
sources:
  - name: "The Express Tribune / Reuters"
    url: "https://tribune.com.pk/story/2597260/chinas-mediation-eases-fighting-between-pakistan-afghanistan-sources"
    region: "South Asia"
    quote: "A meeting between the Chinese ambassador to Pakistan, Jiang Zaidong, and Prime Minister Shehbaz Sharif late last month included a message from Xi to cease hostilities."
  - name: "Pakistan Today"
    url: "https://www.pakistantoday.com.pk/2026/03/13/pakistan-and-afghanistan-forces-agree-to-brief-pause-at-torkham-to-identify-and-retrieve-body"
    region: "South Asia"
    quote: "Despite the agreement for a temporary ceasefire, the body could not be retrieved. Delays in consultation among Afghan authorities led to the expiration of the agreed pause."
  - name: "Al Jazeera"
    url: "https://www.aljazeera.com/news/2026/3/10/pakistan-orders-sweeping-austerity-measures-as-iran-war-triggers-oil-crisis"
    region: "Middle East"
    quote: "Petrol on Tuesday costing $1.15 a litre and diesel at $1.20 a litre -- a 20 percent jump since last week."
  - name: "Reuters"
    url: "https://www.reuters.com/world/asia-pacific/pakistan-imf-review-talks-continue-middle-east-risks-weigh-2026-03-12/"
    region: "International"
    quote: "Talks assessed risks from the Middle East conflict and rising energy prices to Pakistan's economy, balance of payments and external financing needs."
  - name: "Wikipedia / Multiple Sources"
    url: "https://en.wikipedia.org/wiki/2026_Afghanistan%E2%80%93Pakistan_war"
    region: "International"
    quote: "115,000 Afghan civilians displaced, 3,000 Pakistani civilians displaced per UNHCR."
faqs:
  - q: "Is there a ceasefire between Pakistan and Afghanistan in March 2026?"
    a: "No formal ceasefire is in place. China's mediation, including a direct message from President Xi Jinping, has reduced the intensity of fighting -- no Pakistani airstrikes have been reported in recent days -- but daily ground clashes continue along the border. A brief pause at Torkham on March 13 to retrieve a body collapsed before it could be completed."
  - q: "Why is China mediating the Pakistan-Afghanistan conflict?"
    a: "China stepped in because the previous mediators -- Qatar, Saudi Arabia, and Turkey -- are consumed by the Iran-US war in the Middle East. Beijing has strategic interests in both countries, including the China-Pakistan Economic Corridor and mineral extraction deals with the Taliban, giving it leverage with both sides."
  - q: "How is the Iran war affecting Pakistan's conflict with Afghanistan?"
    a: "The Iran war has driven oil above $100/barrel, triggering a 20% fuel price spike in Pakistan and threatening its $7 billion IMF bailout. Pakistan's Saudi defence pact complicates its neutrality. Meanwhile, the traditional mediators are distracted, leaving Beijing as the only major power engaged on this front."
---
