...
sources:
  - name: "The Guardian"
    ...
    quote: "A Hollywood-themed propaganda video released by the White House promising \"justice the American way\" for Iran features movie stars from Australia, New Zealand and Canada"
  - name: "Truthout"
    url: "https://truthout.org/articles/white-house-propaganda-videos-splice-horrific-iran-war-footage-with-video-games/"
    region: "North America"
    quote: "For several days in a row, the White House has posted videos on X of the US strikes on Iran spliced with footage taken from video games and action movies"
  - name: "Euronews"
    url: "https://www.euronews.com/next/2026/03/06/irans-state-media-ramps-up-disinformation-campaign-as-the-us-iran-conflict-wages"
    region: "Europe"
    quote: "Since the United States and Israel launched attacks on Iran on 28 February, 18 war-related claims by Iran were found to be false"
  - name: "IANS"
    url: "https://ianslive.in/ai-deepfakes-driving-surge-in-us-scams--20260306073304"
    region: "Asia-Pacific"
    quote: "Artificial intelligence and deepfake technology are accelerating financial scams in the United States"
faqs:
  - q: "How are governments using video games in propaganda?"
    a: "The White House has posted videos splicing real strike footage with clips from Grand Theft Auto, Call of Duty, and action movies, presenting warfare using video game aesthetics and memes. This treats military action as social media content optimized for engagement rather than serious communication."
  - q: "How does Iran's information warfare strategy work?"
    a: "Iran operates a dual strategy: blocking domestic internet access (98% traffic reduction) to prevent citizens from accessing foreign media, while simultaneously running AI-manipulated image campaigns targeting Western audiences with false claims about military victories."
  - q: "Can deepfakes be reliably detected?"
    a: "Detection varies dramatically between lab conditions and real-world use. The most effective strategies combine AI detection systems with human training to spot artifice, familiarity with the depicted person, and liveness checks that measure natural human responses. But attackers adapt as fast as detection improves."
---
