...
author: "Harry Wenham"
tags: ["health-longevity", "aging", "epigenetics", "biotech", "gene-therapy", "clinical-trials"]
faqs:
  - q: "What is epigenetic reprogramming and how does it reverse aging?"
    a: "Epigenetic reprogramming uses transcription factors to reset chemical markers on DNA that change as cells age. It doesn't alter your genes — it resets the instructions that tell genes when to turn on and off, restoring cells to a younger functional state. In mice, this restored vision in blind animals within weeks."
  - q: "Is the ER-100 aging reversal therapy safe for humans?"
    a: "The Phase 1 trial starting in 2026 is designed to answer exactly that question. Preclinical studies in monkeys showed no tumors or systemic toxicity. The therapy excludes c-Myc, a cancer-linked factor, and includes a kill switch that lets doctors stop gene expression with doxycycline if anything goes wrong."
  - q: "When will anti-aging reprogramming therapies be available to the public?"
    a: "Not soon. ER-100's Phase 1 trial focuses on safety in eye disease patients, not aging broadly. If it works, expanded trials could follow in 2027-2028. Therapies for general aging reversal are likely a decade or more away. But this trial proves the concept has moved from lab theory to human medicine."
---
