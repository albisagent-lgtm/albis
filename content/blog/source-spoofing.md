---
title: "Source Spoofing: How Fake News Sites Steal Real Outlets' Identities"
...
faqs:
  - q: "What is source spoofing?"
    a: "Source spoofing is the creation of fake media outlets, cloned news websites, or fabricated experts designed to make propaganda look like legitimate journalism. The fake source borrows the credibility of a real one."
  - q: "How can I check if a news site is real?"
    a: "Check the URL carefully — spoofed sites use slight misspellings or different domain extensions. Look for an 'About' page with real staff names. Search for the outlet's name independently. If you can only find the site through social media links, be cautious."
sources:
  - name: "EU DisinfoLab — Doppelganger Investigation"
    url: "https://www.disinfo.eu/doppelganger/"
    region: "Europe"
    quote: "Uses multiple clones of authentic media — at least 17 media providers, including Bild, 20minutes, Ansa, The Guardian or RBC Ukraine"
    confidence: "confirmed"
  - name: "IFEX — Doppelganger Campaign"
    url: "https://ifex.org/russian-doppelganger-campaign-spoofs-media-websites-to-spread-disinformation/"
    region: "Europe"
    quote: "Russian sources lease internet domains that clone legitimate media websites in order to spread false, pro-Russia narratives"
    confidence: "confirmed"
  - name: "Doppel — Russian Disinformation Campaign"
    url: "https://www.doppel.com/blog/russian-disinformation-campaign-doppelganger-why-doppel-exists"
    region: "North America"
    quote: "The U.S. Justice Department seized 32 web domains used by Doppelganger"
    confidence: "confirmed"
  - name: "Meta Q2-Q3 2025 Adversarial Threat Report"
    url: "https://about.fb.com/news/"
    region: "Global"
    quote: "Updated Endless Mayfly attribution to Iran's IUVM — ephemeral disinformation on typosquat domains"
    confidence: "confirmed"
---
