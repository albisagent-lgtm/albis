...
sources:
  - name: "CNBC"
    ...
    quote: "China on Thursday set its GDP growth target for 2026 at 4.5% to 5% — the lowest target on record going back to early 1990s — as Beijing grapples with persistent deflationary pressures and trade tensions with the U.S."
  - name: "Carnegie Endowment for International Peace"
    ...
    quote: "Even a complete halt to Iranian exports won't lead to an immediate crisis in China, but it will torpedo the pricing model on which entire segments of the Chinese economy are built."
  - name: "Columbia University Center on Global Energy Policy"
    url: "https://www.energypolicy.columbia.edu/how-the-iran-conflict-is-reshaping-russia-and-chinas-energy-security/"
    region: "International"
    quote: "The conflict in the Middle East is vindicating China's approach to energy security over the past two decades."
  - name: "ISW / AEI China-Taiwan Update"
    url: "https://understandingwar.org/research/china-taiwan/china-taiwan-update-march-13-2026/"
    region: "North America"
    quote: "The PRC increased its military budget, escalated its rhetoric towards Taiwan, and placed an emphasis on emerging technological development in 2026."
  - name: "The Guardian"
    url: "https://www.theguardian.com/world/2026/mar/03/trump-us-iran-middle-east-china"
    region: "Europe"
    quote: "Trump's decision to embark on a war against Iran creates a space for China to once more leverage its critical mineral dominance."
faqs:
  - q: "What is China's GDP target for 2026?"
    a: "China set its 2026 GDP growth target at 4.5–5%, its lowest since the early 1990s. The economy is in its fourth consecutive year of deflation, with real estate prices down 11.1% in January-February 2026 and roughly 70% of household wealth tied to property."
  - q: "Is China benefiting from the Iran war?"
    a: "Strategically yes — US distraction has accelerated China's multipolarity narrative, delayed the Xi-Trump summit, and reduced Western focus on Taiwan. But economically, China faces its worst structural conditions in 35 years at the same time."
  - q: "What are US AI chip export controls doing to China?"
    a: "NVIDIA now requires a license to sell its H20 GPU in China, and a bipartisan Congress group is pushing to tighten limits further. China has responded by filing 700+ AI models with domestic regulators and mandating homegrown chips for all state-funded data centres."
---
...
Since the US and Israel struck Iran on February 28, Beijing has played its hand carefully: abstaining on UN votes, dispatching envoys, positioning itself as a post-conflict stabiliser. NATO is fracturing. The Trump-Xi summit is almost certainly delayed. US credibility across the Global South is fraying fast. Meanwhile, the ISW confirmed this week that China increased its military budget and escalated rhetoric toward [Taiwan](/perspectives/china) — precisely while Washington's military attention is consumed in the Middle East.
...
China's response has been systematic: register 700+ [AI](/topics/ai) models with domestic regulators, mandate homegrown silicon, accelerate indigenous chip development. It's a coherent long-term strategy. It's also a race against NVIDIA's roadmap, which isn't waiting.
...
The [Albis Perception Gap Index](/indexes/pgi) scored China's strategic position at 6.8 this week — significant divergence between Western analysts framing this as "Beijing overreaching" and Chinese domestic coverage framing it as "strategic patience vindicated."
