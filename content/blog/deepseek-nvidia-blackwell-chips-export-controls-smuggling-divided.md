...
sources:
  - name: "Reuters"
    ...
    quote: "U.S. policy is 'we're not shipping Blackwells to China'"
  - name: "The Information"
    url: "https://www.theinformation.com/articles/deepseek-using-banned-nvidia-chips-race-build-next-model"
    region: "North America"
    quote: "The chips DeepSeek is using were smuggled"
  - name: "The Straits Times"
    url: "https://www.straitstimes.com/business/us-looking-if-deepseek-got-nvidia-ai-chips-through-singapore-others"
    region: "Asia-Pacific"
    quote: "US authorities began investigating whether DeepSeek circumvented sanctions through third parties in countries like Malaysia, Singapore and the United Arab Emirates"
  - name: "Modern Diplomacy"
    url: "https://moderndiplomacy.eu/2026/02/24/chinas-deepseek-trains-ai-on-u-s-nvidia-chip-despite-export-ban/"
    region: "Europe"
    quote: "DeepSeek may have removed technical indicators that could reveal the chips' origin"
confidence: "confirmed"
faqs:
  - q: "Did DeepSeek use banned Nvidia chips to train its AI model?"
    a: "A senior Trump administration official confirmed in February 2026 that DeepSeek trained its next model on Nvidia Blackwell chips at a data center in Inner Mongolia, despite US export controls banning those chips from China."
  - q: "How did DeepSeek get Nvidia Blackwell chips in China?"
    a: "The exact route is unclear. The Information reported the chips were smuggled. US investigators are probing whether third parties in Singapore, Malaysia, and the UAE helped divert chips to China through shell companies."
  - q: "What does China say about the DeepSeek chip allegations?"
    a: "China's embassy in Washington said Beijing opposes 'drawing ideological lines, overstretching the concept of national security, expansive use of export controls and politicizing economic, trade, and technological issues.'"
---
...
Read it from Beijing, and the [export controls](/topics/ai) themselves are the aggression. The rules are designed to strangle Chinese technology development. Any company resourceful enough to build competitive AI despite those restrictions isn't a criminal — it's proof the controls are both unjust and failing.

The [Albis Perception Gap Index](/indexes/pgi) scored this story at **6.55** — driven by sharp divergence on causal attribution (7.0), actor portrayal (7.0), and cui bono (8.0). The US-Asia Pacific regional pair hit 7.0. Whether a violation even occurred is fundamentally contested. One side says rules were broken. The other says the rules shouldn't exist.
