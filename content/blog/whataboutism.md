---
title: "Whataboutism: How Deflection Kills Accountability"
...
faqs:
  - q: "What is whataboutism?"
    a: "Whataboutism is the practice of responding to criticism by pointing at the accuser's own failings instead of addressing the original issue. It's a deflection tactic — the goal isn't to win an argument but to neutralize it entirely."
  - q: "Is whataboutism ever legitimate?"
    a: "Pointing out genuine hypocrisy can be valid. The difference is intent. Legitimate criticism addresses both issues. Whataboutism uses the counter-accusation to avoid addressing the original criticism at all. The subject changes, and accountability disappears."
sources:
  - name: "Russia Matters — 2 Decades of Russian Whataboutism"
    url: "https://www.russiamatters.org/blog/2-decades-russian-whataboutism-partial-rundown"
    region: "Global"
    quote: "The strategic practice of deflecting criticism with counter-accusations against the criticizer, while implying hypocrisy"
    confidence: "confirmed"
  - name: "Britannica — Whataboutism"
    url: "https://www.britannica.com/topic/whataboutism"
    region: "Global"
    quote: "Responding to an accusation or difficult question by making a counteraccusation, by asking a different but related question, or by raising a different issue altogether"
    confidence: "confirmed"
  - name: "Detector Media — How Russian Propaganda Uses Whataboutism"
    url: "https://disinfo.detector.media/en/post/how-russian-propaganda-uses-whataboutism-tactics"
    region: "Europe"
    quote: "Acts of violence against African Americans during the US Civil Rights Movement became one of the key messages of Soviet propaganda"
    confidence: "confirmed"
  - name: "Euromaidan Press — A Guide to Russian Propaganda Part 2"
    url: "https://euromaidanpress.com/2016/08/31/a-guide-to-russian-propaganda-part-2-whataboutism/"
    region: "Europe"
    quote: "After spending days denying or minimizing the Chernobyl nuclear meltdown, the Soviet government finally admitted there was an accident"
    confidence: "confirmed"
---
