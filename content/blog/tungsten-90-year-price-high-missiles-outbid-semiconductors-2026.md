---
title: "Tungsten 90-Year Price High: Missiles Now Outbid Chips"
description: "Tungsten prices surged 557% to a 90-year high as Iran war munitions compete with chipmakers and solar manufacturers for the same metal. Here's what it means for your phone, your power grid, and the AI boom."
date: "2026-03-24"
...
region_significance:
  ...
  ap: 4
region_frames:
  us: "Military readiness crisis — munitions demand draining civilian supply"
  eu: "Industrial vulnerability requiring urgent reshoring of critical minerals"
  ap: "Semiconductor supply emergency as China leverages tungsten dominance"
sources:
  - "Reuters - Every missile fired over Iran is burning through US tungsten stocks (March 23, 2026)"
  - "Bloomberg - Munitions Metal Tungsten Eclipses Gold, Copper in 557% Rally (March 15, 2026)"
  - "MINING.COM / Project Blue - USGS data on 90-year tungsten price high"
  - "Fastmarkets - Tungsten 2026: Geopolitics sets global tone (March 18, 2026)"
  - "BusinessToday India - War far from fabs rattling chip supply chain (March 20, 2026)"
...
Tungsten prices have surged 557% since China imposed [export controls](/topics/critical-minerals) in February 2025. The Rotterdam benchmark for ammonium paratungstate (APT) — the intermediate product used to make tungsten metal — jumped from under $400 per metric ton to over $2,200. According to consultancy Project Blue, citing US Geological Survey data, tungsten products haven't traded this high in at least 90 years.
...
Military buyers will always outbid civilian buyers. That's the rule. And the civilian buyers in question aren't making luxury goods — they're making [semiconductors](/topics/semiconductors), printed circuit boards, and solar panels.
...
The Iran conflict isn't just reshaping oil markets and [food supply chains](/blog/sulfur-shortage-hormuz-blockade-threatens-2027-food-supply). It's quietly depleting the raw materials that power the technology economy. Every missile that detonates in Iran makes the next generation of semiconductors slightly more expensive, the clean energy transition slightly slower, and the AI boom slightly more fragile.
