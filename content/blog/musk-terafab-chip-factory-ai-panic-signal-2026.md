---
title: "Musk's $25B Terafab May Actually Cost $13 Trillion"
description: "Bernstein analysts say Musk's Terafab chip factory needs 140-360 new fabs and up to $13 trillion — while Broadcom warns TSMC capacity has 'choked' the AI supply chain."
date: "2026-03-25"
author: "James Chen"
...
faqs:
  - q: "What is Elon Musk's Terafab chip factory?"
    a: "Terafab is a joint venture between Tesla, SpaceX, and xAI announced March 21, 2026. Located in Austin, Texas, it aims to produce 1 terawatt of AI compute annually at 2-nanometer process technology. Musk says he needs it because existing chipmakers can't expand fast enough."
  - q: "How much will Terafab actually cost to build?"
    a: "Musk says $20-25 billion. Barclays says their $50 billion bull-case estimate is 'dramatically low.' Bernstein analysts estimate the full 1-terawatt vision would need 140-360 new fabs costing $5 trillion to $13 trillion — roughly 250 times Tesla's annual capital spending."
  - q: "Does Tesla have semiconductor manufacturing experience?"
    a: "No. Tesla has never fabricated a chip. Its Dojo custom chip project was shut down in August 2025, and lead engineers including Peter Bannon left the company. Tesla is now posting job listings for Terafab roles in Austin and Palo Alto."
sources:
  - name: "Bloomberg via Mercury News"
    url: "https://www.mercurynews.com/2026/03/24/musks-terafab-fever-dream-exposes-reality-of-the-ai-chip-crunch/"
    region: "North America"
    quote: "The project would require something like $5 trillion to $13 trillion in capital spending, according to estimates from Bernstein analysts."
  - name: "Reuters"
    url: "https://www.reuters.com/world/asia-pacific/broadcom-flags-supply-constraints-says-tsmc-capacity-bottleneck-2026-03-24/"
    region: "International"
    quote: "TSMC capacity has become a bottleneck, or has kind of choked the supply chain in 2026."
  - name: "Electrek"
    url: "https://electrek.co/2026/03/22/tesla-spacex-terafab-chip-factory-ai-desperation/"
    region: "North America"
    quote: "Tesla's CFO acknowledged that the full Terafab cost is not yet incorporated into Tesla's record capital expenditure plan for 2026."
  - name: "Barclays via EV News"
    url: "https://eletric-vehicles.com/tesla/barclays-says-teslas-terafab-could-cost-many-multiples-above-50-billion/"
    region: "Europe"
    quote: "Our 'bull' CapEx target for Terafab of $50bn+ appears dramatically low vs the aspirations Tesla communicated."
  - name: "Fast Company"
    url: "https://www.fastcompany.com/91513947/how-elon-musk-plans-to-build-his-own-chip-empire-in-texas"
    region: "North America"
    quote: "Tesla did have a chip design team, but most left the company after Musk killed the Dojo project."
...
region_significance:
  ...
  asia_pacific: 4
region_frames:
  us: "Framed as bold Musk vision with heavy skepticism from analysts"
  eu: "Framed through strategic autonomy lens — reducing global chip dependency"
  asia_pacific: "Chinese media most skeptical — detailed cost analysis questioning feasibility"
---
...
Meanwhile, the people trying to get around the supply crunch are getting creative in ways that make governments nervous. Last week, [three people tied to Super Micro Computer were charged](/blog/super-micro-nvidia-chip-smuggling-arrest-export-controls-failing-2026) with illegally diverting $2.5 billion in Nvidia-powered servers to China using fake shipping documents and dummy equipment. ByteDance reportedly deployed 36,000 Nvidia chips in Malaysia through an intermediary called Aolani Cloud — a legal grey zone that effectively sidesteps US export controls.
