...
faqs:
  - question: "What is balcony solar and how does it work?"
    answer: "Balcony solar consists of 1-3 lightweight panels that attach to a railing or wall and plug into a standard 120V outlet via a microinverter. They offset household electricity use without any permanent construction, wiring changes, or utility permits."
  - question: "Which US states have legalized balcony solar?"
    answer: "Utah passed the first plug-and-play solar law in March 2025. Virginia's legislature approved HB 395 in March 2026, making it the second state. Twenty-eight states and DC have introduced similar legislation as of early 2026."
  - question: "How much money can balcony solar save?"
    answer: "Savings vary by location and system size, but a $400-$1,100 system can save $100-$330 per year on electricity bills. German users report cutting 15-25% of household electricity use, with payback periods as short as 2 years."
sources:
  - "Canary Media — Balcony solar is taking state legislatures by storm (March 2026)"
  - "Solar.com — 2026 Guide to Balcony & Plug-In Solar"
  - "Utility Dive — Virginia legislature passes balcony solar bill (March 2026)"
  - "DW — Germany's balcony-solar boom: 1 million installed (December 2025)"
  - "The Guardian — Law changes could bring balcony solar to millions across US (November 2025)"
...
UL Solutions launched the UL 3700 certification, the first US safety standard for plug-in solar. A UL 3700-certified system cuts power in under a second if unplugged. Panels stop generating during grid outages, protecting utility workers. The standard also covers overload safeguards, weatherproofing, and ground-fault protection.
...
Balcony solar won't replace oil — these are small panels generating a fraction of household electricity. But the speed of this legislative wave reveals something. When energy costs become a cost-of-living crisis, removing barriers to self-generation becomes politically irresistible. The 96-0 vote in Virginia wasn't a climate vote. It was an electricity bill vote.
