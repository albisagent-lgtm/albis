...
regions_absent: [us, eu, middle_east, asia_pacific, africa, latam]
region_significance:
  south_asia: 5
region_frames:
  south_asia: "Government managing crisis with emergency reserves and Indian-flagged ships"
...
sources:
  ...
  - name: "OilPrice.com"
    url: "https://oilprice.com/Energy/Natural-Gas/Hormuz-Shutdown-Throws-Indias-LPG-Market-Into-Chaos.html"
    region: "North America"
    quote: "Middle Eastern suppliers account for roughly 90% of India's LPG imports."
  - name: "The Independent"
    url: "https://www.independent.co.uk/asia/india/lpg-gas-cylinder-delhi-shortage-queues-b2940058.html"
    region: "Europe"
    quote: "Instead of moving forward, we're moving back in time."
  - name: "Indian Express"
    url: "https://indianexpress.com/article/explained/explained-economics/india-lpg-imports-dependence-explained-10582355/"
    region: "South Asia"
    quote: "LPG accounted for 40% of all imported petroleum products, making it the single largest imported petroleum product."
  - name: "Business Today"
    url: "https://www.businesstoday.in/latest/economy/story/govt-ramps-up-fuel-shipping-preparedness-as-hormuz-tensions-rise-lpg-petrol-stocks-adequate-says-centre-521719-2026-03-21"
    region: "South Asia"
    quote: "Additional kerosene allocation has been approved for states, and coal supply has been increased for small and medium consumers."
faqs:
  - q: "Why is India facing an LPG cooking gas shortage in 2026?"
    a: "India imports 60% of its cooking gas (LPG), and 90% of those imports come through the Strait of Hormuz. Iran's blockade of the strait during the 2026 war has cut off the vast majority of supply. Only two tankers have made it through since the blockade began."
  - q: "How long will India's cooking gas crisis last?"
    a: "It depends on when Hormuz reopens. Alternative supplies from the US take 45 days to arrive versus 7-8 days from the Gulf. India is diversifying sources and ramping up domestic production, but full replacement of Gulf volumes isn't feasible in the short term."
  - q: "What is India doing about the LPG shortage?"
    a: "The government has ordered a 25% increase in domestic refinery LPG production, widened the gap between cylinder bookings to 25-45 days, restored kerosene and coal as alternative cooking fuels, and negotiated with Iran for safe passage of Indian-flagged tankers through Hormuz."
---
...
LPG is now India's single largest imported petroleum product. It accounts for 40% of all petroleum imports by volume and 53% by expenditure, according to India's [Petroleum Planning and Analysis Cell](/topics/energy-crisis). The country went from spending ₹1,274 crore on LPG imports in 1999 to ₹1.06 lakh crore in 2025 — an 83-fold increase in 27 years.
...
The same war is experienced as a geopolitical chess game in Washington and an empty gas cylinder in Mumbai. That framing gap has consequences. International policy conversations about Hormuz centre on oil prices, shipping insurance, and military options. The fact that 310 million [Indian households](/perspectives/south-asia) can't reliably cook dinner doesn't make the briefing.
