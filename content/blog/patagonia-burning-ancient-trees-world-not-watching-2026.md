...
author: "Harry Wenham"
tags: ["unseen", "gai", "climate", "argentina", "wildfires", "patagonia"]
faqs:
  - question: "What are Alerce trees and why do they matter?"
    answer: "Alerce (Patagonian cypress) trees are the second-longest-living tree species on Earth, capable of surviving over 3,600 years. They store massive amounts of carbon — the largest 1% of trees hold roughly half of all above-ground forest carbon. When they burn, that stored carbon releases back into the atmosphere, accelerating the warming that caused the fires."
  - question: "Why did Argentina's firefighting budget get cut during a record fire season?"
    answer: "President Javier Milei's austerity program slashed funding for the National Fire Management Service by 71% in real terms for 2026. The cuts hit prevention programs, park protection, and firefighter resources right as Patagonia entered one of its worst fire seasons in decades."
  - question: "Why aren't more countries covering the Patagonia fires?"
    answer: "The Albis Global Attention Index scored this story at 6.64 — one of the highest invisibility ratings recorded. The Iran-Israel-US conflict dominates global attention, pushing climate disasters in the Southern Hemisphere out of view for Europe, Asia, the Middle East, Africa, and most of the world."
sources:
  - name: "Bulletin of the Atomic Scientists"
    url: "https://thebulletin.org/2026/02/why-patagonia-burns-every-summer-climate-change-shifting-fire-regimes-and-policy-failures/"
    region: "International"
    quote: "More than 45,000 hectares — an area almost twice the size of Buenos Aires — have already been consumed by fire in Northern Patagonia this summer."
  - name: "World Weather Attribution"
    url: "https://www.worldweatherattribution.org/climate-change-fuels-the-destruction-of-worlds-oldest-trees/"
    region: "International"
    quote: "Driven by extreme heat above 38°C, months of drought, and fierce winds of 40-50 km/h, the fires spread very fast, so intense that pyrocumulus clouds formed above some burn areas."
  - name: "Al Jazeera"
    url: "https://www.aljazeera.com/gallery/2026/2/3/wildfires-devastate-argentinas-patagonia-threaten-ancient-forests"
    region: "Middle East"
    quote: "The wildfires are among the most severe to strike the drought-stricken Patagonia region in decades, compelling thousands of residents and tourists to evacuate."
  - name: "AP News"
    url: "https://apnews.com/article/argentina-patagonia-milei-trump-austerity-wildfires-drought-f07520babbbb3ea18f9da96d47a7c3b4"
    region: "North America"
    quote: "The service faces another 71% reduction in funds this year, according to an analysis of the 2026 budget by FARN."
  - name: "Gizmodo"
    url: "https://gizmodo.com/as-patagonia-burns-the-world-may-lose-some-of-its-most-ancient-trees-2000720805"
    region: "North America"
    quote: "The oldest, largest specimen stands nearly 200 feet tall and is estimated to be 2,600 years old."
