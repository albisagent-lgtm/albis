...
sources:
  - name: "TechCrunch"
    ...
    quote: "U.S. regulators have allegedly drafted rules that would require U.S. government approval to ship AI chips anywhere outside the U.S."
  - name: "WinBuzzer"
    url: "https://winbuzzer.com/2026/03/09/us-draft-rules-require-permits-all-ai-chip-exports-xcxwbn/"
    region: "International"
    quote: "A 129-page draft is circulating through the administration, with conditions tied to investments in American AI infrastructure."
  - name: "Reuters"
    url: "https://www.reuters.com/world/us-mulls-new-rules-ai-chip-exports-including-requiring-investments-by-foreign-2026-03-05/"
    region: "International"
    quote: "The rules depart markedly from former President Joe Biden's approach, which was based on the premise that close U.S. allies should be exempted from most restrictions."
  - name: "EU Perspectives"
    url: "https://euperspectives.eu/2026/02/will-ai-gigfactories-deliver-for-europe/"
    region: "Europe"
    quote: "As long as Europe continues to build the car but rent the engine, export controls will continue to govern Europe's ability to build an AI-based economy."
faqs:
  - q: "What are the new US AI chip export controls?"
    a: "The Trump administration has drafted a 129-page rule requiring US government approval for all AI chip exports worldwide — including to close allies like the UK, Germany, and Japan. Orders above 200,000 GPUs would require recipient governments to make security commitments and invest in US AI infrastructure."
  - q: "How do US allies feel about the AI chip export rules?"
    a: "European and Asian allies view the rules as overreach. Europe worries about tech sovereignty since it doesn't manufacture its own AI chips. Japan, South Korea, and Taiwan — home to key chipmakers — see it as treating allies the same as adversaries."
  - q: "Why is the US restricting AI chip exports to allies?"
    a: "The US says the rules prevent chip diversion to China and protect national security. Critics argue it's really about turning semiconductor access into a diplomatic bargaining chip, forcing other countries to invest in American AI infrastructure in exchange for chip access."
---
...
The [Albis Perception Gap Index](/indexes/pgi) scored this story at **PGI 7.2** — one of the widest gaps of the day. The sharpest divide runs between the US and Asia-Pacific (8.0), followed by the US and Europe (6.5).
...
[Asian outlets](/perspectives/japan) tell a completely different story. The same policy that America calls "security" looks like imperial control from Tokyo, Seoul, and Taipei.

South Korea and Taiwan — home to Samsung and TSMC — have their own national interests in the chip trade. Japan's semiconductor industry is mid-renaissance, backed by heavy government investment. All three countries already enforce chip export controls aligned with US policy.
...
Europe's reaction sits somewhere between alarm and resignation. The continent doesn't make its own [AI chips](/topics/ai). It imports them. That makes any US export control regime an existential question for European tech ambitions.
...
European coverage focuses on [sovereignty](/topics/ai). A continent trying to build independent AI capacity just discovered its supply chain runs through the US Commerce Department.
