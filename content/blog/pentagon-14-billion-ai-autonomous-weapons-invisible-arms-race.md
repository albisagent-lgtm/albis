...
date: "2026-03-15"
author: "Albis"
image: "https://images.pexels.com/photos/32998808/pexels-photo-32998808.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800&w=1200"
tags: ["unseen", "gai", "ai", "autonomous-weapons", "pentagon", "military", "drones"]
seoKeyword: "Pentagon AI autonomous weapons budget 2026"
faqs:
  - q: "How much is the Pentagon spending on AI weapons in 2026?"
    a: "The Pentagon's FY2026 budget includes a record $13.4-14.2 billion specifically for AI and autonomous weapons systems — the first time the Department of Defense has created a standalone budget line for this category."
  - q: "What is the Phantom MK-1 military humanoid robot?"
    a: "Phantom MK-1 is a humanoid robot built by Foundation, a US startup with $24 million in military contracts. It's designed to wield any weapon a human can, and two units were sent to Ukraine in February 2026 for frontline reconnaissance."
  - q: "Are autonomous weapons being used in Ukraine right now?"
    a: "Yes. AI-powered drones in Ukraine are already assessing targets and firing autonomously when Russian radio jamming makes remote operation impossible. Ukraine recently opened millions of drone strike videos to train AI targeting models."
sources:
  - name: "Defense One"
    url: "https://www.defenseone.com/policy/2026/02/pentagons-spending-plan-doubles-down-land-air-sea-robots/411628/"
    region: "North America"
    quote: "$1.4 billion to expand the industrial base for drones, $500 million for the Defense Autonomous Warfare Group"
  - name: "TIME"
    url: "https://time.com/article/2026/03/09/ai-robots-soldiers-war/"
    region: "North America"
    quote: "AI-powered drones in Ukraine are already assessing targets and autonomously firing as Russian radio jamming renders remote operation ineffective"
  - name: "Reuters"
    ...
    quote: "Progress on a potential international framework to prohibit and restrict Lethal Autonomous Weapons Systems is urgently needed"
  - name: "The Guardian"
    url: "https://www.theguardian.com/technology/2026/mar/13/anthropic-pentagon-artificial-intelligence"
    region: "Europe"
    quote: "Anthropic attempting to prohibit its AI model from being used for domestic mass surveillance or fully autonomous lethal weapons"
  - name: "Usanas Foundation"
    url: "https://usanasfoundation.com/regulating-lethal-autonomous-weapons-systems-laws-in-a-fractured-multipolar-order"
    region: "South Asia"
    quote: "The Pentagon has requested a record $14.2 billion for AI and autonomous systems"
...
The [Global Attention Index](/indexes/gai) scores this at 7 out of 10 — covered in one region, invisible to the other six. About 7.3 billion people live in countries where this arms race isn't making headlines.
...
This isn't theoretical. AI-powered drones in [Ukraine](/perspectives/ukraine) already select targets and fire on their own. Russian radio jamming broke remote control, so manufacturers built AI that lets drones lock on and strike alone.
...
This buildup is splitting the [AI industry](/topics/ai). Anthropic refused to let its Claude model power autonomous kill systems or domestic mass surveillance. The Pentagon called Anthropic a "supply chain risk." Anthropic's fighting that in court.
...
American defense publications and tech outlets cover this closely. Everywhere else? Silence. Europe, the Middle East, [Asia-Pacific](/perspectives/japan), South Asia, Africa, Latin America — nothing.
