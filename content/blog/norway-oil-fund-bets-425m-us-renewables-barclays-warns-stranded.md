---
title: "The World's Biggest Oil Fund Just Bet $425 Million on American Solar and Wind"
...
sources:
  - name: "Reuters"
    url: "https://www.reuters.com/sustainability/boards-policy-regulation/norway-wealth-fund-makes-first-investment-us-renewable-energy-assets-2026-03-03/"
    region: "International"
    quote: "Norway's sovereign wealth fund has made its first investment in renewable energy assets in the United States, buying a 33.3% stake in a portfolio of 17 solar plants and five onshore wind power facilities."
  - name: "DBBNWA"
    url: "https://www.dbbnwa.com/articles/norway-wealth-fund-enters-u-s-renewables-with-northview-energy/"
    region: "North America"
    quote: "Valued at approximately $2.6 billion, Northview will initially own and operate a seed portfolio of 22 utility-scale assets representing roughly 2.3 gigawatts of power capacity across 11 U.S. states."
  - name: "OilPrice.com"
    url: "https://oilprice.com/Latest-Energy-News/World-News/Barclays-Warns-Grid-Constraints-Could-Strand-Renewables-Assets.html"
    region: "International"
    quote: "Stranded-asset risk is no longer confined to one part of the system. Renewables can be stranded where interconnection queues, curtailment or insufficient firming capacity impairs their ability to deliver value."
  - name: "BloombergNEF via SolarQuarter"
    url: "https://solarquarter.com/2026/03/05/battery-storage-costs-plunge-to-78-mwh-in-2025-amid-rising-renewable-costs/"
    region: "International"
    quote: "The global benchmark cost for a four-hour battery storage project dropped 27% year-on-year to $78 per megawatt-hour in 2025, the lowest level recorded since BNEF began tracking the data in 2009."
  - name: "Los Angeles Times"
    url: "https://www.latimes.com/environment/story/2026-03-04/renewable-energy-defies-trumps-attacks-reaching-new-record"
    region: "North America"
    quote: "About 1,162 terawatt-hours of the country's electricity was generated from renewable sources in 2025, a 10% increase over the prior year — representing 26% of all US electricity made."
confidence: "confirmed"
faqs:
  - q: "Why is Norway's oil fund investing in US renewable energy?"
    a: "Norway's $1.8 trillion sovereign wealth fund — built entirely from petroleum revenue — is diversifying into clean energy as part of its 2025 Climate Action Plan. The fund bought a 33.3% stake in 22 US solar and wind facilities through a new joint venture called Northview Energy, valued at $2.6 billion total."
  - q: "Can renewable energy assets become stranded?"
    a: "Yes. Barclays warned in March 2026 that grid congestion, interconnection queues, and insufficient transmission infrastructure could strand renewable assets — meaning they're built but can't deliver power to customers. The bottleneck isn't generation; it's getting clean electricity where it needs to go."
  - q: "What percentage of US electricity comes from renewables?"
    a: "In 2025, renewables generated 26% of all US electricity — a record 1,162 terawatt-hours, up 10% from the prior year. Nearly 80% of planned new US power capacity over the next decade is tied to renewable sources."
---
