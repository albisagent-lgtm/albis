---
title: "Mexico and Romania Pass Landmark Femicide Laws as UN Gender Talks Expose Deep Divides"
...
sources:
  - name: "La Voce di New York"
    url: "https://lavocedinewyork.com/en/news/2026/03/25/mexico-passes-national-law-against-femicide-penalties-up-to-70-years/"
    region: "Latin America"
    quote: "The reform classifies femicide as a grave human rights violation and requires that every violent death of a woman be treated as such from the outset."
  - name: "Balkan Insight"
    url: "https://balkaninsight.com/2026/03/25/romanias-new-law-toughening-femicide-sentences-welcomed/bi/"
    region: "Europe"
    quote: "Women in Romania will now have more protection mechanisms if they become victims of violence."
  - name: "Democracy Docket"
    url: "https://www.democracydocket.com/news-alerts/save-america-act-married-women-voting-rights-restrictions/"
    region: "North America"
    quote: "The latest version of the bill does not include any special carve-outs for eligible voters whose current names differ from those on their identification documents."
  - name: "Inter Press Service"
    url: "https://www.ipsnews.net/2026/03/gender-equality-a-global-priority-or-a-global-consensus/"
    region: "International"
    quote: "This year's theme cuts to the heart of the struggle for equality: access to justice."
  - name: "BBVA / UN Women"
    url: "https://www.bbva.com/en/sustainability/gender-equality-could-boost-global-gdp-by-more-than-20/"
    region: "International"
    quote: "Only 4% of women worldwide live in countries that offer near-full legal equality."
faqs:
  - q: "What is Mexico's new femicide law?"
    a: "Mexico enacted a national law in March 2026 classifying femicide as a grave human rights violation with penalties up to 70 years in prison. It establishes nine gender-based criteria for classifying femicide and eliminates statutes of limitations for criminal proceedings."
  - q: "How does the SAVE America Act affect women's voting rights?"
    a: "The SAVE America Act requires documentary proof of citizenship to register to vote. An estimated 69 million women who changed their name after marriage would face mismatched records between birth certificates and current legal names, creating new barriers to registration."
  - q: "What happened at CSW70 regarding gender equality?"
    a: "The 70th UN Commission on the Status of Women adopted Agreed Conclusions on access to justice for women with 37 votes in favour. The US voted against and failed to pass a proposal narrowing the UN definition of gender, which was blocked by EU member states."
perception_gap: 7
regions_found: [us, eu, latam, africa]
regions_absent: [middle_east, south_asia, asia_pacific]
region_significance:
  us: 5
  eu: 4
  latam: 5
  africa: 2
region_frames:
  us: "Framed around voting rights and domestic policy battles"
  eu: "Framed as progress on femicide legislation and justice reform"
  latam: "Framed as landmark legal protections against endemic gender violence"
  africa: "Framed through CSW70 participation and cultural concerns about gender definitions"
---
...
In the US, the SAVE America Act continued to generate controversy over its potential impact on [women's rights](/topics/womens-rights). The bill, reintroduced by Rep. Chip Roy (R-Texas), requires all prospective voters to show documentary proof of citizenship such as birth certificates or passports to register.
...
UN Women data presented at CSW70 show that only 4 percent of women worldwide live in countries offering near-full legal equality, according to the World Bank. The organisation projects that invisible barriers and discriminatory laws will stall [economic gender parity](/topics/gender-equality) for 286 years at the current pace.
