...
sources:
  - name: "DW"
    url: "https://www.dw.com/en/how-germany-is-fueling-namibias-green-hydrogen-revolution/a-72136731"
    region: "Europe"
    quote: "Iron reduction has so far taken place in Germany with the help of coking coal, which is why it is so enormously carbon intensive."
  - name: "EU International Partnerships"
    url: "https://international-partnerships.ec.europa.eu/news-and-events/news/global-gateway-namibia-becomes-pioneer-africas-green-transition-2025-04-11_en"
    region: "Europe"
    quote: "The first zero-emissions iron production facility in Africa was inaugurated at the Hyron Oshivela Production site."
  - name: "The Exchange Africa"
    url: "https://theexchange.africa/green-hydrogen-pilots-africa/"
    region: "Africa"
    quote: "The continent is host to 78 proposed green hydrogen projects representing $194 billion in planned investment. Yet only two are operational. Both are in Namibia."
  - name: "ESI Africa"
    url: "https://www.esi-africa.com/industry-sectors/smart-technologies/first-green-hydrogen-produced-in-namibia/"
    region: "Africa"
    quote: "The project can produce 1 million tonnes of iron annually and is expected to reduce CO2 emissions by 1.8 million tonnes per year."
  - name: "Fuel Cells Works"
    url: "https://fuelcellsworks.com/2025/03/20/electrolyzer/milestone-hyiron-oshivela-produces-first-green-hydrogen-in-southern-africa-using-chinese-electrolysers"
    region: "International"
    quote: "HyIron's Oshivela plant has successfully produced southern Africa's first green hydrogen using a 12MW Chinese-made electrolyser."
confidence: "confirmed"
faqs:
  - q: "What is Namibia's green hydrogen plant?"
    a: "The HyIron Oshivela Plant near Arandis, Namibia, is Africa's first zero-emissions iron production facility. It uses 44,000 solar panels to power electrolysers that split water into hydrogen and oxygen, then uses the hydrogen to reduce iron ore without any carbon emissions."
  - q: "Can green hydrogen compete with fossil fuels on cost?"
    a: "Green hydrogen currently costs $3.50-$6.00/kg globally, while grey hydrogen from natural gas costs $0.98-$2.93/kg. But Namibia's projected costs of $1.73-$2.30/kg would make it competitive with fossil fuel hydrogen by 2030, second only to Chile."
  - q: "Why is Germany investing in Namibia's green hydrogen?"
    a: "Germany needs to decarbonize its steel industry, which relies on coking coal for iron reduction. Namibia has both iron ore deposits and world-class solar resources, making it an ideal partner for producing green iron that Germany can import to replace carbon-intensive production."
---
...
The setup is elegantly simple. In the Namib Desert foothills, 44,000 solar panels generate up to 25 megawatts of electricity. That power feeds two Chinese-made electrolysers — the largest in [southern Africa](/perspectives/south-africa) — which split water into hydrogen and oxygen.
...
So instead of shipping coal to blast furnaces, the future looks like this: Namibia makes green iron, ships it to Hamburg, and Germany's steelmakers skip the dirtiest part of their process entirely. It's [outsourcing decarbonization](/topics/climate) — but in a way that creates jobs in one of the world's most employment-starved economies.
...
While the world fights over who controls the [Strait of Hormuz](/blog/oil-100-barrel-hormuz-crisis-ripple-effects-2026) and whether $100 oil will crash the global economy, Namibia quietly opened a facility that makes the entire argument feel dated.
