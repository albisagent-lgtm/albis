...
sources:
  - name: "The Guardian"
    url: "https://www.theguardian.com/world/2026/mar/19/india-liquefied-petroleum-gas-lpg-supply-chain-disruption-iran-conflict"
    region: "Europe"
    quote: "India imports about 60% of its LPG, 90% of that routed through the Strait of Hormuz. Only two cargoes have made it through since the strait closed."
  - name: "Times of India"
    ...
    region: "South Asia"
    quote: "Crude imports into India are down 23% compared to February. Middle Eastern supplies dropped from 59.9 million barrels to 22.4 million."
  - name: "Economic Times"
    url: "https://economictimes.indiatimes.com/news/new-updates/petrol-price-hike-why-did-indian-oil-companies-raised-fuel-prices-today-after-a-4-years-gap-explained/articleshow/129697941.cms"
    region: "South Asia"
    quote: "Premium petrol variants hiked by Rs 2.09 to Rs 2.35 per litre — the first increase in four years."
  - name: "Bloomberg"
    url: "https://www.bloomberg.com/news/articles/2026-03-20/india-rupee-drops-past-93-to-dollar-to-record-amid-crude-swings"
    region: "International"
    quote: "The rupee dropped as much as 1.2%, the most since February 2022, to 93.76 per dollar."
  - name: "India Today"
    url: "https://www.indiatoday.in/india/story/us-iran-israel-war-middle-east-strait-of-hormuz-why-lpg-was-hit-first-not-diesel-petrol-supplies-india-2881343-2026-03-14"
    region: "South Asia"
    quote: "About a fifth of eateries in Mumbai have either shut down or scaled back operations."
confidence: "confirmed"
faqs:
  - q: "Why are India's fuel prices rising in March 2026?"
    a: "The Iran war disrupted shipping through the Strait of Hormuz, which carries about 50% of India's crude oil imports. Global crude surged past $100/barrel, and India's oil companies hiked premium petrol by ₹2.35/litre — the first increase in four years. The rupee also hit record lows at 93.76 per dollar, making imports more expensive."
  - q: "Is India facing an LPG cooking gas shortage?"
    a: "Yes. India imports 60% of its LPG, with 90% of that routed through Hormuz. Only two LPG tankers have made it through since the strait closed. Households in Delhi are waiting days for refills, a fifth of Mumbai's restaurants have shut, and the government has restricted commercial LPG to prioritise homes and hospitals."
  - q: "How is India replacing its lost oil supply from the Middle East?"
    a: "India's Middle Eastern crude imports fell from 59.9 million barrels in early February to 22.4 million in the first 18 days of March. Russia has nearly doubled its share, now supplying 44% of India's crude. African nations like Angola, Congo, and Gabon are filling gaps. India has also diversified so that 70% of crude now comes from non-Hormuz routes."
---
...
The Albis [Global Attention Index](/indexes/gai) scored India's fuel crisis at 6.86 — the highest invisibility rating in today's scan. Only two of seven global regions are covering the story: South Asia (where it's front-page news) and the US (where it gets a passing mention). Europe, the Middle East, Asia-Pacific, Africa, and Latin America are blind to it.

That's a country of 1.4 billion people experiencing its worst [energy crisis](/topics/energy) in decades, and five-sixths of the world's media regions haven't noticed.
