...
faqs:
  - q: "What are small modular reactors and when will Europe build them?"
    a: "SMRs are factory-built nuclear reactors smaller than traditional plants, designed for faster deployment. The EU strategy targets first projects by the early 2030s, with 17-53 GW capacity by 2050. But no SMR has been licensed in the EU yet."
  - q: "Has any country successfully built a small modular reactor?"
    a: "Only Russia and China have operational SMRs as of 2026. Russia's floating reactor Akademik Lomonosov has been running since 2020. China connected its ACP100 to the grid. No Western SMR has been commercially deployed."
  - q: "Why did the NuScale Idaho SMR project fail?"
    a: "NuScale's 462 MW project with UAMPS in Idaho was cancelled in November 2023 after costs ballooned and only 116 MW of the 462 MW capacity attracted subscribers. Cheap natural gas and growing wind made the economics unworkable."
sources:
  - name: "European Commission"
    ...
    region: "Europe"
    quote: "Total SMR capacity in the EU could reach between 17 GW and 53 GW by 2050"
  - name: "Heinrich Böll Foundation"
    url: "https://nuclear-news.net/2026/03/10/4-a-small-modular-reactors-smaller-regulation/"
    region: "Europe"
    quote: "No SMR concept had been granted a construction licence in the EU as of February 2026"
  - name: "The Motley Fool"
    url: "https://www.fool.com/investing/2026/03/10/europes-first-nuscale-powered-modular-reactor-proj/"
    region: "North America"
    quote: "RoPower has decided to move forward with its power plant... NuScale could finally have its first customer"
  - name: "Clean Air Task Force"
    url: "https://www.catf.us/2023/11/lessons-learned-recently-cancelled-nuscale-uamps-project/"
    region: "North America"
    quote: "UAMPS lacked experience with nuclear technology, couldn't undertake cost risks on behalf of its customers"
  - name: "MIT Technology Review"
    url: "https://www.technologyreview.com/2026/01/12/1129991/sodium-ion-batteries-2026-breakthrough-technology/"
    region: "North America"
    quote: "Named sodium-ion batteries a 2026 breakthrough technology"
...
The timing isn't coincidental. With the [Iran war](/topics/iran) choking 20% of global oil through the Strait of Hormuz and Brent crude above $100, Europe's energy vulnerability is back on full display. The Commission's answer is a technology that exists mostly on paper.

## What the EU Is Actually Proposing

The strategy (COM/2026/117) lays out an ambitious vision. SMRs — reactors small enough to be factory-built and trucked to site — would complement [renewables](/topics/climate) by providing steady baseload power. The Commission wants "SMR Valleys" for industrial clusters, regulatory sandboxes to speed approvals, and a coalition of interested member states to coordinate designs.
...
After Russia invaded Ukraine in 2022, Europe scrambled to replace Russian gas. Solar and wind installations surged. But the current crisis shows that renewables alone can't fill every gap — especially for industrial heat, hydrogen production, and the [AI data centers](/topics/ai) consuming electricity at unprecedented rates.
...
While Europe waits for SMRs that won't arrive until the 2030s at the earliest, other [clean energy technologies](/topics/climate) are deploying right now.
