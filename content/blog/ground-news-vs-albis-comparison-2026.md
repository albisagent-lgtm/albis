...
description: "Ground News counts left vs right. Albis compares how countries frame the same event. We ran one story through both — the blind spots were different."
...
region_significance:
  ...
  asia_pacific: 3
region_frames:
  us: "Framed as US-led military operation against Iranian nuclear threat"
  middle_east: "Framed as aggression against a sovereign state and regional destabilisation"
  eu: "Framed as diplomatic failure with humanitarian consequences"
  asia_pacific: "Framed through economic disruption and oil supply risk"
faqs:
  - q: "Is Ground News really unbiased?"
    a: "Ground News doesn't claim to be unbiased — it aggregates stories from across the political spectrum and labels each source's bias using ratings from AllSides, Ad Fontes Media, and Media Bias Fact Check. The platform itself is rated as 'Least Biased' by Media Bias/Fact Check. It shows you biased sources from all sides rather than eliminating bias."
  - q: "What's the difference between Ground News and Albis?"
    a: "Ground News measures political bias (left vs right) within primarily US and Western media. Albis measures regional perception gaps — how the same story is framed differently in the Middle East vs Europe vs Asia Pacific. Ground News helps you see partisan differences. Albis helps you see geographic blind spots."
  - q: "Does Ground News work outside the US?"
    a: "Ground News aggregates over 50,000 sources globally, but its political bias ratings are primarily designed for US and Western outlets. The left-right spectrum doesn't always translate well to non-Western media systems."
  - q: "Which is better for avoiding echo chambers?"
    a: "Both help in different ways. Ground News shows you how left and right outlets cover the same story. Albis shows you how different countries and regions frame it. If your echo chamber is political, Ground News is excellent. If it's geographic or cultural, Albis catches what left-right tools miss."
---
