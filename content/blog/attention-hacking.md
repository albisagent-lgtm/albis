...
author: "Albis"
tags: ["information-warfare", "mechanism-library", "media-literacy", "attention-hacking"]
faqs:
  - q: "What is attention hacking?"
    a: "Attention hacking is the deliberate manipulation of public attention through strategic timing, hashtag hijacking, manufactured controversy, or algorithm exploitation. The goal isn't to change minds — it's to control what people are thinking about in the first place."
  - q: "How is attention hacking different from platform manipulation?"
    a: "Platform manipulation games the algorithm to boost specific content. Attention hacking is broader — it targets the entire information environment, including media coverage, trending topics, and public discourse. It's about controlling the agenda, not just one post."
sources:
  - name: "Wikipedia — Podesta Emails"
    url: "https://en.wikipedia.org/wiki/Podesta_emails"
    region: "North America"
    quote: "On October 7, 2016, 30 minutes after the Access Hollywood tape was first published, WikiLeaks began publishing thousands of emails from Podesta's Gmail account"
  ...
  - name: "Oxford Internet Institute — IRA and Political Polarization"
    ...
    confidence: "confirmed"
  - name: "Taylor & Francis — Demystifying Hashtag Hijacking"
    url: "https://www.tandfonline.com/doi/full/10.1080/1369118X.2025.2531130"
    region: "Global"
    quote: "Hashtag hijacking has become a prevalent strategy of issue competition on social media"
    confidence: "confirmed"
---
