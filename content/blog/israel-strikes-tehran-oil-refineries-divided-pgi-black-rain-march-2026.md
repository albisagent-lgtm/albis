...
sources:
  - name: "TIME"
    ...
    quote: "Something like a black monster has swallowed the sky over Tehran"
  - name: "The Conversation"
    url: "https://theconversation.com/what-international-law-says-about-the-israeli-strikes-on-iranian-oil-facilities-277875"
    region: "International"
    quote: "Oil refineries showcase the complexity of applying these principles"
  - name: "Daily Mail"
    url: "https://www.dailymail.co.uk/news/article-15628467/Trump-furious-Israel-destroying-Iran-oil-fields-crude-surges-planned-summit-collapses.html"
    region: "Europe"
    quote: "The president doesn't like the attack. He wants to save the oil. He doesn't want to burn it."
  - name: "Axios"
    url: "https://www.axios.com/2026/03/08/us-dismayed-israel-iran-fuel-strikes"
    region: "North America"
    quote: "The message from the US was stark: 'What the f***'"
  - name: "Al Jazeera"
    ...
    region: "Middle East"
    quote: "Iran says 1,255 killed in US-Israeli attacks, mostly civilians"
confidence: "confirmed"
faqs:
  - q: "Why did Israel strike Tehran's oil refineries?"
    a: "Israel says the strikes targeted fuel infrastructure that powers Iran's military operations, including aviation fuel for drones and missiles. An Israeli military official said they were also meant to send a message to Iran to stop targeting Israeli civilian infrastructure."
  - q: "What is the PGI score for this story?"
    a: "The Perception Gap Index scored this story at 9.0, placing it firmly in 'Competing Realities' territory — one of the highest scores recorded. Different regions frame the same strikes as either a proportionate military response or illegal economic warfare against civilians."
  - q: "What does international law say about striking oil refineries?"
    a: "International humanitarian law doesn't outright prohibit attacks on energy infrastructure. But it requires careful assessment of military relevance and proportionality — whether civilian harm is excessive compared to military advantage gained."
---
...
**Perception Gap Index: 9.0 — Competing Realities 🔴**
...
The word that keeps appearing in Arabic-language coverage: "economic warfare."

**In Europe**, the reaction is split but leaning toward alarm. The Conversation published an analysis within hours asking whether international humanitarian law permits this. Their answer: it's genuinely complicated. Article 52 of the Geneva Conventions says an object is a legitimate target if it "makes an effective contribution to military action." Oil refineries sit right on the line — they power both tanks and ambulances.

**In Washington (again)**, even the ally is rattled. The White House reportedly sent Israel a blunt message after seeing the scale of destruction: "What the f***." A Trump adviser told Axios: "The president doesn't like the attack. He wants to save the oil. He doesn't want to burn it. And it reminds people of higher gas prices."

A planned US-Israel summit was scrapped on Monday — the first open disagreement between the allies since the war began.
...
**Factual Divergence:** Low. The physical events are well-documented.
**Causal Attribution:** High. Israel says Iran's military use of fuel justifies the strike. Iran says Israel is destroying civilian life support.
**Framing & Emphasis:** Maximum. Same fires, radically different headlines.
**Emotional Valence:** Extreme. Triumph in Tel Aviv, horror in Tehran, anxiety in Washington.
**Actor Portrayal:** Complete reversal. Israel as defender vs. Israel as aggressor, depending on which capital you're reading from.

The gap here isn't about spin. It's about which civilians count — and who gets to define "military target" when the target heats homes and fuels jets with the same barrel of oil.
