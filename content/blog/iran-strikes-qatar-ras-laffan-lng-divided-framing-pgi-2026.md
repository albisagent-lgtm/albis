...
sources:
  - name: "Al Jazeera"
    ...
    region: "Middle East"
    quote: "Qatar considers this assault a dangerous escalation, a flagrant violation of its sovereignty, and a direct threat to its national security."
  - name: "New York Times"
    url: "https://www.nytimes.com/2026/03/18/business/energy-environment/israel-strikes-south-pars-gas-oil-prices.html"
    region: "North America"
    quote: "The attacks signal that the Persian Gulf's extensive energy facilities may be at growing risk."
  - name: "South China Morning Post"
    url: "https://www.scmp.com/week-asia/economics/article/3346262/asias-energy-reliant-economies-face-existential-threat-prolonged-iran-war"
    region: "Asia-Pacific"
    quote: "Spot prices for natural gas have more than doubled to three-year highs, reaching over US$25 per MMBtu after Qatar Energy declared force majeure."
  - name: "Gulf Times"
    url: "https://www.gulf-times.com/article/722585/qatar/qatar-expels-iranian-military-attaches"
    region: "Middle East"
    quote: "The Gulf Cooperation Council also condemned the attack on Ras Laffan in the strongest possible terms."
  - name: "Reuters"
    ...
    quote: "Tehran's retaliation against Israeli attacks on its own gas facilities marks a further escalation of the nearly three-week war."
faqs:
  - q: "What happened at Qatar's Ras Laffan on March 18, 2026?"
    a: "Iran fired missiles at Ras Laffan Industrial City, the world's largest LNG export hub, causing extensive damage and fires. Qatar expelled Iran's military attaches in response. No casualties were reported, but natural gas prices doubled to three-year highs above $25 per MMBtu."
  - q: "Why did Iran attack Qatar's gas facility?"
    a: "Iran attacked Gulf energy sites in retaliation for Israeli strikes on its South Pars gas field, which damaged up to one-fifth of Iran's gas processing capacity. The IRGC named five specific Gulf facilities as 'legitimate targets for retaliation.'"
  - q: "How did different countries frame Iran's attack on Qatar's LNG facility?"
    a: "Western outlets led with energy market risk. Gulf media called it an act of aggression and sovereignty violation. Asian outlets focused on energy supply shocks to LNG-dependent economies. Iran framed its strikes as legitimate self-defense against Western-backed destruction of its infrastructure."
---
...
The [Albis Perception Gap Index](/indexes/pgi) scored this story at **8 out of 10** — in the top tier of divergent global coverage. Four regions. Four completely different events.
