...
sources:
  - name: "Life Biosciences"
    ...
    quote: "IND clearance marks the first ever cellular rejuvenation therapy using partial epigenetic reprogramming to reach human clinical trials"
  - name: "MIT Technology Review"
    ...
    region: "North America"
    quote: "The version of the technique being advanced by Life Biosciences passed initial safety tests in animals"
  - name: "PMC Longevity Clinics Study"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC12606959/"
    region: "Europe"
    quote: "Annual memberships frequently range from €10,000 to €50,000, with some executive health packages exceeding €100,000"
  - name: "TechCrunch"
    url: "https://techcrunch.com/2025/01/24/retro-biosciences-backed-by-sam-altman-is-raising-1-billion-to-extend-human-lifespan/"
    region: "North America"
    quote: "Retro Biosciences, backed by Sam Altman, is raising $1 billion to extend human lifespan"
confidence: "confirmed"
faqs:
  - q: "What is ER-100 epigenetic reprogramming therapy?"
    a: "ER-100 is the first gene therapy in human trials designed to reverse cellular aging by resetting epigenetic markers using three of the four Yamanaka factors (OSK). FDA cleared it in January 2026 for optic neuropathies including glaucoma and NAION."
  - q: "How much do longevity therapies cost?"
    a: "Current longevity clinic memberships range from €10,000 to €50,000 annually, with some executive packages exceeding €100,000. First-generation therapies like ER-100 are likely to start even higher before economies of scale develop."
  - q: "When will anti-aging therapies be widely available?"
    a: "ER-100 began Phase 1 trials in Q1 2026, but widespread access depends on regulatory approval, manufacturing scale, and whether healthcare systems cover longevity interventions — a timeline measured in years or decades, not months."
---
