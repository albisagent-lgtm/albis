---
title: "KRAS Cancer Drugs Get Two FDA Breakthroughs"
...
sources:
  - name: "OncLive"
    url: "https://www.onclive.com/view/zoldonrasib-nets-breakthrough-therapy-designation-in-kras-g12d-mutated-nsclc"
    region: "North America"
    quote: "The first breakthrough therapy designation ever granted for an investigational drug specifically targeting the KRAS G12D mutation"
  - name: "Targeted Oncology"
    url: "https://www.targetedonc.com/view/daraxonrasib-earns-fda-breakthrough-status-in-pancreatic-cancer"
    region: "North America"
    quote: "Median progression-free survival was 8.8 months with a disease control rate of 91%"
  - name: "Revolution Medicines"
    url: "https://ir.revmed.com/news-releases/news-release-details/revolution-medicines-shares-new-clinical-results-supporting"
    region: "North America"
    quote: "The confirmed objective response rate was 35%, the disease control rate was 92%, and the median overall survival was 13.1 months"
  - name: "Nature Signal Transduction and Targeted Therapy"
    url: "https://www.nature.com/articles/s41392-021-00780-4"
    region: "International"
    quote: "Despite 40 years of proprietary drug efforts, there are still no effective strategies targeting KRAS mutations"
  - name: "ScienceDirect"
    url: "https://www.sciencedirect.com/science/article/abs/pii/S0006291X25004024"
    region: "International"
    quote: "Approximately 19% (~3.4 million) of new cancer patients annually harbour RAS mutations"
confidence: "confirmed"
faqs:
  - q: "What is the KRAS cancer mutation?"
    a: "KRAS is the most frequently mutated oncogene in human cancer, driving roughly 85% of pancreatic cancers, 45% of colorectal cancers, and 30% of lung cancers. For four decades, scientists considered it 'undruggable' because the protein's smooth surface offered no obvious pocket for a drug to grab onto."
  - q: "What are daraxonrasib and zoldonrasib?"
    a: "Both are investigational drugs from Revolution Medicines that target the KRAS mutation in its active 'on' state. Daraxonrasib targets multiple KRAS variants and is in Phase 3 trials for pancreatic cancer. Zoldonrasib specifically targets the G12D variant and just received FDA breakthrough therapy designation for lung cancer."
  - q: "When could KRAS-targeting cancer drugs be available?"
    a: "Phase 3 trial results for daraxonrasib in pancreatic cancer are expected later in 2026. If the results hold up, the drug could seek FDA approval shortly after. Zoldonrasib is earlier in development but its breakthrough designation will speed regulatory review."
---
...
The [FDA's recent shift toward one-trial approvals](/blog/fda-one-trial-drug-approval-staff-exodus-chaos-2026) makes the regulatory path faster — but the scientific challenge of KRAS was never about paperwork. It was about chemistry.
...
[The Hormuz blockade is emptying pharmacies worldwide](/blog/hormuz-strait-medicine-shortage-drug-supply-chain-crisis-2026), and the conversation about global health has understandably shifted toward supply chains and access. But drug discovery breakthroughs and supply chain crises are two halves of the same equation. A drug that doesn't exist can't be supplied, no matter how open the shipping lanes.
